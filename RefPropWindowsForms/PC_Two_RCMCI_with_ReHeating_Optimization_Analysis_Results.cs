...
{
    public partial class PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results : Form
    {
        PC_Two_RCMCI_withReheating puntero_aplicacion;

        public PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results(PC_Two_RCMCI_withReheating puntero1)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                puntero_aplicacion.t_trh_in = Convert.ToDouble(puntero_aplicacion.textBox116.Text);
                puntero_aplicacion.p_trh_in = Convert.ToDouble(puntero_aplicacion.textBox117.Text);
                ...
                puntero_aplicacion.m_eta_trh = Convert.ToDouble(puntero_aplicacion.textBox115.Text);
                ...
                puntero_aplicacion.dp_rhx = Convert.ToDouble(puntero_aplicacion.textBox118.Text);

                puntero_aplicacion.eta_thermal = 0.0;

                puntero_aplicacion.luis.wmm = puntero_aplicacion.luis.working_fluid.MolecularWeight;

                core.PC_Two_RCMCI_withReheating cicloPC_Two_RCMCI_withReheating = new core.PC_Two_RCMCI_withReheating();
                ...
                xlWorkSheet1.Cells[4, 9] = "P_rhx_in(kPa)";
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500, initial_CIP_value + 1000, initial_CIP_value + 1500, initial_CIP_value + 5000 });
                    ...
                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 1000.0 });

                    var initialValue = new[] { 0.2, initial_CIP_value + 1500.0, initial_CIP_value + 2500.0, initial_CIP_value + 3500.0, initial_CIP_value + 4500.0, 17000.0 };
                    ...
                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        ...
                        ref cicloPC_Two_RCMCI_withReheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc_in, 
                        puntero_aplicacion.t_mc4_in, puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_mc2_in, 
                        puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh_in, variables[5],
                        ...
                        puntero_aplicacion.m_eta_t, puntero_aplicacion.m_eta_trh, puntero_aplicacion.n_sub_hxrs,
                        ...
                        -puntero_aplicacion.dp_rhx);

                        counter++;

                        puntero_aplicacion.massflow2 = cicloPC_Two_RCMCI_withReheating.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloPC_Two_RCMCI_withReheating.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloPC_Two_RCMCI_withReheating.eta_thermal;
                        ...
                        puntero_aplicacion.p_trh_in = variables[5];

                        puntero_aplicacion.temp21 = cicloPC_Two_RCMCI_withReheating.temp[0];
                        puntero_aplicacion.temp22 = cicloPC_Two_RCMCI_withReheating.temp[1];
                        puntero_aplicacion.temp23 = cicloPC_Two_RCMCI_withReheating.temp[2];
                        puntero_aplicacion.temp24 = cicloPC_Two_RCMCI_withReheating.temp[3];
                        puntero_aplicacion.temp25 = cicloPC_Two_RCMCI_withReheating.temp[4];
                        puntero_aplicacion.temp26 = cicloPC_Two_RCMCI_withReheating.temp[5];
                        puntero_aplicacion.temp27 = cicloPC_Two_RCMCI_withReheating.temp[6];
                        puntero_aplicacion.temp28 = cicloPC_Two_RCMCI_withReheating.temp[7];
                        puntero_aplicacion.temp29 = cicloPC_Two_RCMCI_withReheating.temp[8];
                        puntero_aplicacion.temp210 = cicloPC_Two_RCMCI_withReheating.temp[9];
                        puntero_aplicacion.temp211 = cicloPC_Two_RCMCI_withReheating.temp[10];
                        puntero_aplicacion.temp212 = cicloPC_Two_RCMCI_withReheating.temp[11];
                        puntero_aplicacion.temp213 = cicloPC_Two_RCMCI_withReheating.temp[12];
                        puntero_aplicacion.temp214 = cicloPC_Two_RCMCI_withReheating.temp[13];
                        puntero_aplicacion.temp215 = cicloPC_Two_RCMCI_withReheating.temp[14];
                        puntero_aplicacion.temp216 = cicloPC_Two_RCMCI_withReheating.temp[15];
                        puntero_aplicacion.temp217 = cicloPC_Two_RCMCI_withReheating.temp[16];
                        puntero_aplicacion.temp218 = cicloPC_Two_RCMCI_withReheating.temp[17];

                        puntero_aplicacion.pres21 = cicloPC_Two_RCMCI_withReheating.pres[0];
                        puntero_aplicacion.pres22 = cicloPC_Two_RCMCI_withReheating.pres[1];
                        puntero_aplicacion.pres23 = cicloPC_Two_RCMCI_withReheating.pres[2];
                        puntero_aplicacion.pres24 = cicloPC_Two_RCMCI_withReheating.pres[3];
                        puntero_aplicacion.pres25 = cicloPC_Two_RCMCI_withReheating.pres[4];
                        puntero_aplicacion.pres26 = cicloPC_Two_RCMCI_withReheating.pres[5];
                        puntero_aplicacion.pres27 = cicloPC_Two_RCMCI_withReheating.pres[6];
                        puntero_aplicacion.pres28 = cicloPC_Two_RCMCI_withReheating.pres[7];
                        puntero_aplicacion.pres29 = cicloPC_Two_RCMCI_withReheating.pres[8];
                        puntero_aplicacion.pres210 = cicloPC_Two_RCMCI_withReheating.pres[9];
                        puntero_aplicacion.pres211 = cicloPC_Two_RCMCI_withReheating.pres[10];
                        puntero_aplicacion.pres212 = cicloPC_Two_RCMCI_withReheating.pres[11];
                        puntero_aplicacion.pres213 = cicloPC_Two_RCMCI_withReheating.pres[12];
                        puntero_aplicacion.pres214 = cicloPC_Two_RCMCI_withReheating.pres[13];
                        puntero_aplicacion.pres215 = cicloPC_Two_RCMCI_withReheating.pres[14];
                        puntero_aplicacion.pres216 = cicloPC_Two_RCMCI_withReheating.pres[15];
                        puntero_aplicacion.pres217 = cicloPC_Two_RCMCI_withReheating.pres[16];
                        puntero_aplicacion.pres218 = cicloPC_Two_RCMCI_withReheating.pres[17];

                        puntero_aplicacion.PHX = cicloPC_Two_RCMCI_withReheating.PHX.Q_dot;
                        puntero_aplicacion.RHX = cicloPC_Two_RCMCI_withReheating.RHX.Q_dot;

                        puntero_aplicacion.LT_Q = cicloPC_Two_RCMCI_withReheating.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloPC_Two_RCMCI_withReheating.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloPC_Two_RCMCI_withReheating.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloPC_Two_RCMCI_withReheating.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloPC_Two_RCMCI_withReheating.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloPC_Two_RCMCI_withReheating.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloPC_Two_RCMCI_withReheating.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloPC_Two_RCMCI_withReheating.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloPC_Two_RCMCI_withReheating.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloPC_Two_RCMCI_withReheating.LT.eff;

                        puntero_aplicacion.HT_Q = cicloPC_Two_RCMCI_withReheating.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloPC_Two_RCMCI_withReheating.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloPC_Two_RCMCI_withReheating.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloPC_Two_RCMCI_withReheating.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloPC_Two_RCMCI_withReheating.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloPC_Two_RCMCI_withReheating.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloPC_Two_RCMCI_withReheating.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloPC_Two_RCMCI_withReheating.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloPC_Two_RCMCI_withReheating.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloPC_Two_RCMCI_withReheating.HT.eff;

                        puntero_aplicacion.PC1 = -cicloPC_Two_RCMCI_withReheating.PC1.Q_dot;
                        puntero_aplicacion.PC2 = -cicloPC_Two_RCMCI_withReheating.PC2.Q_dot;
                        puntero_aplicacion.PC3 = -cicloPC_Two_RCMCI_withReheating.PC3.Q_dot;
                        puntero_aplicacion.PC4 = -cicloPC_Two_RCMCI_withReheating.PC4.Q_dot;
                        ...
                        listBox31.Items.Add(puntero_aplicacion.p_trh_in.ToString());
                        ...
                        double LTR_min_DT_1 = cicloPC_Two_RCMCI_withReheating.temp[7] - cicloPC_Two_RCMCI_withReheating.temp[2];
                        double LTR_min_DT_2 = cicloPC_Two_RCMCI_withReheating.temp[8] - cicloPC_Two_RCMCI_withReheating.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloPC_Two_RCMCI_withReheating.temp[7] - cicloPC_Two_RCMCI_withReheating.temp[3];
                        double HTR_min_DT_2 = cicloPC_Two_RCMCI_withReheating.temp[6] - cicloPC_Two_RCMCI_withReheating.temp[4];
                        ...
                        //P_rhx_in(kPa)
                        xlWorkSheet1.Cells[counter_Excel + 1, 9] = Convert.ToString(puntero_aplicacion.p_trh_in);
                        //CIT
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 15] = cicloPC_Two_RCMCI_withReheating.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 16] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 17] = cicloPC_Two_RCMCI_withReheating.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    textBox14.Text = p_rhx_in2_list[maxIndex].ToString();
                    ...
                    if (checkBox3.Checked == true)
                    {
                        ...
                        puntero_aplicacion.textBox117.Text = p_rhx_in2_list[maxIndex].ToString();
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500, initial_CIP_value + 1000, initial_CIP_value + 1500, initial_CIP_value + 5000, 0.0 });
                    ...
                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 1000.0, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value + 1500.0, initial_CIP_value + 2500.0, initial_CIP_value + 3500.0, initial_CIP_value + 4500.0, 17000.0, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PC_Two_RCMCI_withReheating_for_optimization(puntero_aplicacion.luis,
                        ref cicloPC_Two_RCMCI_withReheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc_in,
                        puntero_aplicacion.t_mc4_in, puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_mc2_in,
                        puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh_in, variables[5],
                        variables[1], variables[2], variables[2],
                        variables[3], variables[3], variables[4],
                        variables[4], puntero_aplicacion.p_mc2_out,
                        variables[6], UA_Total, puntero_aplicacion.m_eta_mc4, puntero_aplicacion.m_eta_pc,
                        puntero_aplicacion.m_eta_rc, puntero_aplicacion.m_eta_mc3, puntero_aplicacion.m_eta_mc2,
                        puntero_aplicacion.m_eta_t, puntero_aplicacion.m_eta_trh, puntero_aplicacion.n_sub_hxrs,
                        variables[0], puntero_aplicacion.tol, puntero_aplicacion.eta_thermal,
                        -puntero_aplicacion.dp_lt1, -puntero_aplicacion.dp_lt2, -puntero_aplicacion.dp_ht1,
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        if (i == Convert.ToDouble(textBox57.Text))
                        {
                            ...
                            xlWorkSheet1.Cells[4, 17] = "HTR Eff.(%)";
                            xlWorkSheet1.Cells[4, 18] = "HTR Pinch(ºC)";
                            xlWorkSheet1.Cells[4, 19] = "PTC_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 20] = "PTC_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 21] = "LF_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 22] = "LF_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 23] = "PTC_rhx_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 24] = "PTC_rhx_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 25] = "LF_rhx_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 26] = "LF_rhx_Pressure_Drop(bar)";
                        }
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                ...
                                PHX_Q2_list.Add(cicloPC_Two_RCMCI_withReheating.PHX.Q_dot);
                                RHX_Q2_list.Add(cicloPC_Two_RCMCI_withReheating.RHX.Q_dot);

                                HT_Eff_list.Add(cicloPC_Two_RCMCI_withReheating.HT.eff);
                                LT_Eff_list.Add(cicloPC_Two_RCMCI_withReheating.LT.eff);
                            ...
                            PTC_rhx.textBox3.Text = Convert.ToString(puntero_aplicacion.temp217);
                            PTC_rhx.textBox6.Text = Convert.ToString(puntero_aplicacion.temp218);
                            PTC_rhx.textBox4.Text = Convert.ToString(puntero_aplicacion.pres217);
                            PTC_rhx.textBox5.Text = Convert.ToString(puntero_aplicacion.pres218);
                            ...
                            LF_rhx.textBox3.Text = Convert.ToString(puntero_aplicacion.temp217);
                            LF_rhx.textBox6.Text = Convert.ToString(puntero_aplicacion.temp218);
                            LF_rhx.textBox4.Text = Convert.ToString(puntero_aplicacion.pres217);
                            LF_rhx.textBox5.Text = Convert.ToString(puntero_aplicacion.pres218);
                            ...
                            //P_rhx_in(kPa)
                            xlWorkSheet1.Cells[counter_Excel + 1, 9] = p_rhx_in2_list[maxIndex].ToString();
                            //CIT
                            xlWorkSheet1.Cells[counter_Excel + 1, 10] = Convert.ToString(i - 273.15);
                            //LT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 11] = Convert.ToString(puntero_aplicacion.ua_lt);
                            //HT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 12] = Convert.ToString(puntero_aplicacion.ua_ht);
                            //Rec.Frac.
                            xlWorkSheet1.Cells[counter_Excel + 1, 13] = recomp_frac2_list[maxIndex].ToString();
                            //Eff.(%)
                            xlWorkSheet1.Cells[counter_Excel + 1, 14] = (eta_thermal2_list[maxIndex] * 100).ToString();
                            //LTR Eff.(%)
                            xlWorkSheet1.Cells[counter_Excel + 1, 15] = cicloPC_Two_RCMCI_withReheating.LT.eff.ToString();
                            //LTR Pinch(ºC)
                            xlWorkSheet1.Cells[counter_Excel + 1, 16] = LTR_min_DT_paper.ToString();
                            ...
                            xlWorkSheet1.Cells[counter_Excel + 1, 19] = puntero_aplicacion.PTC_Main_SF_Effective_Apperture_Area.ToString();
                            //PTC_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 20] = puntero_aplicacion.PTC_Main_SF_Pressure_drop.ToString();
                            //LF_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 21] = puntero_aplicacion.LF_Main_SF_Effective_Apperture_Area.ToString();
                            //LF_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 22] = puntero_aplicacion.LF_Main_SF_Pressure_drop.ToString();
                            //PTC_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 23] = puntero_aplicacion.PTC_Reheating_SF_Effective_Apperture_Area.ToString();
                            //PTC_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 24] = puntero_aplicacion.PTC_Reheating_SF_Pressure_drop.ToString();
                            //LF_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 25] = puntero_aplicacion.LF_Reheating_SF_Effective_Apperture_Area.ToString();
                            //LF_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 26] = puntero_aplicacion.LF_Reheating_SF_Pressure_drop.ToString();
                    ...
                    else if (checkBox2.Checked == true)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_PC_Two_RCMCI_withReheating_for_optimization(puntero_aplicacion.luis,
                                ref cicloPC_Two_RCMCI_withReheating, puntero_aplicacion.w_dot_net, i, i, i, i,
                                puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh_in, variables[5],
                                variables[1], variables[2], variables[2], variables[3], variables[3], variables[4],
                                variables[4], puntero_aplicacion.p_mc2_out, variables[6], UA_Total,
                                ...
                                -puntero_aplicacion.dp_pc2, -puntero_aplicacion.dp_phx, -puntero_aplicacion.dp_rhx);
                            ...
                            xlWorkSheet1.Cells[counter_Excel + 1, 10] = Convert.ToString(i - 273.15);
                            //LT UA(kW/K) 
                            xlWorkSheet1.Cells[counter_Excel + 1, 11] = ua_LT_list[maxIndex].ToString();
                            //HT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 12] = ua_HT_list[maxIndex].ToString();
                            //Rec.Frac.
                            xlWorkSheet1.Cells[counter_Excel + 1, 13] = recomp_frac2_list[maxIndex].ToString();
                            //Eff.(%)
                            xlWorkSheet1.Cells[counter_Excel + 1, 14] = (eta_thermal2_list[maxIndex] * 100).ToString();
