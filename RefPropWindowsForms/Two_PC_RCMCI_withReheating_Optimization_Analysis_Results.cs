...
{
    public partial class Two_PC_RCMCI_withReheating_Optimization_Analysis_Results : Form
    {
        Two_PC_RCMCI_withReheating puntero_aplicacion;

        public Two_PC_RCMCI_withReheating_Optimization_Analysis_Results(Two_PC_RCMCI_withReheating puntero1)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                puntero_aplicacion.t_trh_in = Convert.ToDouble(puntero_aplicacion.textBox115.Text);
                puntero_aplicacion.p_trh_in = Convert.ToDouble(puntero_aplicacion.textBox116.Text);
                ...
                puntero_aplicacion.m_eta_trh = Convert.ToDouble(puntero_aplicacion.textBox117.Text);
                ...
                xlWorkSheet1.Cells[4, 5] = "P_rhx_in(kPa)";
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500, initial_CIP_value + 1000, initial_CIP_value + 1500, initial_CIP_value + 3500 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out });

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 1000.0 });

                    var initialValue = new[] { 0.2, initial_CIP_value, initial_CIP_value + 1500.0, initial_CIP_value + 3000.0, initial_CIP_value + 4000.0, 17000.0 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_with_Reheating(puntero_aplicacion.luis, ref cicloTwo_PC_RCMCI_withReheating,
                        puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in, puntero_aplicacion.t_pc2_in,
                        puntero_aplicacion.t_mc4_in, puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_t_in,
                        puntero_aplicacion.t_trh_in, variables[5], variables[1], variables[2], variables[2],
                        variables[3], variables[3], variables[4], variables[4], puntero_aplicacion.p_mc3_out, 
                        ...
                        puntero_aplicacion.massflow2 = cicloTwo_PC_RCMCI_withReheating.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloTwo_PC_RCMCI_withReheating.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloTwo_PC_RCMCI_withReheating.eta_thermal;
                        ...
                        puntero_aplicacion.temp21 = cicloTwo_PC_RCMCI_withReheating.temp[0];
                        puntero_aplicacion.temp22 = cicloTwo_PC_RCMCI_withReheating.temp[1];
                        puntero_aplicacion.temp23 = cicloTwo_PC_RCMCI_withReheating.temp[2];
                        puntero_aplicacion.temp24 = cicloTwo_PC_RCMCI_withReheating.temp[3];
                        puntero_aplicacion.temp25 = cicloTwo_PC_RCMCI_withReheating.temp[4];
                        puntero_aplicacion.temp26 = cicloTwo_PC_RCMCI_withReheating.temp[5];
                        puntero_aplicacion.temp27 = cicloTwo_PC_RCMCI_withReheating.temp[6];
                        puntero_aplicacion.temp28 = cicloTwo_PC_RCMCI_withReheating.temp[7];
                        puntero_aplicacion.temp29 = cicloTwo_PC_RCMCI_withReheating.temp[8];
                        puntero_aplicacion.temp210 = cicloTwo_PC_RCMCI_withReheating.temp[9];
                        puntero_aplicacion.temp211 = cicloTwo_PC_RCMCI_withReheating.temp[10];
                        puntero_aplicacion.temp212 = cicloTwo_PC_RCMCI_withReheating.temp[11];
                        puntero_aplicacion.temp213 = cicloTwo_PC_RCMCI_withReheating.temp[12];
                        ...
                        puntero_aplicacion.pres23 = cicloTwo_PC_RCMCI_withReheating.pres[2];
                        puntero_aplicacion.pres24 = cicloTwo_PC_RCMCI_withReheating.pres[3];
                        puntero_aplicacion.pres25 = cicloTwo_PC_RCMCI_withReheating.pres[4];
                        puntero_aplicacion.pres26 = cicloTwo_PC_RCMCI_withReheating.pres[5];
                        puntero_aplicacion.pres27 = cicloTwo_PC_RCMCI_withReheating.pres[6];
                        puntero_aplicacion.pres28 = cicloTwo_PC_RCMCI_withReheating.pres[7];
                        puntero_aplicacion.pres29 = cicloTwo_PC_RCMCI_withReheating.pres[8];
                        puntero_aplicacion.pres210 = cicloTwo_PC_RCMCI_withReheating.pres[9];
                        puntero_aplicacion.pres211 = cicloTwo_PC_RCMCI_withReheating.pres[10];
                        puntero_aplicacion.pres212 = cicloTwo_PC_RCMCI_withReheating.pres[11];
                        puntero_aplicacion.pres213 = cicloTwo_PC_RCMCI_withReheating.pres[12];
                        ...
                        puntero_aplicacion.LT_Q = cicloTwo_PC_RCMCI_withReheating.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloTwo_PC_RCMCI_withReheating.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloTwo_PC_RCMCI_withReheating.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloTwo_PC_RCMCI_withReheating.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloTwo_PC_RCMCI_withReheating.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloTwo_PC_RCMCI_withReheating.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloTwo_PC_RCMCI_withReheating.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloTwo_PC_RCMCI_withReheating.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloTwo_PC_RCMCI_withReheating.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloTwo_PC_RCMCI_withReheating.LT.eff;

                        puntero_aplicacion.HT_Q = cicloTwo_PC_RCMCI_withReheating.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloTwo_PC_RCMCI_withReheating.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloTwo_PC_RCMCI_withReheating.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloTwo_PC_RCMCI_withReheating.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloTwo_PC_RCMCI_withReheating.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloTwo_PC_RCMCI_withReheating.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloTwo_PC_RCMCI_withReheating.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloTwo_PC_RCMCI_withReheating.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloTwo_PC_RCMCI_withReheating.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloTwo_PC_RCMCI_withReheating.HT.eff;

                        puntero_aplicacion.PC1 = -cicloTwo_PC_RCMCI_withReheating.PC1.Q_dot;
                        puntero_aplicacion.PC2 = -cicloTwo_PC_RCMCI_withReheating.PC2.Q_dot;
                        puntero_aplicacion.PC3 = -cicloTwo_PC_RCMCI_withReheating.PC3.Q_dot;
                        puntero_aplicacion.PC4 = -cicloTwo_PC_RCMCI_withReheating.PC4.Q_dot;
                        ...
                        listBox22.Items.Add(puntero_aplicacion.p_trh_in.ToString());
                        ...
                        double LTR_min_DT_1 = cicloTwo_PC_RCMCI_withReheating.temp[7] - cicloTwo_PC_RCMCI_withReheating.temp[2];
                        double LTR_min_DT_2 = cicloTwo_PC_RCMCI_withReheating.temp[8] - cicloTwo_PC_RCMCI_withReheating.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloTwo_PC_RCMCI_withReheating.temp[7] - cicloTwo_PC_RCMCI_withReheating.temp[3];
                        double HTR_min_DT_2 = cicloTwo_PC_RCMCI_withReheating.temp[6] - cicloTwo_PC_RCMCI_withReheating.temp[4];
                        ...
                        //P_rhx_in(kPa)
                        xlWorkSheet1.Cells[counter_Excel + 1, 5] = Convert.ToString(puntero_aplicacion.p_trh_in);
                        //CIT
                        xlWorkSheet1.Cells[counter_Excel + 1, 6] = Convert.ToString(puntero_aplicacion.t_mc4_in - 273.15);
                        //LT UA(kW/K)
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = cicloTwo_PC_RCMCI_withReheating.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 13] = cicloTwo_PC_RCMCI_withReheating.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    textBox7.Text = p_rhx_in2_list[maxIndex].ToString();
                    ...
                    if (checkBox3.Checked == true)
                    {
                        ...
                        puntero_aplicacion.textBox116.Text = p_rhx_in2_list[maxIndex].ToString();
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "Two_PC_RCMCI_withRH" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500, initial_CIP_value + 1000, initial_CIP_value + 1500, initial_CIP_value + 3500, 0.0 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, 1.0 });

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 1000.0, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value, initial_CIP_value + 1500.0, initial_CIP_value + 3000.0, initial_CIP_value + 4000.0, 17000.0, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_with_Reheating_for_optimization(puntero_aplicacion.luis, 
                        ref cicloTwo_PC_RCMCI_withReheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in, 
                        puntero_aplicacion.t_pc2_in, puntero_aplicacion.t_mc4_in, puntero_aplicacion.t_mc3_in, 
                        puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh_in, variables[5], variables[1], variables[2], 
                        variables[2], variables[3], variables[3], variables[4], variables[4], puntero_aplicacion.p_mc3_out,
                        variables[6], UA_Total, puntero_aplicacion.m_eta_mc4,
                        puntero_aplicacion.m_eta_pc1, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_rc,
                        puntero_aplicacion.m_eta_mc3, puntero_aplicacion.m_eta_t, puntero_aplicacion.m_eta_trh,
                        puntero_aplicacion.n_sub_hxrs, variables[0], puntero_aplicacion.tol, puntero_aplicacion.eta_thermal,
                        -puntero_aplicacion.dp_lt1, -puntero_aplicacion.dp_lt2, -puntero_aplicacion.dp_ht1,
            ...
            for (double j = Convert.ToDouble(textBox11.Text); j <= Convert.ToDouble(textBox10.Text); j = j + Convert.ToDouble(textBox9.Text))
            {
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        List<Double> RHX_list = new List<Double>();
                        ...
                        if (i == Convert.ToDouble(textBox57.Text))
                        {
                            ...
                            xlWorkSheet1.Cells[4, 19] = "PTC_rhx_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 20] = "PTC_rhx_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 21] = "LF_rhx_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 22] = "LF_rhx_Pressure_Drop(bar)";
                        }
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_with_Reheating(puntero_aplicacion.luis, ref cicloTwo_PC_RCMCI_withReheating,
                                puntero_aplicacion.w_dot_net, i, i, i, i, puntero_aplicacion.t_t_in,
                                puntero_aplicacion.t_trh_in, variables[5], variables[1], variables[2], variables[2],
                                variables[3], variables[3], variables[4], variables[4], puntero_aplicacion.p_mc3_out,
                                puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht, puntero_aplicacion.m_eta_mc4,
                                puntero_aplicacion.m_eta_pc1, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_rc,
                                ...
                                PHX_list.Add(cicloTwo_PC_RCMCI_withReheating.PHX.Q_dot);
                                RHX_list.Add(cicloTwo_PC_RCMCI_withReheating.PHX.Q_dot);
                            ...
                            listBox24.Items.Add(p_rhx_in2_list[maxIndex].ToString());
                            ...
                            //P_rhx_in(kPa)
                            xlWorkSheet1.Cells[counter_Excel + 1, 5] = p_rhx_in2_list[maxIndex].ToString();
                            //CIT
                            ...
                            //PTC_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 19] = puntero_aplicacion.PTC_Reheating_SF_Effective_Apperture_Area.ToString();
                            //PTC_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 20] = puntero_aplicacion.PTC_Reheating_SF_Pressure_drop.ToString();
                            //LF_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 21] = puntero_aplicacion.LF_Reheating_SF_Effective_Apperture_Area.ToString();
                            //LF_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 22] = puntero_aplicacion.LF_Reheating_SF_Pressure_drop.ToString();
                    ...
                    else if (checkBox2.Checked == true)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_with_Reheating_for_optimization(puntero_aplicacion.luis,
                                ref cicloTwo_PC_RCMCI_withReheating, puntero_aplicacion.w_dot_net, i, i, i, i,
                                puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh_in, variables[5], variables[1], variables[2],
                                variables[2], variables[3], variables[3], variables[4], variables[4], puntero_aplicacion.p_mc3_out,
                                variables[6], UA_Total, puntero_aplicacion.m_eta_mc4,
                                puntero_aplicacion.m_eta_pc1, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_rc,
                            ...
                            xlWorkSheet1.Cells[counter_Excel + 1, 4] = p_mc4_out2_list[maxIndex].ToString();
                            //P_rhx_in(kPa)
                            xlWorkSheet1.Cells[counter_Excel + 1, 5] = p_mc4_out2_list[maxIndex].ToString();
                            //CIT
                            xlWorkSheet1.Cells[counter_Excel + 1, 6] = Convert.ToString(i - 273.15);
                            //LT UA(kW/K)
