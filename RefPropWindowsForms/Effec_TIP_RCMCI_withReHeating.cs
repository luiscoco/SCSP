...
{
    public partial class Effec_TIP_RCMCI_withReHeating : Form
    {
        ...
        public Effec_TIP_RCMCI_withReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            UA_Total_min = Convert.ToDouble(textBox75.Text);
            UA_Total_max = Convert.ToDouble(textBox73.Text);
            UA_Total_increment = Convert.ToDouble(textBox71.Text);
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
                ...
                TIP_min = Convert.ToDouble(textBox76.Text);
                ...
                TIP_max = Convert.ToDouble(textBox74.Text);
                TIP_increment = Convert.ToDouble(textBox72.Text);
            ...
            else if (radioButton19.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + ReHeating_SF_Effective_Aperture_Area_list[element] + " Effic.: " + ReHeating_SF_Effective_Aperture_Area_list[element1] + " UA: " + ReHeating_SF_Effective_Aperture_Area_list[element2]);
            ...
            else if (radioButton16.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + ReHeating_SF_Pressure_Drop_list[element] + " Effic.: " + ReHeating_SF_Pressure_Drop_list[element1] + " UA: " + ReHeating_SF_Pressure_Drop_list[element2]);
            ...
            else if (radioButton14.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + RHX_Eff_list[element] + " Effic.: " + RHX_Eff_list[element1] + " UA: " + RHX_Eff_list[element2]);
            ...
            else if (radioButton12.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + RHX_UA_list[element] + " Effic.: " + RHX_UA_list[element1] + " UA: " + RHX_UA_list[element2]);
            ...
            else if (radioButton8.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + RHX_Q_list[element] + " Effic.: " + RHX_Q_list[element1] + " UA: " + RHX_Q_list[element2]);
            ...
            if (radioButton1.Checked == true)
            {
                ...
                if (checkBox3.Checked == true)
                {
                    ...
                    chart1.ChartAreas["ChartArea1"].AxisX.Maximum = Convert.ToDouble(textBox69.Text);
                    chart1.ChartAreas["ChartArea1"].AxisY.Minimum = Convert.ToDouble(textBox68.Text);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_RCMCI_WithReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_RCMCI_WithReHeating(this, "Main_SF");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (comboBox5.Text == "Parabolic")
            {
                ...
                ReHeating_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_RCMCI_WithReHeating(this, "ReHeating_SF");
            ...
            else if (comboBox5.Text == "Fresnel")
            {
                ...
                ReHeating_LF_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_RCMCI_WithReHeating(this, "ReHeating_SF");
