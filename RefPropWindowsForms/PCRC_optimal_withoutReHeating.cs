...
{
    public partial class PCRC_optimal_withoutReHeating : Form
    {
        ...
        const string refpropDLL_path4 = "PCRC_Ethane_Optimal_Subplex_without_RH.dll";
        ...
        const string refpropDLL_path5 = "PCRC_Methane_Optimal_Subplex_without_RH.dll";
        ...
        const string refpropDLL_path6 = "PCRC_Nitrogen_Optimal_Subplex_without_RH.dll";
        ...
        const string refpropDLL_path7 = "PCRC_SF6_Optimal_Subplex_without_RH.dll";
        ...
        const string refpropDLL_path8 = "PCRC_Xenon_Optimal_Subplex_without_RH.dll";
        ...
        const string refpropDLL_path2 = "PCRC_CO2_Optimal_Newuoa.dll";
        [DllImport(refpropDLL_path2, EntryPoint = "carbondioxidenewuoa_", SetLastError = true)]
        public static extern void carbondioxidenewuoa_(ref Double w_dot_net1, ref Double t_mc_in1, ref Double t_t_in1, ref Double p_pc_in_guess1, ref Boolean fixed_p_pc_in1, ref Double t_pc_in1,
                                                 ref Double ua_rec_total1, ref Double eta_mc1, ref Double eta_rc1, ref Double eta_pc1, ref Double eta_t1,
                                                 ref Int64 n_sub_hxrs1, ref Double p_high_limit1, ref Double p_mc_out_guess1, ref Boolean fixed_p_mc_out1,
                                                 ref Double pr_mc_guess1, ref Boolean fixed_pr_mc1, ref Double recomp_frac_guess1, ref Boolean fixed_recomp_frac1,
                                                 ref Double lt_frac_guess1, ref Boolean fixed_lt_frac1, ref Double tol1, ref Double opt_tol1, ref Double eta_thermal1,
        ...
        const string refpropDLL_path3 = "PCRC_CO2_Optimal_Uobyqa.dll";
        [DllImport(refpropDLL_path3, EntryPoint = "carbondioxideuobyqa_", SetLastError = true)]
        public static extern void carbondioxideuobyqa_(ref Double w_dot_net1, ref Double t_mc_in1, ref Double t_t_in1, ref Double p_pc_in_guess1, ref Boolean fixed_p_pc_in1, ref Double t_pc_in1,
                                                 ref Double ua_rec_total1, ref Double eta_mc1, ref Double eta_rc1, ref Double eta_pc1, ref Double eta_t1,
                                                 ref Int64 n_sub_hxrs1, ref Double p_high_limit1, ref Double p_mc_out_guess1, ref Boolean fixed_p_mc_out1,
                                                 ref Double pr_mc_guess1, ref Boolean fixed_pr_mc1, ref Double recomp_frac_guess1, ref Boolean fixed_recomp_frac1,
                                                 ref Double lt_frac_guess1, ref Boolean fixed_lt_frac1, ref Double tol1, ref Double opt_tol1, ref Double eta_thermal1,
        ...
        public PCRC_optimal_withoutReHeating()
        {
            InitializeComponent();
        }
        ...
        public Double  ua_rec_total2, pr_mc_guess2, recomp_frac_guess2, lt_frac_guess2;
        public Double  p_high_limit2, p_mc_out_guess2;
        public Boolean fixed_p_mc_out2, fixed_pr_mc2, fixed_recomp_frac2, fixed_lt_frac2,fixed_p_pc_in2;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            carbondioxidenewuoa_(ref  w_dot_net2, ref  t_mc_in2, ref  t_t_in2, ref  p_pc_in_guess2, ref fixed_p_pc_in2, ref  t_pc_in2, ref  ua_rec_total2,
                           ref  eta_mc2, ref  eta_rc2, ref  eta_pc2, ref  eta_t2, ref  n_sub_hxrs2, ref  p_high_limit2,
                           ref  p_mc_out_guess2, ref  fixed_p_mc_out2, ref  pr_mc_guess2, ref  fixed_pr_mc2, ref  recomp_frac_guess2, ref  fixed_recomp_frac2,
                           ref  lt_frac_guess2, ref  fixed_lt_frac2, ref  tol2, ref  opt_tol2, ref  eta_thermal2,
                           ref  dp2_lt1, ref  dp2_lt2, ref  dp2_ht1, ref  dp2_ht2, ref  dp2_pc1, ref  dp2_pc2, ref  dp2_phx1,
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            carbondioxideuobyqa_(ref  w_dot_net2, ref  t_mc_in2, ref  t_t_in2, ref  p_pc_in_guess2, ref fixed_p_pc_in2, ref  t_pc_in2, ref  ua_rec_total2,
                           ref  eta_mc2, ref  eta_rc2, ref  eta_pc2, ref  eta_t2, ref  n_sub_hxrs2, ref  p_high_limit2,
                           ref  p_mc_out_guess2, ref  fixed_p_mc_out2, ref  pr_mc_guess2, ref  fixed_pr_mc2, ref  recomp_frac_guess2, ref  fixed_recomp_frac2,
                           ref  lt_frac_guess2, ref  fixed_lt_frac2, ref  tol2, ref  opt_tol2, ref  eta_thermal2,
                           ref  dp2_lt1, ref  dp2_lt2, ref  dp2_ht1, ref  dp2_ht2, ref  dp2_pc1, ref  dp2_pc2, ref  dp2_phx1,
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Pre_Compressor1.textBox8.Text = Convert.ToString(recomp_frac_guess2);
            ...
            if (comboBox4.Text == "Parabolic")
            {
                SF_PHX = new PTC_Solar_Field();
                    ...
                    SF_PHX.PTC_Solar_Field_ciclo_PCRC_Optimization_withoutReHeating(this, 7, "Main_SF");
                ...
                else if (comboBox4.Text == "Fresnel")
                {
                    ...
                    SF_PHX_LF.LF_Solar_Field_ciclo_PCRC_Optimization_withoutReHeating(this, 7, "Main_SF");
            ...
            Generator_dialog.PCRC_Optimization_withoutReHeating(this, 7);
            ...
            Net_Power_dialog.PCRC_Optimization_withoutReHeating(this, 7);
            ...
            Final_Report_dialog.Ciclo_PCRC_Optimization_withoutReHeating(this, 7);
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            ...
            Diagrams_dialog.PCRC_Optimization_withoutReHeating(this, 7);
            Diagrams_dialog.button2_Click(this, e);
            Diagrams_dialog.Show();
        }

        //SIMPLE Brayton cycle Check box
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            if (comboBox11.Text == "Parabolic")
            {
                ...
                PHX1_temp_out = Convert.ToDouble(textBox55.Text);
                ...
                SF_PHX.PTC_Solar_Field_uno(luis);
                SF_PHX.PTC_Solar_Field_ciclo_PCRC_Optimization_withoutReHeating(this, 7, "Main_SF1_Dual_Loop");
                SF_PHX.button3_Click(this, e);
                SF_PHX.Show();
            }
            ...
            else if (comboBox11.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_uno(luis);
                SF_PHX_LF.LF_Solar_Field_ciclo_PCRC_Optimization_withoutReHeating(this, 7, "Main_SF1_Dual_Loop");
                SF_PHX_LF.Load_ComboBox7();
                SF_PHX_LF.button3_Click(this, e);
                SF_PHX_LF.Show();
            }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            if (comboBox10.Text == "Parabolic")
            {
                ...
                SF_PHX.textBox35.Text = Convert.ToString(pres26);
                SF_PHX.PTC_Solar_Field_uno(luis);
                SF_PHX.PTC_Solar_Field_ciclo_PCRC_Optimization_withoutReHeating(this, 7, "Main_SF2_Dual_Loop");
                SF_PHX.button3_Click(this, e);
                SF_PHX.Show();
            }
            ...
            else if (comboBox10.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.textBox35.Text = Convert.ToString(pres26);
                SF_PHX_LF.LF_Solar_Field_uno(luis);
                SF_PHX_LF.LF_Solar_Field_ciclo_PCRC_Optimization_withoutReHeating(this, 8, "Main_SF2_Dual_Loop");
                SF_PHX_LF.Load_ComboBox7();
                SF_PHX_LF.button3_Click(this, e);
                SF_PHX_LF.Show();
            }
