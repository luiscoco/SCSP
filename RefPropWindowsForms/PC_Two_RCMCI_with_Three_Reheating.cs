...
{
    public partial class PC_Two_RCMCI_with_Three_Reheating : Form
    {
        //Input Data:
        ...
        {
            PC_Two_RCMCI_with_Three_ReHeating_Optimization_Analysis_Results PC_Two_RCMCI_with_Three_ReHeating_Optimization_Analysis_Results_dialog = new PC_Two_RCMCI_with_Three_ReHeating_Optimization_Analysis_Results(this);
            PC_Two_RCMCI_with_Three_ReHeating_Optimization_Analysis_Results_dialog.Show();
        }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            t_trh1_in = Convert.ToDouble(textBox116.Text);
            p_trh1_in = Convert.ToDouble(textBox117.Text);

            t_trh2_in = Convert.ToDouble(textBox125.Text);
            p_trh2_in = Convert.ToDouble(textBox126.Text);

            t_trh3_in = Convert.ToDouble(textBox132.Text);
            p_trh3_in = Convert.ToDouble(textBox133.Text);
            ...
            m_eta_trh3 = Convert.ToDouble(textBox131.Text);
            ...
            dp_rhx1 = Convert.ToDouble(textBox118.Text);
            dp_rhx2 = Convert.ToDouble(textBox134.Text);
            dp_rhx3 = Convert.ToDouble(textBox124.Text);
            ...
            luis.RecompCycle_PC_Two_RCMCI_with_Three_Reheating(luis, ref cicloPC_Two_RCMCI_with_Three_Reheating,
            w_dot_net, t_pc_in, t_mc4_in, t_mc3_in, t_mc2_in, t_t_in, t_trh1_in, p_trh1_in, t_trh2_in, p_trh2_in, t_trh3_in, p_trh3_in,
            p_pc_in, p_pc_out, p_mc4_in, p_mc4_out, p_mc3_in, p_mc3_out, p_mc2_in, p_mc2_out, ua_lt, ua_ht,
            m_eta_mc4, m_eta_pc, m_eta_rc, m_eta_mc3, m_eta_mc2, m_eta_t, m_eta_trh1, m_eta_trh2, m_eta_trh3, n_sub_hxrs,
            m_recomp_frac, tol, eta_thermal, -dp_lt1, -dp_lt2, -dp_ht1, -dp_ht2, -dp_pc1, -dp_pc4, -dp_pc3, -dp_pc2,
            -dp_phx, -dp_rhx1, -dp_rhx2, -dp_rhx3);

            massflow2 = cicloPC_Two_RCMCI_with_Three_Reheating.m_dot_turbine;
            w_dot_net2 = cicloPC_Two_RCMCI_with_Three_Reheating.W_dot_net;
            eta_thermal2 = cicloPC_Two_RCMCI_with_Three_Reheating.eta_thermal;
            ...
            temp21 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[0];
            temp22 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[1];
            temp23 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[2];
            temp24 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[3];
            temp25 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[4];
            temp26 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[5];
            temp27 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[6];
            temp28 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[7];
            temp29 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[8];
            temp210 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[9];
            temp211 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[10];
            temp212 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[11];
            temp213 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[12];
            temp214 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[13];
            temp215 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[14];
            temp216 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[15];
            temp217 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[16];
            temp218 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[17];
            temp219 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[18];
            temp220 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[19];
            temp221 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[20];
            temp222 = cicloPC_Two_RCMCI_with_Three_Reheating.temp[21];

            pres21 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[0];
            pres22 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[1];
            pres23 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[2];
            pres24 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[3];
            pres25 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[4];
            pres26 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[5];
            pres27 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[6];
            pres28 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[7];
            pres29 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[8];
            pres210 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[9];
            pres211 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[10];
            pres212 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[11];
            pres213 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[12];
            pres214 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[13];
            pres215 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[14];
            pres216 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[15];
            pres217 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[16];
            pres218 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[17];
            pres219 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[18];
            pres220 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[19];
            pres221 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[20];
            pres222 = cicloPC_Two_RCMCI_with_Three_Reheating.pres[21];
            ...
            textBox119.Text = Convert.ToString(temp220);
            textBox128.Text = Convert.ToString(temp221);
            textBox127.Text = Convert.ToString(temp222);
            ...
            textBox122.Text = Convert.ToString(pres219);
            textBox121.Text = Convert.ToString(pres220);
            textBox130.Text = Convert.ToString(pres221);
            ...
            String point7_state, point8_state, point9_state, point10_state, point11_state, point12_state,
                   ...
                   point19_state, point20_state, point21_state, point22_state;
            ...
            {
                PHX = cicloPC_Two_RCMCI_with_Three_Reheating.PHX.Q_dot;
                RHX1 = cicloPC_Two_RCMCI_with_Three_Reheating.RHX1.Q_dot;
                RHX2 = cicloPC_Two_RCMCI_with_Three_Reheating.RHX2.Q_dot;
                RHX3 = cicloPC_Two_RCMCI_with_Three_Reheating.RHX3.Q_dot;

                recomp_frac2 = cicloPC_Two_RCMCI_with_Three_Reheating.recomp_frac;

                LT_Q = cicloPC_Two_RCMCI_with_Three_Reheating.LT.Q_dot;
                LT_mdotc = cicloPC_Two_RCMCI_with_Three_Reheating.LT.m_dot_design[0];
                LT_mdoth = cicloPC_Two_RCMCI_with_Three_Reheating.LT.m_dot_design[1];
                LT_Tcin = cicloPC_Two_RCMCI_with_Three_Reheating.LT.T_c_in;
                LT_Thin = cicloPC_Two_RCMCI_with_Three_Reheating.LT.T_h_in;
                LT_Pcin = cicloPC_Two_RCMCI_with_Three_Reheating.LT.P_c_in;
                LT_Phin = cicloPC_Two_RCMCI_with_Three_Reheating.LT.P_h_in;
                LT_Pcout = cicloPC_Two_RCMCI_with_Three_Reheating.LT.P_c_out;
                LT_Phout = cicloPC_Two_RCMCI_with_Three_Reheating.LT.P_h_out;
                LT_Effc = cicloPC_Two_RCMCI_with_Three_Reheating.LT.eff;

                HT_Q = cicloPC_Two_RCMCI_with_Three_Reheating.HT.Q_dot;
                HT_mdotc = cicloPC_Two_RCMCI_with_Three_Reheating.HT.m_dot_design[0];
                HT_mdoth = cicloPC_Two_RCMCI_with_Three_Reheating.HT.m_dot_design[1];
                HT_Tcin = cicloPC_Two_RCMCI_with_Three_Reheating.HT.T_c_in;
                HT_Thin = cicloPC_Two_RCMCI_with_Three_Reheating.HT.T_h_in;
                HT_Pcin = cicloPC_Two_RCMCI_with_Three_Reheating.HT.P_c_in;
                HT_Phin = cicloPC_Two_RCMCI_with_Three_Reheating.HT.P_h_in;
                HT_Pcout = cicloPC_Two_RCMCI_with_Three_Reheating.HT.P_c_out;
                HT_Phout = cicloPC_Two_RCMCI_with_Three_Reheating.HT.P_h_out;
                HT_Effc = cicloPC_Two_RCMCI_with_Three_Reheating.HT.eff;

                PC1 = -cicloPC_Two_RCMCI_with_Three_Reheating.PC1.Q_dot;
                PC2 = -cicloPC_Two_RCMCI_with_Three_Reheating.PC2.Q_dot;
                PC3 = -cicloPC_Two_RCMCI_with_Three_Reheating.PC3.Q_dot;
                PC4 = -cicloPC_Two_RCMCI_with_Three_Reheating.PC4.Q_dot;
        ...
        {
            Precooler_dialog4 = new PreeCooler();
            Precooler_dialog4.textBox2.Text = Convert.ToString(-PC4);
            Precooler_dialog4.textBox4.Text = Convert.ToString(massflow2 * (1 - recomp_frac2));
            Precooler_dialog4.textBox6.Text = Convert.ToString(temp214);
            Precooler_dialog4.textBox12.Text = Convert.ToString(pres214);
            Precooler_dialog4.textBox8.Text = Convert.ToString(pres215);
            Precooler_dialog4.PreeCooler1(luis);
            Precooler_dialog4.Calculate_Cooler();
            Precooler_dialog4.Show();
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            Main_Compressor4 = new snl_compressor_tsr();
            Main_Compressor4.textBox1.Text = Convert.ToString(pres21);
            Main_Compressor4.textBox2.Text = Convert.ToString(temp21);
            Main_Compressor4.textBox6.Text = Convert.ToString(pres22);
            Main_Compressor4.textBox5.Text = Convert.ToString(temp22);
            Main_Compressor4.textBox9.Text = Convert.ToString(massflow2);
            Main_Compressor4.textBox8.Text = Convert.ToString(recomp_frac2);
            Main_Compressor4.button3.Enabled = false;
            Main_Compressor4.button5.Enabled = false;
            Main_Compressor4.button6.Enabled = false;
            Main_Compressor4.button7.Enabled = false;
            Main_Compressor4.Calculate_Main_Compressor();
            N_design_Main_Compressor = Convert.ToDouble(Main_Compressor4.textBox11.Text);

            Main_Compressor4.Show();
        }

        //Compressor (C3)
        private void button2_Click(object sender, EventArgs e)
        {
            Main_Compressor3 = new snl_compressor_tsr();
            Main_Compressor3.textBox1.Text = Convert.ToString(pres213);
            Main_Compressor3.textBox2.Text = Convert.ToString(temp213);
            Main_Compressor3.textBox6.Text = Convert.ToString(pres214);
            Main_Compressor3.textBox5.Text = Convert.ToString(temp214);
            Main_Compressor3.textBox9.Text = Convert.ToString(massflow2);
            Main_Compressor3.textBox8.Text = Convert.ToString(recomp_frac2);
            Main_Compressor3.button3.Enabled = false;
            Main_Compressor3.button5.Enabled = false;
            Main_Compressor3.button6.Enabled = false;
            Main_Compressor3.button7.Enabled = false;
            Main_Compressor3.Calculate_Main_Compressor();
            N_design_Main_Compressor = Convert.ToDouble(Main_Compressor3.textBox11.Text);

            Main_Compressor3.Show();
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            Main_Compressor2.textBox1.Text = Convert.ToString(pres215);
            Main_Compressor2.textBox2.Text = Convert.ToString(temp215);
            Main_Compressor2.textBox6.Text = Convert.ToString(pres216);
            Main_Compressor2.textBox5.Text = Convert.ToString(temp216);
        ...
        private void button31_Click(object sender, EventArgs e)
        {
            ...
            Main_Turbine.textBox6.Text = Convert.ToString(pres219);
            Main_Turbine.textBox2.Text = Convert.ToString(temp218);
            Main_Turbine.textBox5.Text = Convert.ToString(temp219);
            Main_Turbine.textBox9.Text = Convert.ToString(massflow2);
            Main_Turbine.textBox8.Text = Convert.ToString(recomp_frac2);
            Main_Turbine.textBox3.Text = Convert.ToString(N_design_Main_Compressor);
            Main_Turbine.calculate_Radial_Turbine();
        ...
        {
            Main_Turbine = new Radial_Turbine();
            Main_Turbine.textBox1.Text = Convert.ToString(pres220);
            Main_Turbine.textBox6.Text = Convert.ToString(pres221);
            Main_Turbine.textBox2.Text = Convert.ToString(temp220);
            Main_Turbine.textBox5.Text = Convert.ToString(temp221);
            Main_Turbine.textBox9.Text = Convert.ToString(massflow2);
            Main_Turbine.textBox8.Text = Convert.ToString(recomp_frac2);
            Main_Turbine.textBox3.Text = Convert.ToString(N_design_Main_Compressor);
            Main_Turbine.calculate_Radial_Turbine();
        ...
        {
            Main_Turbine = new Radial_Turbine();
            Main_Turbine.textBox1.Text = Convert.ToString(pres222);
            Main_Turbine.textBox6.Text = Convert.ToString(pres27);
            Main_Turbine.textBox2.Text = Convert.ToString(temp222);
