...
namespace NLoptNet
{
	...
	public class NLoptSolver : IDisposable
	{
		...
		public NLoptSolver(NLoptAlgorithm algorithm, uint numVariables, double relativeStoppingTolerance = 0.000001, int maximumIterations = 0, NLoptAlgorithm? childAlgorithm = null)
		{
			if (numVariables < 1)
