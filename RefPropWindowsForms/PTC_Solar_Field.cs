...
namespace RefPropWindowsForms
{
    public partial class PTC_Solar_Field : Form
    {
        ...
        public RC_withReHeating_new_proposed_configuration Punterociclo_23;
        ...
        // RC_Design_WithReHeating: Brayton_cycle_type_variable = 23
        public void PTC_Solar_Field_ciclo_RC_Design_withReHeating_new_configuration(RC_withReHeating_new_proposed_configuration Punterociclo23, Double Brayton_cycle_type, String SF_Type)
        {
            SF_Type_variable = SF_Type;
            Brayton_cycle_type_variable = Brayton_cycle_type;
            Punterociclo_23 = Punterociclo23;
        }
        ...
        public void PTC_Solar_Field_ciclo_PCRC_Optimization_withReHeating_new_configuration(PCRC_withReHeating_new_proposed_configuration Punterociclo26, Double Brayton_cycle_type, String SF_Type)
        {
            SF_Type_variable = SF_Type;
            Brayton_cycle_type_variable = Brayton_cycle_type;
            Punterociclo_26 = Punterociclo26;
        }
        ...
        public void PTC_Solar_Field_ciclo_PCRC_with_Two_Intercooling_without_ReHeating(PCRC_with_Two_Intercooling_without_ReHeating Punterociclo27, Double Brayton_cycle_type, String SF_Type)
        {
            SF_Type_variable = SF_Type;
            Brayton_cycle_type_variable = Brayton_cycle_type;
        ...
        public void PTC_Solar_Field_ciclo_RCMCI_Design_withReHeating_new_configuration(RCMCI_with_ReHeating_new_proposed_configuration Punterociclo24, Double Brayton_cycle_type, String SF_Type)
        {
            SF_Type_variable = SF_Type;
            Brayton_cycle_type_variable = Brayton_cycle_type;
        ...
        // RCMCI_with_Two_Intercooling_without_Reheating: Brayton_cycle_type_variable = 28
        public void PTC_Solar_Field_ciclo_RCMCI_with_Two_Intercooling_without_Reheating(RCMCI_with_Two_Intercooling_without_Reheating Punterociclo28, Double Brayton_cycle_type, String SF_Type)
        {
            SF_Type_variable = SF_Type;
            Brayton_cycle_type_variable = Brayton_cycle_type;
            Punterociclo_28 = Punterociclo28;
        }
        ...
        public void PTC_Solar_Field_ciclo_RC_Design_withoutReHeating_new_configuration(RC_without_ReHeating_new_proposed_configuration Punterociclo21, Double Brayton_cycle_type, String SF_Type)
        {
            SF_Type_variable = SF_Type;
            Brayton_cycle_type_variable = Brayton_cycle_type;
        ...
        // RCMCI_Design_WithoutReHeating_new_configuration: Brayton_cycle_type_variable = 22
        public void PTC_Solar_Field_ciclo_RCMCI_Design_withoutReHeating_new_configuration(RCMCI_without_ReHeating_new_proposed_configuration Punterociclo22, Double Brayton_cycle_type, String SF_Type)
        {
            SF_Type_variable = SF_Type;
            Brayton_cycle_type_variable = Brayton_cycle_type;
            Punterociclo_22 = Punterociclo22;
        }
        ...
        public void Calculate_PHX()
        {
            ...
            else if (this.Brayton_cycle_type_variable == 23)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_23.temp212 + Convert.ToDouble(textBox107.Text));
                }

                else if (this.SF_Type_variable == "Main_SF1_Dual_Loop")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_23.PHX1_temp_out + Convert.ToDouble(textBox107.Text));
                }
                ...
                {
                    textBox37.Text = Convert.ToString(Punterociclo_23.temp214 + Convert.ToDouble(textBox107.Text));
                }

                else if (this.SF_Type_variable == "ReHeating_SF1_Dual_Loop")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_23.RHX1_temp_out + Convert.ToDouble(textBox107.Text));
                }
            ...
            else if (this.Brayton_cycle_type_variable == 22)
            {
                ...
                {
                    textBox37.Text = Convert.ToString(Punterociclo_22.PHX1_temp_out + Convert.ToDouble(textBox107.Text));
                }
            ...
            else if (this.Brayton_cycle_type_variable == 18)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_18.temp26 + Convert.ToDouble(textBox107.Text));
                }               

                else if (this.SF_Type_variable == "ReHeating1_SF")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_18.temp212 + Convert.ToDouble(textBox107.Text));
                }

                else if (this.SF_Type_variable == "ReHeating2_SF")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_18.temp216 + Convert.ToDouble(textBox107.Text));
                }

                else if (this.SF_Type_variable == "ReHeating3_SF")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_18.temp218 + Convert.ToDouble(textBox107.Text));
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 26)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_26.temp212 + Convert.ToDouble(textBox107.Text));
                }

                else if (this.SF_Type_variable == "Main_SF1_Dual_Loop")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_26.PHX1_temp_out + Convert.ToDouble(textBox107.Text));
                }
                ...
                {
                    textBox37.Text = Convert.ToString(Punterociclo_26.temp216 + Convert.ToDouble(textBox107.Text));
                }

                else if (this.SF_Type_variable == "ReHeating_SF1_Dual_Loop")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_26.RHX1_temp_out + Convert.ToDouble(textBox107.Text));
                }
            ...
            else if (this.Brayton_cycle_type_variable == 28)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_28.temp26 + Convert.ToDouble(textBox107.Text));
                }

                else if (this.SF_Type_variable == "Main_SF1_Dual_Loop")
                {
                    textBox37.Text = Convert.ToString(Punterociclo_28.PHX1_temp_out + Convert.ToDouble(textBox107.Text));
                }
        ...
        public void button3_Click(object sender, EventArgs e)
        {
            ...
            else if (this.Brayton_cycle_type_variable == 23)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_23.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "ReHeating_SF")
                {
                    Punterociclo_23.ReHeating_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF1_Dual_Loop")
                {
                    Punterociclo_23.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                    Punterociclo_23.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1 = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF2_Dual_Loop")
                {
                    Punterociclo_23.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption + Punterociclo_23.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1;
                    Punterociclo_23.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_2 = Electrical_Consumption;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 21)
            {
                ...
                {
                    Punterociclo_21.ReHeating_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF1_Dual_Loop")
                {
                    Punterociclo_21.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                    Punterociclo_21.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1 = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF2_Dual_Loop")
                {
                    Punterociclo_21.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption + Punterociclo_21.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1;
                    Punterociclo_21.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_2 = Electrical_Consumption;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 22)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_22.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "ReHeating_SF")
                {
                    Punterociclo_22.ReHeating_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF1_Dual_Loop")
                {
                    Punterociclo_22.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                    Punterociclo_22.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1 = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF2_Dual_Loop")
                {
                    Punterociclo_22.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption + Punterociclo_22.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1;
                    Punterociclo_22.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_2 = Electrical_Consumption;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 18)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_18.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "ReHeating1_SF")
                {
                    Punterociclo_18.ReHeating1_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "ReHeating2_SF")
                {
                    Punterociclo_18.ReHeating2_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "ReHeating3_SF")
                {
                    Punterociclo_18.ReHeating3_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 26)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_26.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "ReHeating_SF")
                {
                    Punterociclo_26.ReHeating_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF1_Dual_Loop")
                {
                    Punterociclo_26.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                    Punterociclo_26.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1 = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF2_Dual_Loop")
                {
                    Punterociclo_26.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption + Punterociclo_26.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1;
                    Punterociclo_26.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_2 = Electrical_Consumption;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 27)
            {
                ...
                {
                    Punterociclo_27.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                    Punterociclo_27.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1 = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF2_Dual_Loop")
                {
                    Punterociclo_27.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption + Punterociclo_27.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1;
                    Punterociclo_27.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_2 = Electrical_Consumption;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 24)
            {
                ...
                {
                    Punterociclo_24.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                    Punterociclo_24.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1 = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF2_Dual_Loop")
                {
                    Punterociclo_24.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption + Punterociclo_24.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1;
                    Punterociclo_24.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_2 = Electrical_Consumption;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 28)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_28.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF1_Dual_Loop")
                {
                    Punterociclo_28.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption;
                    Punterociclo_28.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1 = Electrical_Consumption;
                }

                else if (this.SF_Type_variable == "Main_SF2_Dual_Loop")
                {
                    Punterociclo_28.Main_SF_Pump_Electrical_Consumption = Electrical_Consumption + Punterociclo_28.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_1;
                    Punterociclo_28.Dual_Loop_PTC_Main_SF_Pump_Motor_Elec_Consump_2 = Electrical_Consumption;
                }
            }
        ...
        public void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (this.Brayton_cycle_type_variable == 23)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_23.PTC_Main_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }

                else if (this.SF_Type_variable == "ReHeating_SF")
                {
                    Punterociclo_23.PTC_ReHeating_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable ==21)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_21.PTC_Main_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 22)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_22.PTC_Main_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 18)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_18.PTC_Main_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
                else if (this.SF_Type_variable == "ReHeating1_SF")
                {
                    Punterociclo_18.PTC_ReHeating1_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
                else if (this.SF_Type_variable == "ReHeating2_SF")
                {
                    Punterociclo_18.PTC_ReHeating2_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
                else if (this.SF_Type_variable == "ReHeating3_SF")
                {
                    Punterociclo_18.PTC_ReHeating3_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 26)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_26.PTC_Main_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }

                else if (this.SF_Type_variable == "ReHeating_SF")
                {
                    Punterociclo_26.PTC_ReHeating_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 27)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_27.PTC_Main_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 24)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_24.PTC_Main_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }

                else if (this.SF_Type_variable == "ReHeating_SF")
                {
                    Punterociclo_24.PTC_ReHeating_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
            }
            ...
            else if (this.Brayton_cycle_type_variable == 28)
            {
                if (this.SF_Type_variable == "Main_SF")
                {
                    Punterociclo_28.PTC_Main_SF_Effective_Apperture_Area = PTC_SF_Effective_Apperture_Area;
                }
            }
