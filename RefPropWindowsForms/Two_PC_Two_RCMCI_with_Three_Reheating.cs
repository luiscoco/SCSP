...
namespace RefPropWindowsForms
{
    public partial class Two_PC_Two_RCMCI_with_Three_Reheating : Form
    {
        ...
        {
            Two_PC_Two_RCMCI_with_Three_Reheating_Optimization_Analysis_Results Two_PC_Two_RCMCI_with_Three_Reheating_Optimization_Analysis_Results_dialog = new Two_PC_Two_RCMCI_with_Three_Reheating_Optimization_Analysis_Results();
