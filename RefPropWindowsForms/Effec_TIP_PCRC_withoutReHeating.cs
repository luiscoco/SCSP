...
{
    public partial class Effec_TIP_PCRC_withoutReHeating : Form
    {
        ...
        public Effec_TIP_PCRC_withoutReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button14_Click(object sender, EventArgs e)
        {
           ...
           //if (Convert.ToDouble(textBox23.Text) < 20000)
           //{
           //     textBox30.Text = "2.0";
           //     pr_mc_guess2 = Convert.ToDouble(textBox30.Text);               
           // }

           //else if (Convert.ToDouble(textBox23.Text) > 20000)
           //{
                textBox30.Text = "2.5";
                pr_mc_guess2 = Convert.ToDouble(textBox30.Text);
           //}
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
                ...
                if (TIP_min < 17500)
                {
                    MessageBox.Show("Error, TIP should be above 17500");
                }
                ...
                {
                    textBox23.Text = Convert.ToString(TIP_temp_value);
            ...
            if (radioButton1.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + eta_list[element] + " Effic.: " + eta_list[element1] + " UA: " + eta_list[element2]);
            ...
            else if (radioButton4.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + LT_UA_list[element] + " Effic.: " + LT_UA_list[element1] + " UA: " + LT_UA_list[element2]);
            ...
            else if (radioButton3.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + HT_UA_list[element] + " Effic.: " + HT_UA_list[element1] + " UA: " + HT_UA_list[element2]);
            ...
            else if (radioButton5.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + PR_frac_list[element] + " Effic.: " + PR_frac_list[element1] + " UA: " + PR_frac_list[element2]);
            ...
            else if (radioButton7.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + CIP_list[element] + " Effic.: " + CIP_list[element1] + " UA: " + CIP_list[element2]);
            ...
            else if (radioButton8.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + LT_HX_Eff_list[element] + " Effic.: " + LT_HX_Eff_list[element1] + " UA: " + LT_HX_Eff_list[element2]);
            ...
            else if (radioButton9.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + LT_HX_min_DT_list[element] + " Effic.: " + LT_HX_min_DT_list[element1] + " UA: " + LT_HX_min_DT_list[element2]);
            ...
            else if (radioButton20.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + Main_SF_Effective_Aperture_Area_list[element] + " Effic.: " + Main_SF_Effective_Aperture_Area_list[element1] + " UA: " + Main_SF_Effective_Aperture_Area_list[element2]);
            ...
            else if (radioButton15.Checked == true)
            {
                ...
                {
                    comboBox8.Items.Add("TIP: " + Main_SF_Pressure_Drop_list[element] + " Effic.: " + Main_SF_Pressure_Drop_list[element1] + " UA: " + Main_SF_Pressure_Drop_list[element2]);
            ...
            {
                TIP = new double[PC2_Eff_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add("TIP: " + PC2_Eff_list[element] + " Effic.: " + PC2_Eff_list[element1] + " UA: " + PC2_Eff_list[element2]);
                    TIP[contador] = PC2_Eff_list[element];
            ...
            {
                TIP = new double[PC2_UA_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add("TIP: " + PC2_UA_list[element] + " Effic.: " + PC2_UA_list[element1] + " UA: " + PC2_UA_list[element2]);
                    TIP[contador] = PC2_UA_list[element];
            ...
            {
                TIP = new double[PC2_Q_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add("TIP: " + PC2_Q_list[element] + " Effic.: " + PC2_Q_list[element1] + " UA: " + PC2_Q_list[element2]);
                    TIP[contador] = PC2_Q_list[element];
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_PCRC_Without_ReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_PCRC_Without_ReHeating(this, "Main_SF");
