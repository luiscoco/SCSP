...
{
    public partial class PCRCMCI_with_Three_ReHeating_Optimization_Analysis_Results : Form
    {
        PCRCMCI_with_Three_ReHeating puntero_aplicacion;

        public PCRCMCI_with_Three_ReHeating_Optimization_Analysis_Results(PCRCMCI_with_Three_ReHeating puntero1)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                puntero_aplicacion.p_rhx3_in = Convert.ToDouble(puntero_aplicacion.textBox125.Text);
                puntero_aplicacion.t_rht3_in = Convert.ToDouble(puntero_aplicacion.textBox124.Text);
                ...
                puntero_aplicacion.dp_rhx3 = Convert.ToDouble(puntero_aplicacion.textBox123.Text);
                ...
                puntero_aplicacion.m_eta_trh3 = Convert.ToDouble(puntero_aplicacion.textBox122.Text);
                ...
                using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                {
                    ...
                    initial_CIP_value + 1000.0, initial_CIP_value + 3000.0, initial_CIP_value + 2000.0 , initial_CIP_value + 1500.0});
                    
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out, puntero_aplicacion.p_mc2_out, 
                    puntero_aplicacion.p_mc2_out, puntero_aplicacion.p_mc2_out, puntero_aplicacion.p_mc2_out , puntero_aplicacion.p_mc2_out});

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 1000.0, 1000.0, 1000.0 });

                    var initialValue = new[] { 0.2, initial_CIP_value + 1000.0, initial_CIP_value + 2000.0,
                                               initial_CIP_value + 3000.0, 16000.0, 14000.0 , 13000.0};

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PCRCMCI_withThreeReheating(puntero_aplicacion.luis,
                        ref cicloPCRCMCI_withThreeRH, puntero_aplicacion.w_dot_net,
                        puntero_aplicacion.t_pc_in, puntero_aplicacion.t_mc1_in, puntero_aplicacion.t_mc2_in,
                        puntero_aplicacion.t_t_in, puntero_aplicacion.t_rht1_in, variables[4],
                        puntero_aplicacion.t_rht2_in, variables[5], puntero_aplicacion.t_rht3_in,
                        variables[6], variables[1], variables[2],
                        ...
                        -puntero_aplicacion.dp_pc3, -puntero_aplicacion.dp_phx, -puntero_aplicacion.dp_rhx1,
                        -puntero_aplicacion.dp_rhx2, -puntero_aplicacion.dp_rhx3);

                        counter++;

                        puntero_aplicacion.massflow2 = cicloPCRCMCI_withThreeRH.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloPCRCMCI_withThreeRH.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloPCRCMCI_withThreeRH.eta_thermal;
                        ...
                        puntero_aplicacion.p_rhx3_in = variables[6];

                        puntero_aplicacion.temp21 = cicloPCRCMCI_withThreeRH.temp[0];
                        puntero_aplicacion.temp22 = cicloPCRCMCI_withThreeRH.temp[1];
                        puntero_aplicacion.temp23 = cicloPCRCMCI_withThreeRH.temp[2];
                        puntero_aplicacion.temp24 = cicloPCRCMCI_withThreeRH.temp[3];
                        puntero_aplicacion.temp25 = cicloPCRCMCI_withThreeRH.temp[4];
                        puntero_aplicacion.temp26 = cicloPCRCMCI_withThreeRH.temp[5];
                        puntero_aplicacion.temp27 = cicloPCRCMCI_withThreeRH.temp[6];
                        puntero_aplicacion.temp28 = cicloPCRCMCI_withThreeRH.temp[7];
                        puntero_aplicacion.temp29 = cicloPCRCMCI_withThreeRH.temp[8];
                        puntero_aplicacion.temp210 = cicloPCRCMCI_withThreeRH.temp[9];
                        puntero_aplicacion.temp211 = cicloPCRCMCI_withThreeRH.temp[10];
                        puntero_aplicacion.temp212 = cicloPCRCMCI_withThreeRH.temp[11];
                        puntero_aplicacion.temp213 = cicloPCRCMCI_withThreeRH.temp[12];
                        puntero_aplicacion.temp214 = cicloPCRCMCI_withThreeRH.temp[13];
                        puntero_aplicacion.temp215 = cicloPCRCMCI_withThreeRH.temp[14];
                        puntero_aplicacion.temp216 = cicloPCRCMCI_withThreeRH.temp[15];
                        puntero_aplicacion.temp217 = cicloPCRCMCI_withThreeRH.temp[16];
                        puntero_aplicacion.temp218 = cicloPCRCMCI_withThreeRH.temp[17];
                        puntero_aplicacion.temp219 = cicloPCRCMCI_withThreeRH.temp[18];
                        puntero_aplicacion.temp220 = cicloPCRCMCI_withThreeRH.temp[19];

                        puntero_aplicacion.pres21 = cicloPCRCMCI_withThreeRH.pres[0];
                        puntero_aplicacion.pres22 = cicloPCRCMCI_withThreeRH.pres[1];
                        puntero_aplicacion.pres23 = cicloPCRCMCI_withThreeRH.pres[2];
                        puntero_aplicacion.pres24 = cicloPCRCMCI_withThreeRH.pres[3];
                        puntero_aplicacion.pres25 = cicloPCRCMCI_withThreeRH.pres[4];
                        puntero_aplicacion.pres26 = cicloPCRCMCI_withThreeRH.pres[5];
                        puntero_aplicacion.pres27 = cicloPCRCMCI_withThreeRH.pres[6];
                        puntero_aplicacion.pres28 = cicloPCRCMCI_withThreeRH.pres[7];
                        puntero_aplicacion.pres29 = cicloPCRCMCI_withThreeRH.pres[8];
                        puntero_aplicacion.pres210 = cicloPCRCMCI_withThreeRH.pres[9];
                        puntero_aplicacion.pres211 = cicloPCRCMCI_withThreeRH.pres[10];
                        puntero_aplicacion.pres212 = cicloPCRCMCI_withThreeRH.pres[11];
                        puntero_aplicacion.pres213 = cicloPCRCMCI_withThreeRH.pres[12];
                        puntero_aplicacion.pres214 = cicloPCRCMCI_withThreeRH.pres[13];
                        puntero_aplicacion.pres215 = cicloPCRCMCI_withThreeRH.pres[14];
                        puntero_aplicacion.pres216 = cicloPCRCMCI_withThreeRH.pres[15];
                        puntero_aplicacion.pres217 = cicloPCRCMCI_withThreeRH.pres[16];
                        puntero_aplicacion.pres218 = cicloPCRCMCI_withThreeRH.pres[17];
                        puntero_aplicacion.pres219 = cicloPCRCMCI_withThreeRH.pres[18];
                        puntero_aplicacion.pres220 = cicloPCRCMCI_withThreeRH.pres[19];

                        puntero_aplicacion.PHX1 = cicloPCRCMCI_withThreeRH.PHX.Q_dot;
                        puntero_aplicacion.RHX1 = cicloPCRCMCI_withThreeRH.RHX1.Q_dot;
                        puntero_aplicacion.RHX2 = cicloPCRCMCI_withThreeRH.RHX2.Q_dot;
                        puntero_aplicacion.RHX3 = cicloPCRCMCI_withThreeRH.RHX3.Q_dot;

                        puntero_aplicacion.LT_Q = cicloPCRCMCI_withThreeRH.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloPCRCMCI_withThreeRH.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloPCRCMCI_withThreeRH.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloPCRCMCI_withThreeRH.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloPCRCMCI_withThreeRH.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloPCRCMCI_withThreeRH.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloPCRCMCI_withThreeRH.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloPCRCMCI_withThreeRH.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloPCRCMCI_withThreeRH.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloPCRCMCI_withThreeRH.LT.eff;

                        puntero_aplicacion.HT_Q = cicloPCRCMCI_withThreeRH.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloPCRCMCI_withThreeRH.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloPCRCMCI_withThreeRH.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloPCRCMCI_withThreeRH.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloPCRCMCI_withThreeRH.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloPCRCMCI_withThreeRH.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloPCRCMCI_withThreeRH.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloPCRCMCI_withThreeRH.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloPCRCMCI_withThreeRH.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloPCRCMCI_withThreeRH.HT.eff;

                        puntero_aplicacion.PC1 = -cicloPCRCMCI_withThreeRH.PC1.Q_dot;
                        puntero_aplicacion.PC2 = -cicloPCRCMCI_withThreeRH.PC2.Q_dot;
                        puntero_aplicacion.PC3 = -cicloPCRCMCI_withThreeRH.PC3.Q_dot;
                        ...
                        p_rhx3_list.Add(puntero_aplicacion.p_rhx3_in);
                        ...
                        listBox27.Items.Add(puntero_aplicacion.p_rhx3_in.ToString());
                        ...
                        double LTR_min_DT_1 = cicloPCRCMCI_withThreeRH.temp[7] - cicloPCRCMCI_withThreeRH.temp[2];
                        double LTR_min_DT_2 = cicloPCRCMCI_withThreeRH.temp[8] - cicloPCRCMCI_withThreeRH.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloPCRCMCI_withThreeRH.temp[7] - cicloPCRCMCI_withThreeRH.temp[3];
                        double HTR_min_DT_2 = cicloPCRCMCI_withThreeRH.temp[6] - cicloPCRCMCI_withThreeRH.temp[4];
                        ...
                        //P_rxh3(kPa)
                        xlWorkSheet1.Cells[counter_Excel + 1, 6] = Convert.ToString(puntero_aplicacion.p_rhx3_in);
                        //CIT
                        xlWorkSheet1.Cells[counter_Excel + 1, 7] = Convert.ToString(puntero_aplicacion.t_mc1_in - 273.15);
                        //LT UA(kW/K)
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = cicloPCRCMCI_withThreeRH.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 13] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 14] = cicloPCRCMCI_withThreeRH.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    textBox8.Text = p_rhx3_list[maxIndex].ToString();
                    ...
                    if (checkBox3.Checked == true)
                    {
                        ...
                        puntero_aplicacion.textBox125.Text = p_rhx3_list[maxIndex].ToString();
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "PCRCMCI_with_Three_ReHeating" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500.0,
                    initial_CIP_value + 1000.0, initial_CIP_value + 3000.0, initial_CIP_value + 2000.0,
                    initial_CIP_value + 1500.0, 0.0 });
                    ...
                    var initialValue = new[] { 0.2, initial_CIP_value + 1000.0, initial_CIP_value + 2000.0, initial_CIP_value + 3000.0, 16000.0, 14000.0, 13000.0, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                       puntero_aplicacion.luis.RecompCycle_PCRCMCI_withThreeReheating_for_optimization(puntero_aplicacion.luis,
                       ref cicloPCRCMCI_withThreeRH, puntero_aplicacion.w_dot_net,
                       puntero_aplicacion.t_pc_in, puntero_aplicacion.t_mc1_in, puntero_aplicacion.t_mc2_in,
                       puntero_aplicacion.t_t_in, puntero_aplicacion.t_rht1_in, variables[4],
                       puntero_aplicacion.t_rht2_in, variables[5], puntero_aplicacion.t_rht3_in,
                       variables[6], variables[1], variables[2],
                       variables[3], puntero_aplicacion.p_mc2_out, variables[2],
                       variables[3], variables[7], UA_Total,
                       puntero_aplicacion.m_eta_mc2, puntero_aplicacion.m_eta_pc, puntero_aplicacion.m_eta_rc,
                       puntero_aplicacion.m_eta_mc1, puntero_aplicacion.m_eta_t, puntero_aplicacion.m_eta_trh1,
                       puntero_aplicacion.m_eta_trh2, puntero_aplicacion.m_eta_trh3, puntero_aplicacion.n_sub_hxrs,
                       variables[0], puntero_aplicacion.tol, puntero_aplicacion.eta_thermal,
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        if (i == Convert.ToDouble(textBox57.Text))
                        {
                            ...
                            xlWorkSheet1.Cells[4, 20] = "ReHeating1_PTC_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 21] = "ReHeating1_PTC_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 22] = "ReHeating1_LF_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 23] = "ReHeating1_LF_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 24] = "ReHeating2_PTC_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 25] = "ReHeating2_PTC_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 26] = "ReHeating2_LF_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 27] = "ReHeating2_LF_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 28] = "ReHeating3_PTC_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 29] = "ReHeating3_PTC_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 30] = "ReHeating3_LF_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 31] = "ReHeating3_LF_Pressure_Drop(bar)";
                        }
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                puntero_aplicacion.luis.RecompCycle_PCRCMCI_withThreeReheating(puntero_aplicacion.luis,
                                ref cicloPCRCMCI_withThreeRH, puntero_aplicacion.w_dot_net,
                                i, i, i, puntero_aplicacion.t_t_in, puntero_aplicacion.t_rht1_in, variables[4],
                                puntero_aplicacion.t_rht2_in, variables[5], puntero_aplicacion.t_rht3_in,
                                variables[6], variables[1], variables[2],
                                variables[3], puntero_aplicacion.p_mc2_out, variables[2],
                                variables[3], puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht,
                                ...
                                PHX_Q2_list.Add(cicloPCRCMCI_withThreeRH.PHX.Q_dot);
                                RHX1_Q2_list.Add(cicloPCRCMCI_withThreeRH.RHX1.Q_dot);
                                RHX2_Q2_list.Add(cicloPCRCMCI_withThreeRH.RHX2.Q_dot);
                                RHX2_Q2_list.Add(cicloPCRCMCI_withThreeRH.RHX3.Q_dot);

                                HT_Eff_list.Add(cicloPCRCMCI_withThreeRH.HT.eff);
                                LT_Eff_list.Add(cicloPCRCMCI_withThreeRH.LT.eff);
                            ...
                            listBox26.Items.Add(p_rhx1_list[maxIndex].ToString());
                            listBox25.Items.Add(p_rhx2_list[maxIndex].ToString());
