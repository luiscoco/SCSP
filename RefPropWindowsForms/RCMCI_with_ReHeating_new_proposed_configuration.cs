...
{
    public partial class RCMCI_with_ReHeating_new_proposed_configuration : Form
    {
        ...
        public RCMCI_with_ReHeating_new_proposed_configuration()
        {
            InitializeComponent();
        }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            eta_trh12 = Convert.ToDouble(textBox19.Text);
            eta_trh22 = Convert.ToDouble(textBox18.Text);
            eta_t2 = eta_trh12;
            ...
            //PRIMERA LLAMADA
            luis.RecompCycle_RCMCI_withReheating_newproposed(luis, ref cicloRCMCIwithTwoReheating, w_dot_net2,
            ...
            //SEGUNDA LLAMADA
            luis.RecompCycle_RCMCI_withReheating_newproposed(luis, ref cicloRCMCIwithTwoReheating, w_dot_net2,
            t_mc2_in2, temp25, t_rht1_in2, p_rhx1_in2, t_rht2_in2, p_rhx2_in2, p_mc2_in2,
            p_mc2_out2, p_mc1_in2, t_mc1_in2, p_mc1_out2, ua_lt2, ua_ht2, eta2_mc2, eta_rc2,
            eta1_mc2, eta_t2, eta_trh12, eta_trh22, n_sub_hxrs2, recomp_frac2, tol2, eta_thermal2,
            -dp2_lt1, -dp2_lt2, -dp2_ht1, -dp2_ht2, -dp11_pc1, -dp12_pc1, -dp2_phx1, -dp2_phx2,
            -dp2_rhx11, -dp2_rhx12, -dp2_rhx21, -dp2_rhx22, -dp11_pc2, -dp12_pc2);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                SF_PHX.PTC_Solar_Field_ciclo_RCMCI_Design_withReHeating_new_configuration(this, 24, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_ciclo_RCMCI_Design_withReHeating_new_configuration(this, 24, "Main_SF");
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            if (comboBox5.Text == "Parabolic")
            {
                ...
                SF_PHX.PTC_Solar_Field_uno(luis);
                SF_PHX.PTC_Solar_Field_ciclo_RCMCI_Design_withReHeating_new_configuration(this, 24, "ReHeating_SF");
                SF_PHX.button3_Click(this, e);
                SF_PHX.Show();
            }
            ...
            else if (comboBox5.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_uno(luis);
                SF_PHX_LF.LF_Solar_Field_ciclo_RCMCI_Design_withReHeating_new_configuration(this, 24, "ReHeating_SF");
                SF_PHX_LF.Load_ComboBox7();
                SF_PHX_LF.button3_Click(this, e);
                SF_PHX_LF.Show();
            }
