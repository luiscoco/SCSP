...
namespace RefPropWindowsForms
{
    public partial class Fresnel : Form
    {
        ...
        public void LF_Solar_Field_ciclo_SB_with_Three_Recuperators_and_Two_Recompressors_without_ReHeating(SB_with_Three_Recuperators_and_Two_Recompressors_without_ReHeating Punterociclo29, Double Brayton_cycle_type, String SF_Type)
        {
            SF_Type_variable = SF_Type;
            Brayton_cycle_type_variable = Brayton_cycle_type;
