...
{
    public partial class RCMCI_without_ReHeating_new_proposed_configuration : Form
    {
        ...
        public RCMCI_without_ReHeating_new_proposed_configuration()
        {
            InitializeComponent();
        }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            //CheckBox for High Temperature and not calculating the Solar Fields
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                SF_PHX.PTC_Solar_Field_ciclo_RCMCI_Design_withoutReHeating_new_configuration(this, 22, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_ciclo_RCMCI_Design_withoutReHeating_new_configuration(this, 22, "Main_SF");
