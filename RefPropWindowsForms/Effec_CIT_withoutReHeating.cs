...
{
    public partial class Effec_CIT_withoutReHeating : Form
    {
        ...
        public Effec_CIT_withoutReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_RC_WithoutReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_RC_WithoutReHeating(this, "Main_SF");
