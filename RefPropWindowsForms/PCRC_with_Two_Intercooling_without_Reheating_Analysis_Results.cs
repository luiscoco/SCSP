    ...
    public partial class PCRC_with_Two_Intercooling_without_Reheating_Analysis_Results : Form
    {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value/1.3, initial_CIP_value/1.3, initial_CIP_value/1.3 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc_out2, puntero_aplicacion.p_mc_out2, puntero_aplicacion.p_mc_out2 });

                    solver.SetInitialStepSize(new[] { 0.05, 1000, 1000, 1000 });

                    var initialValue = new[] { 0.2, initial_CIP_value / 1.3, initial_CIP_value / 1.3, initial_CIP_value / 1.3 };
                    ...
                    //Closing Excel Book 
                    xlWorkBook1.SaveAs(textBox4.Text + "SolarPaces2019_Paper_Results_PCRC_with_Two_Intercooling_without_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
