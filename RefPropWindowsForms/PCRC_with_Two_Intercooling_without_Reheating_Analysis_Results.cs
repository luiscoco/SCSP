...
{
    public partial class PCRC_with_Two_Intercooling_without_Reheating_Analysis_Results : Form
    {
        PCRC_with_Two_Intercooling_without_ReHeating puntero_aplicacion;

        public PCRC_with_Two_Intercooling_without_Reheating_Analysis_Results(PCRC_with_Two_Intercooling_without_ReHeating puntero1)
        {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                puntero_aplicacion.t_pc2_in2 = Convert.ToDouble(puntero_aplicacion.textBox84.Text);
                puntero_aplicacion.p_pc2_in2 = Convert.ToDouble(puntero_aplicacion.textBox86.Text);
                puntero_aplicacion.p_pc2_out2 = Convert.ToDouble(puntero_aplicacion.textBox87.Text);

                puntero_aplicacion.t_pc1_in2 = Convert.ToDouble(puntero_aplicacion.textBox22.Text);
                puntero_aplicacion.p_pc1_in2 = Convert.ToDouble(puntero_aplicacion.textBox23.Text);
                puntero_aplicacion.p_pc1_out2 = Convert.ToDouble(puntero_aplicacion.textBox8.Text);
                ...
                core.PCRCwithTwoIntercoolingWithoutReheating cicloPCRCwithTwoIntercoolingWithoutReheating = new core.PCRCwithTwoIntercoolingWithoutReheating();
                ...
                using (var solver = new NLoptSolver(algorithm_type, 4, 0.01, 10000))
                {
                    ...
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc_out2 / 1.3, puntero_aplicacion.p_mc_out2 / 1.3, puntero_aplicacion.p_mc_out2 / 1.3 });

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0 });

                    var initialValue = new[] { 0.2, initial_CIP_value, initial_CIP_value + 2500.0, initial_CIP_value + 4500.0 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PCRC_withTwoIntercooling_without_Reheating(puntero_aplicacion.luis, 
                        ref cicloPCRCwithTwoIntercoolingWithoutReheating, puntero_aplicacion.w_dot_net2,
                        puntero_aplicacion.t_t_in2, puntero_aplicacion.t_mc_in2, variables[3], 
                        puntero_aplicacion.p_mc_out2, variables[2], puntero_aplicacion.t_pc1_in2,
                        variables[3], variables[1], puntero_aplicacion.t_pc2_in2,
                        variables[2], puntero_aplicacion.ua_lt2, puntero_aplicacion.ua_ht2, 
                        puntero_aplicacion.eta_mc2, puntero_aplicacion.eta_rc2, puntero_aplicacion.eta_pc12, 
                        puntero_aplicacion.eta_pc22, puntero_aplicacion.eta_t2, puntero_aplicacion.n_sub_hxrs2,
                        ...
                        puntero_aplicacion.massflow2 = cicloPCRCwithTwoIntercoolingWithoutReheating.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloPCRCwithTwoIntercoolingWithoutReheating.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloPCRCwithTwoIntercoolingWithoutReheating.eta_thermal;
                        ...
                        puntero_aplicacion.temp21 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[0];
                        puntero_aplicacion.temp22 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[1];
                        puntero_aplicacion.temp23 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[2];
                        puntero_aplicacion.temp24 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[3];
                        puntero_aplicacion.temp25 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[4];
                        puntero_aplicacion.temp26 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[5];
                        puntero_aplicacion.temp27 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[6];
                        puntero_aplicacion.temp28 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[7];
                        puntero_aplicacion.temp29 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[8];
                        puntero_aplicacion.temp210 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[9];
                        puntero_aplicacion.temp211 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[10];
                        puntero_aplicacion.temp212 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[11];
                        puntero_aplicacion.temp213 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[12];
                        puntero_aplicacion.temp214 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[13];

                        puntero_aplicacion.pres21 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[0];
                        puntero_aplicacion.pres22 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[1];
                        puntero_aplicacion.pres23 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[2];
                        puntero_aplicacion.pres24 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[3];
                        puntero_aplicacion.pres25 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[4];
                        puntero_aplicacion.pres26 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[5];
                        puntero_aplicacion.pres27 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[6];
                        puntero_aplicacion.pres28 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[7];
                        puntero_aplicacion.pres29 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[8];
                        puntero_aplicacion.pres210 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[9];
                        puntero_aplicacion.pres211 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[10];
                        puntero_aplicacion.pres212 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[11];
                        puntero_aplicacion.pres213 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[12];
                        puntero_aplicacion.pres214 = cicloPCRCwithTwoIntercoolingWithoutReheating.pres[13];

                        puntero_aplicacion.PHX1 = cicloPCRCwithTwoIntercoolingWithoutReheating.PHX.Q_dot;

                        puntero_aplicacion.LT_Q = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.eff;

                        puntero_aplicacion.HT_Q = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.eff;

                        puntero_aplicacion.PC11 = cicloPCRCwithTwoIntercoolingWithoutReheating.PC1.Q_dot;
                        puntero_aplicacion.PC21 = cicloPCRCwithTwoIntercoolingWithoutReheating.PC2.Q_dot;
                        puntero_aplicacion.PC31 = cicloPCRCwithTwoIntercoolingWithoutReheating.COOLER.Q_dot;
                        ...
                        double LTR_min_DT_1 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[7] - cicloPCRCwithTwoIntercoolingWithoutReheating.temp[2];
                        double LTR_min_DT_2 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[8] - cicloPCRCwithTwoIntercoolingWithoutReheating.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[7] - cicloPCRCwithTwoIntercoolingWithoutReheating.temp[3];
                        double HTR_min_DT_2 = cicloPCRCwithTwoIntercoolingWithoutReheating.temp[6] - cicloPCRCwithTwoIntercoolingWithoutReheating.temp[4];
                        ...
                        //CIT
                        xlWorkSheet1.Cells[counter_Excel + 1, 4] = Convert.ToString(puntero_aplicacion.t_mc_in2 - 273.15);
                        //LT UA(kW/K)
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 9] = cicloPCRCwithTwoIntercoolingWithoutReheating.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = cicloPCRCwithTwoIntercoolingWithoutReheating.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    if (checkBox3.Checked == true)
                    {
                        ...
                        puntero_aplicacion.textBox23.Text = p_pc2_out2_list[maxIndex].ToString();
                        puntero_aplicacion.textBox8.Text = p_pc1_out2_list[maxIndex].ToString();
                        puntero_aplicacion.textBox86.Text = p_pc2_in2_list[maxIndex].ToString();
                        puntero_aplicacion.textBox87.Text = p_pc2_out2_list[maxIndex].ToString();
                        puntero_aplicacion.textBox3.Text = p_pc1_out2_list[maxIndex].ToString();
                    }

                    //Closing Excel Book 
                    xlWorkBook1.SaveAs(textBox4.Text + "PCRC_with_Two_Intercooling_without_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 5, 0.01, 10000))
                {
                    ...
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc_out2 / 1.3, puntero_aplicacion.p_mc_out2 / 1.3, puntero_aplicacion.p_mc_out2 / 1.3, 1.0 });

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value, initial_CIP_value + 2500.0, initial_CIP_value + 4500.0, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PCRC_withTwoIntercooling_without_Reheating_for_Optimization(puntero_aplicacion.luis,
                        ref cicloPCRCwithTwoIntercoolingWithoutReheating, puntero_aplicacion.w_dot_net2,
                        puntero_aplicacion.t_t_in2, puntero_aplicacion.t_mc_in2, variables[3],
                        puntero_aplicacion.p_mc_out2, variables[2], puntero_aplicacion.t_pc1_in2,
                        variables[3], variables[1], puntero_aplicacion.t_pc2_in2,
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 4, 0.01, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                puntero_aplicacion.luis.RecompCycle_PCRC_withTwoIntercooling_without_Reheating(puntero_aplicacion.luis,
                                ref cicloPCRCwithTwoIntercoolingWithoutReheating, puntero_aplicacion.w_dot_net2,
                                puntero_aplicacion.t_t_in2, i, variables[3],
                                puntero_aplicacion.p_mc_out2, variables[2], i,
                                variables[3], variables[1], i,
                                variables[2], puntero_aplicacion.ua_lt2, puntero_aplicacion.ua_ht2,
                                puntero_aplicacion.eta_mc2, puntero_aplicacion.eta_rc2, puntero_aplicacion.eta_pc12,
                                puntero_aplicacion.eta_pc22, puntero_aplicacion.eta_t2, puntero_aplicacion.n_sub_hxrs2,
                                variables[0], puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2,
                                ...
                                PHX_Q2_list.Add(cicloPCRCwithTwoIntercoolingWithoutReheating.PHX.Q_dot);

                                HT_Eff_list.Add(cicloPCRCwithTwoIntercoolingWithoutReheating.HT.eff);
                                LT_Eff_list.Add(cicloPCRCwithTwoIntercoolingWithoutReheating.LT.eff);
                            ...
                            //PC2_in(kPa)
                            xlWorkSheet1.Cells[counter_Excel + 1, 1] = p_pc2_in2_list[maxIndex].ToString();
                            //PC2_out(kPa)
                            xlWorkSheet1.Cells[counter_Excel + 1, 2] = p_pc2_out2_list[maxIndex].ToString();
                            //PC1_out(kPa)
