...
{
    public partial class Effec_Recomp_Fract_RCMCI_withReHeating : Form
    {
        ...
        const string refpropDLL_path2 = "RCMCI_Ethane_Optimal_with_RH_Subplex.dll";
        ...
        const string refpropDLL_path3 = "RCMCI_SF6_Optimal_with_RH_Subplex.dll";
        ...
        const string refpropDLL_path4 = "RCMCI_Xenon_Optimal_with_RH_Subplex.dll";
        ...
        const string refpropDLL_path5 = "RCMCI_Nitrogen_Optimal_with_RH_Subplex.dll";
        ...
        const string refpropDLL_path6 = "RCMCI_Methane_Optimal_with_RH_Subplex.dll";
        ...
        public Effec_Recomp_Fract_RCMCI_withReHeating()
        {
            InitializeComponent();
        }
        ...
        { 
            ...
            if (comboBox2.Text == "CO2")
            {
                ...
                textBox53.Text = Convert.ToString(temp214);
                ...
                textBox41.Text = Convert.ToString(temp21);
                textBox40.Text = Convert.ToString(temp213);

                textBox73.Text = Convert.ToString(pres214);
                ...
                textBox75.Text = Convert.ToString(massflow2);
                textBox74.Text = Convert.ToString(eta_thermal2 * 100);
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
                ...
                for (int i = 0; i < Convert.ToInt64(maxiter); i++)
                {
                    ...
                    //ReHeating SF_Effective_Aperture_Area & Recomp_Frac
                    ReHeating_SF_Effective_Aperture_Area.SetValueXY(recomp_temp_value, ReHeating_SF_ReflectorApertureArea);
                    ...
                    //ReHeating SF_Pressure_Drop & Recomp_Frac
                    ReHeating_SF_Pressure_Drop.SetValueXY(recomp_temp_value, ReHeating_SF_Total_Pressure_Drop);
            ...
            //ReHeating_SF_Effective_Aperture_Area & Recomp_Frac
            else if (radioButton19.Checked == true)
            {
                Recomp_Frac = new double[ReHeating_SF_Effective_Aperture_Area_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add("Recomp_Frac: " + ReHeating_SF_Effective_Aperture_Area_list[element] + " Effic.: " + ReHeating_SF_Effective_Aperture_Area_list[element1] + " UA: " + ReHeating_SF_Effective_Aperture_Area_list[element2]);
                    Recomp_Frac[contador] = ReHeating_SF_Effective_Aperture_Area_list[element];
            ...
            //ReHeating_SF_Pressure_Drop & Recomp_Frac
            else if (radioButton16.Checked == true)
            {
                Recomp_Frac = new double[ReHeating_SF_Pressure_Drop_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add("Recomp_Frac: " + ReHeating_SF_Pressure_Drop_list[element] + " Effic.: " + ReHeating_SF_Pressure_Drop_list[element1] + " UA: " + ReHeating_SF_Pressure_Drop_list[element2]);
                    Recomp_Frac[contador] = ReHeating_SF_Pressure_Drop_list[element];
            ...
            {
                Recomp_Frac = new double[RHX_Eff_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add("Recomp_Frac: " + RHX_Eff_list[element] + " Effic.: " + RHX_Eff_list[element1] + " UA: " + RHX_Eff_list[element2]);
                    Recomp_Frac[contador] = RHX_Eff_list[element];
            ...
            {
                Recomp_Frac = new double[RHX_UA_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add("Recomp_Frac: " + RHX_UA_list[element] + " Effic.: " + RHX_UA_list[element1] + " UA: " + RHX_UA_list[element2]);
                    Recomp_Frac[contador] = RHX_UA_list[element];
            ...
            {
                Recomp_Frac = new double[RHX_Q_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add("Recomp_Frac: " + RHX_Q_list[element] + " Effic.: " + RHX_Q_list[element1] + " UA: " + RHX_Q_list[element2]);
                    Recomp_Frac[contador] = RHX_Q_list[element];
            ...
            if (radioButton1.Checked == true)
            {
                ...
                if (checkBox3.Checked == true)
                {
                    ...
                    chart1.ChartAreas["ChartArea1"].AxisY.Maximum = Convert.ToDouble(textBox28.Text);
                }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_RCMCI_WithReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_RCMCI_WithReHeating(this, "Main_SF");
                Main_LF_SF_PHX_Data_Input_Dialogue.comboBox1.Text = comboBox7.Text;
                Main_LF_SF_PHX_Data_Input_Dialogue.Show();
            }
        }

        //ReHeating_SF_Data_Input
        private void button7_Click(object sender, EventArgs e)
        {
            if (comboBox5.Text == "Parabolic")
            {
                ReHeating_PTC_SF_PHX_Data_Input_Dialogue = new PTC_SF_PHX_Data_Input();
                ReHeating_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_RCMCI_WithReHeating(this, "ReHeating_SF");
            ...
            else if (comboBox5.Text == "Fresnel")
            {
                ...
                ReHeating_LF_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_RCMCI_WithReHeating(this, "ReHeating_SF");
