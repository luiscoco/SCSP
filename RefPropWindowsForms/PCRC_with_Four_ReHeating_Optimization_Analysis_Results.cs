...
namespace RefPropWindowsForms
{
    ...
    {
        PCRC_with_Four_ReHeatings puntero_aplicacion;

        public PCRC_with_Four_ReHeating_Optimization_Analysis_Results(PCRC_with_Four_ReHeatings puntero1)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                puntero_aplicacion.p_rhx4_in2 = Convert.ToDouble(puntero_aplicacion.textBox112.Text);
                puntero_aplicacion.t_rht4_in2 = Convert.ToDouble(puntero_aplicacion.textBox10.Text);
                ...
                puntero_aplicacion.dp2_phx1 = Convert.ToDouble(puntero_aplicacion.textBox111.Text);
                ...
                puntero_aplicacion.dp2_rhx41 = Convert.ToDouble(puntero_aplicacion.textBox110.Text);
                ...
                puntero_aplicacion.m_eta_trh42 = Convert.ToDouble(puntero_aplicacion.textBox109.Text);
                ...
                core.PCRCwithFourReheating cicloPCRC_withFourRH = new core.PCRCwithFourReheating();              
                ...
                using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                {
                    ...
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, (initial_CIP_value + 500), initial_CIP_value + 4000, initial_CIP_value + 3000, initial_CIP_value + 2000, initial_CIP_value + 1000 });
                    solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, puntero_aplicacion.p_mc_out2 - 3000, puntero_aplicacion.p_mc_out2 - 4000 });

                    solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 1000, 1000 });

                    var initialValue = new[] { 0.2, initial_CIP_value, (initial_CIP_value + 500), 16000, 14000, 13000, 11000 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PCRC_withFourReheating(puntero_aplicacion.luis, 
                        ref cicloPCRC_withFourRH, puntero_aplicacion.m_w_dot_net2, puntero_aplicacion.t_mc_in2,
                        ...
                        puntero_aplicacion.t_pc_in2, variables[2], puntero_aplicacion.ua_lt2,
                        puntero_aplicacion.ua_ht2, puntero_aplicacion.m_eta_mc2, puntero_aplicacion.m_eta_rc2,
                        ...
                        -puntero_aplicacion.dp2_rhx41, -puntero_aplicacion.dp2_rhx42, -puntero_aplicacion.dp2_cooler1, 
                        -puntero_aplicacion.dp2_cooler2);

                        counter++;

                        puntero_aplicacion.massflow2 = cicloPCRC_withFourRH.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloPCRC_withFourRH.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloPCRC_withFourRH.eta_thermal;
                        ...
                        puntero_aplicacion.temp21 = cicloPCRC_withFourRH.temp[0];
                        puntero_aplicacion.temp22 = cicloPCRC_withFourRH.temp[1];
                        puntero_aplicacion.temp23 = cicloPCRC_withFourRH.temp[2];
                        puntero_aplicacion.temp24 = cicloPCRC_withFourRH.temp[3];
                        puntero_aplicacion.temp25 = cicloPCRC_withFourRH.temp[4];
                        puntero_aplicacion.temp26 = cicloPCRC_withFourRH.temp[5];
                        puntero_aplicacion.temp27 = cicloPCRC_withFourRH.temp[6];
                        puntero_aplicacion.temp28 = cicloPCRC_withFourRH.temp[7];
                        puntero_aplicacion.temp29 = cicloPCRC_withFourRH.temp[8];
                        puntero_aplicacion.temp210 = cicloPCRC_withFourRH.temp[9];
                        puntero_aplicacion.temp211 = cicloPCRC_withFourRH.temp[10];
                        puntero_aplicacion.temp212 = cicloPCRC_withFourRH.temp[11];
                        puntero_aplicacion.temp213 = cicloPCRC_withFourRH.temp[12];
                        puntero_aplicacion.temp214 = cicloPCRC_withFourRH.temp[13];
                        puntero_aplicacion.temp215 = cicloPCRC_withFourRH.temp[14];
                        puntero_aplicacion.temp216 = cicloPCRC_withFourRH.temp[15];
                        puntero_aplicacion.temp217 = cicloPCRC_withFourRH.temp[16];
                        puntero_aplicacion.temp218 = cicloPCRC_withFourRH.temp[17];
                        puntero_aplicacion.temp219 = cicloPCRC_withFourRH.temp[18];
                        puntero_aplicacion.temp220 = cicloPCRC_withFourRH.temp[19];
                    
                        puntero_aplicacion.pres21 = cicloPCRC_withFourRH.pres[0];
                        puntero_aplicacion.pres22 = cicloPCRC_withFourRH.pres[1];
                        puntero_aplicacion.pres23 = cicloPCRC_withFourRH.pres[2];
                        puntero_aplicacion.pres24 = cicloPCRC_withFourRH.pres[3];
                        puntero_aplicacion.pres25 = cicloPCRC_withFourRH.pres[4];
                        puntero_aplicacion.pres26 = cicloPCRC_withFourRH.pres[5];
                        puntero_aplicacion.pres27 = cicloPCRC_withFourRH.pres[6];
                        puntero_aplicacion.pres28 = cicloPCRC_withFourRH.pres[7];
                        puntero_aplicacion.pres29 = cicloPCRC_withFourRH.pres[8];
                        puntero_aplicacion.pres210 = cicloPCRC_withFourRH.pres[9];
                        puntero_aplicacion.pres211 = cicloPCRC_withFourRH.pres[10];
                        puntero_aplicacion.pres212 = cicloPCRC_withFourRH.pres[11];
                        puntero_aplicacion.pres213 = cicloPCRC_withFourRH.pres[12];
                        puntero_aplicacion.pres214 = cicloPCRC_withFourRH.pres[13];
                        puntero_aplicacion.pres215 = cicloPCRC_withFourRH.pres[14];
                        puntero_aplicacion.pres216 = cicloPCRC_withFourRH.pres[15];
                        puntero_aplicacion.pres217 = cicloPCRC_withFourRH.pres[16];
                        puntero_aplicacion.pres218 = cicloPCRC_withFourRH.pres[17];
                        puntero_aplicacion.pres219 = cicloPCRC_withFourRH.pres[18];
                        puntero_aplicacion.pres220 = cicloPCRC_withFourRH.pres[19];

                        puntero_aplicacion.PHX1 = cicloPCRC_withFourRH.PHX.Q_dot;
                        puntero_aplicacion.RHX1 = cicloPCRC_withFourRH.RHX1.Q_dot;
                        puntero_aplicacion.RHX2 = cicloPCRC_withFourRH.RHX2.Q_dot;
                        puntero_aplicacion.RHX3 = cicloPCRC_withFourRH.RHX3.Q_dot;
                        puntero_aplicacion.RHX4 = cicloPCRC_withFourRH.RHX4.Q_dot;

                        puntero_aplicacion.LT_Q = cicloPCRC_withFourRH.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloPCRC_withFourRH.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloPCRC_withFourRH.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloPCRC_withFourRH.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloPCRC_withFourRH.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloPCRC_withFourRH.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloPCRC_withFourRH.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloPCRC_withFourRH.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloPCRC_withFourRH.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloPCRC_withFourRH.LT.eff;

                        puntero_aplicacion.HT_Q = cicloPCRC_withFourRH.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloPCRC_withFourRH.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloPCRC_withFourRH.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloPCRC_withFourRH.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloPCRC_withFourRH.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloPCRC_withFourRH.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloPCRC_withFourRH.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloPCRC_withFourRH.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloPCRC_withFourRH.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloPCRC_withFourRH.HT.eff;

                        puntero_aplicacion.PC1 = -cicloPCRC_withFourRH.PC.Q_dot;
                        puntero_aplicacion.COOLER1 = -cicloPCRC_withFourRH.COOLER.Q_dot;
                        ...
                        double LTR_min_DT_1 = cicloPCRC_withFourRH.temp[9] - cicloPCRC_withFourRH.temp[2];
                        double LTR_min_DT_2 = cicloPCRC_withFourRH.temp[8] - cicloPCRC_withFourRH.temp[3];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloPCRC_withFourRH.temp[7] - cicloPCRC_withFourRH.temp[5];
                        double HTR_min_DT_2 = cicloPCRC_withFourRH.temp[8] - cicloPCRC_withFourRH.temp[4];
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = cicloPCRC_withFourRH.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 13] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 14] = cicloPCRC_withFourRH.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    if (checkBox3.Checked == true)
                    {
                        ...
                        puntero_aplicacion.textBox112.Text = p_rhx4_in2_list[maxIndex].ToString();
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox4.Text + "PCRC_with_Four_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 8, 0.000001, 10000))
                {
                    ...
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, (initial_CIP_value + 500), initial_CIP_value + 4000, initial_CIP_value + 3000, initial_CIP_value + 2000, initial_CIP_value + 1000, 0.0 });
                    solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, puntero_aplicacion.p_mc_out2 - 3000, puntero_aplicacion.p_mc_out2 - 4000, 1.0});

                    solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 1000, 1000, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value, (initial_CIP_value + 500), 16000, 14000, 13000, 11000, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PCRC_withFourReheating_for_optimization(puntero_aplicacion.luis,
                        ref cicloPCRC_withFourRH, puntero_aplicacion.m_w_dot_net2, puntero_aplicacion.t_mc_in2,
                        puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2, variables[3],
                        puntero_aplicacion.t_rht2_in2, variables[4], puntero_aplicacion.t_rht3_in2,
                        variables[5], puntero_aplicacion.t_rht4_in2, variables[6],
                        variables[2], puntero_aplicacion.p_mc_out2, variables[1],
                        puntero_aplicacion.t_pc_in2, variables[2], variables[7], UA_Total, 
                        puntero_aplicacion.m_eta_mc2, puntero_aplicacion.m_eta_rc2,
                        puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_t2, puntero_aplicacion.m_eta_trh12,
                        puntero_aplicacion.m_eta_trh22, puntero_aplicacion.m_eta_trh32, puntero_aplicacion.m_eta_trh42,
                        puntero_aplicacion.n_sub_hxrs2, variables[0], puntero_aplicacion.tol2,
                        puntero_aplicacion.eta_thermal2, -puntero_aplicacion.dp2_lt1, -puntero_aplicacion.dp2_lt2,
            ...
            for (double j = Convert.ToDouble(textBox11.Text); j <= Convert.ToDouble(textBox10.Text); j = j + Convert.ToDouble(textBox9.Text))
            {
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                        {
                            solver.SetLowerBounds(new[] { 0.1, initial_pc_in_value, (initial_pc_in_value + 500), initial_pc_in_value + 4000, initial_pc_in_value + 3000, initial_pc_in_value + 2000, initial_pc_in_value + 1000 });
                            solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, puntero_aplicacion.p_mc_out2 - 3000, puntero_aplicacion.p_mc_out2 - 4000 });

                            solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 1000, 1000 });

                            var initialValue = new[] { 0.2, initial_pc_in_value, (initial_pc_in_value + 500), 16000, 14000, 13000, 11000 };

                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                puntero_aplicacion.luis.RecompCycle_PCRC_withFourReheating(puntero_aplicacion.luis,
                                ref cicloPCRC_withFourRH, puntero_aplicacion.m_w_dot_net2, i,
                                puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2, variables[3],
                                puntero_aplicacion.t_rht2_in2, variables[4], puntero_aplicacion.t_rht3_in2,
                                variables[5], puntero_aplicacion.t_rht4_in2, variables[6],
                                variables[2], puntero_aplicacion.p_mc_out2, variables[1],
                                ...
                                PHX_Q_list.Add(cicloPCRC_withFourRH.PHX.Q_dot);
                                RHX1_Q_list.Add(cicloPCRC_withFourRH.RHX1.Q_dot);
                                RHX2_Q_list.Add(cicloPCRC_withFourRH.RHX2.Q_dot);
                                RHX3_Q_list.Add(cicloPCRC_withFourRH.RHX3.Q_dot);
                                RHX4_Q_list.Add(cicloPCRC_withFourRH.RHX4.Q_dot);
                               
                                HT_Eff_list.Add(cicloPCRC_withFourRH.HT.eff);
                                LT_Eff_list.Add(cicloPCRC_withFourRH.LT.eff);
                    ...
                    else if (checkBox2.Checked == true)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 8, 0.000001, 10000))
                        {
                            ...
                            solver.SetLowerBounds(new[] { 0.1, initial_pc_in_value, (initial_pc_in_value + 500), 
                                                         initial_pc_in_value + 4000, initial_pc_in_value + 3000, 
                                                         initial_pc_in_value + 2000, initial_pc_in_value + 1000, 0.0 });
                            solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), 
                                                         puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, 
                                                         puntero_aplicacion.p_mc_out2 - 3000, puntero_aplicacion.p_mc_out2 - 4000, 1.0 });

                            solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 1000, 1000, 0.05 });

                            var initialValue = new[] { 0.2, initial_pc_in_value, (initial_pc_in_value + 500), 
                                                       16000, 14000, 13000, 11000, 0.5 };
