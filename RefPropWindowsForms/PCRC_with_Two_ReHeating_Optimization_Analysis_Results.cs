...
{
    public partial class PCRC_with_Two_ReHeating_Optimization_Analysis_Results : Form
    {
        PCRC_with_Two_ReHeating puntero_aplicacion;

        public PCRC_with_Two_ReHeating_Optimization_Analysis_Results(PCRC_with_Two_ReHeating puntero1)
        {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                {                    
                    ...
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, (initial_CIP_value + 500), initial_CIP_value + 2000, initial_CIP_value + 1000 });
                    solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000 });

                    solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000 });

                    var initialValue = new[] { 0.2, initial_CIP_value, (initial_CIP_value + 500), 14000, 11000 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PCRC_withTwoReheating(puntero_aplicacion.luis, ref cicloPCRC_withTwoRH,
                            puntero_aplicacion.m_w_dot_net2, puntero_aplicacion.t_mc_in2, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2,
                            variables[3], puntero_aplicacion.t_rht2_in2, variables[4], variables[2], puntero_aplicacion.p_mc_out2, variables[1], 
                            puntero_aplicacion.t_pc_in2, variables[2], puntero_aplicacion.ua_lt2, puntero_aplicacion.ua_ht2, puntero_aplicacion.m_eta_mc2, 
                            puntero_aplicacion.m_eta_rc2, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_t2, puntero_aplicacion.m_eta_trh12,
                            puntero_aplicacion.m_eta_trh22, puntero_aplicacion.n_sub_hxrs2, variables[0], puntero_aplicacion.tol2, 
                            puntero_aplicacion.eta_thermal2, -puntero_aplicacion.dp2_lt1, -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht1,
                            -puntero_aplicacion.dp2_ht2, -puntero_aplicacion.dp2_pc1, -puntero_aplicacion.dp2_pc2, -puntero_aplicacion.dp2_phx1, 
                            -puntero_aplicacion.dp2_phx2, -puntero_aplicacion.dp2_rhx11, -puntero_aplicacion.dp2_rhx12, -puntero_aplicacion.dp2_rhx21,
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = cicloPCRC_withTwoRH.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = cicloPCRC_withTwoRH.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox4.Text + "SolarPaces2019_Paper_Results_PCRC_with_Two_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 6, 0.01, 10000))
                {
                    ...
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, (initial_CIP_value + 500), initial_CIP_value + 2000, initial_CIP_value + 1000, 0.2 });
                    solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, 0.8 });

                    solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value, (initial_CIP_value + 500), 14000, 11000, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PCRC_withTwoReheating_for_Optimization(puntero_aplicacion.luis, ref cicloPCRC_withTwoRH,
                            puntero_aplicacion.m_w_dot_net2, puntero_aplicacion.t_mc_in2, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2,
                            variables[3], puntero_aplicacion.t_rht2_in2, variables[4], variables[2], puntero_aplicacion.p_mc_out2, variables[1],
                            puntero_aplicacion.t_pc_in2, variables[2], variables[5], UA_Total, puntero_aplicacion.m_eta_mc2,
                            puntero_aplicacion.m_eta_rc2, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_t2, puntero_aplicacion.m_eta_trh12,
                            puntero_aplicacion.m_eta_trh22, puntero_aplicacion.n_sub_hxrs2, variables[0], puntero_aplicacion.tol2,
                            puntero_aplicacion.eta_thermal2, -puntero_aplicacion.dp2_lt1, -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht1,
                            -puntero_aplicacion.dp2_ht2, -puntero_aplicacion.dp2_pc1, -puntero_aplicacion.dp2_pc2, -puntero_aplicacion.dp2_phx1,
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox4.Text + "SolarPaces2019_Paper_Results_PCRC_with_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
            {
                ...
                if (checkBox2.Checked == false)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 5, 0.01, 10000))
                    {
                        ...
                        solver.SetLowerBounds(new[] { 0.1, initial_pc_in_value, (initial_pc_in_value + 500), puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000 });
                        solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000 });

                        solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000 });

                        var initialValue = new[] { 0.2, initial_pc_in_value, (initial_pc_in_value + 500), 14000, 11000 };

                        Func<double[], double> funcion = delegate (double[] variables)
                        {
                            puntero_aplicacion.luis.RecompCycle_PCRC_withTwoReheating(puntero_aplicacion.luis, ref cicloPCRC_withTwoRH,
                                puntero_aplicacion.m_w_dot_net2, i, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2,
                                variables[3], puntero_aplicacion.t_rht2_in2, variables[4], variables[2], puntero_aplicacion.p_mc_out2, variables[1],
                                i, variables[2], puntero_aplicacion.ua_lt2, puntero_aplicacion.ua_ht2, puntero_aplicacion.m_eta_mc2,
                                puntero_aplicacion.m_eta_rc2, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_t2, puntero_aplicacion.m_eta_trh12,
                                puntero_aplicacion.m_eta_trh22, puntero_aplicacion.n_sub_hxrs2, variables[0], puntero_aplicacion.tol2,
                                puntero_aplicacion.eta_thermal2, -puntero_aplicacion.dp2_lt1, -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht1,
                                -puntero_aplicacion.dp2_ht2, -puntero_aplicacion.dp2_pc1, -puntero_aplicacion.dp2_pc2, -puntero_aplicacion.dp2_phx1,
                            ...
                            PHX_Q_list.Add(cicloPCRC_withTwoRH.PHX.Q_dot);
                            RHX1_Q_list.Add(cicloPCRC_withTwoRH.RHX1.Q_dot);
                            RHX2_Q_list.Add(cicloPCRC_withTwoRH.RHX2.Q_dot);

                            HT_Eff_list.Add(cicloPCRC_withTwoRH.HT.eff);
                            LT_Eff_list.Add(cicloPCRC_withTwoRH.LT.eff);
                ...
                else if (checkBox2.Checked == true)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 6, 0.01, 10000))
                    {
                        solver.SetLowerBounds(new[] { 0.1, initial_pc_in_value, (initial_pc_in_value + 500), puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000, 0.2 });
                        solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, 0.8 });

                        solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 0.05 });

                        var initialValue = new[] { 0.2, initial_pc_in_value, (initial_pc_in_value + 500), 14000, 11000, 0.5 };
                        ...
                        Func<double[], double> funcion = delegate (double[] variables)
                        {
                            puntero_aplicacion.luis.RecompCycle_PCRC_withTwoReheating_for_Optimization(puntero_aplicacion.luis, ref cicloPCRC_withTwoRH,
                                puntero_aplicacion.m_w_dot_net2, i, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2,
                                variables[3], puntero_aplicacion.t_rht2_in2, variables[4], variables[2], puntero_aplicacion.p_mc_out2, variables[1],
                                i, variables[2], variables[5], UA_Total, puntero_aplicacion.m_eta_mc2,
                                puntero_aplicacion.m_eta_rc2, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_t2, puntero_aplicacion.m_eta_trh12,
                                puntero_aplicacion.m_eta_trh22, puntero_aplicacion.n_sub_hxrs2, variables[0], puntero_aplicacion.tol2,
                                puntero_aplicacion.eta_thermal2, -puntero_aplicacion.dp2_lt1, -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht1,
                                -puntero_aplicacion.dp2_ht2, -puntero_aplicacion.dp2_pc1, -puntero_aplicacion.dp2_pc2, -puntero_aplicacion.dp2_phx1,
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox4.Text + "SolarPaces2019_Paper_CIT_Optimization_PCRC_with_Two_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void PCRC_with_Two_ReHeating_Optimization_Analysis_Results_Load(object sender, EventArgs e)
        {
            textBox5.Text = puntero_aplicacion.textBox69.Text;
        }
    }
}
