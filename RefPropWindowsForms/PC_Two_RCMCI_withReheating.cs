...
namespace RefPropWindowsForms
{
    public partial class PC_Two_RCMCI_withReheating : Form
    {
        ...
        {
            PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results_dialog = new PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results();
