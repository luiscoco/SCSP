...
{
    public partial class PC_Two_RCMCI_withReheating : Form
    {
        //Input Data:
        ...
        public Double PTC_Reheating_Solar_Impinging_flowpath, PTC_Reheating_Solar_Energy_Absorbed_flowpath, PTC_Reheating_Energy_Loss_flowpath, PTC_Reheatingn_Net_Absorbed_flowpath;
        ...
        public Double LF_Reheating_Net_Absorbed_SF, LF_Reheating_Collector_Efficiency, LF_Reheating_SF_Pressure_drop, LF_Reheating_calculated_mass_flux, LF_Reheatingn_calculated_Number_Rows;
        ...
        public Double Reheating_SF_Pump_Electrical_Consumption;
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            t_trh_in = Convert.ToDouble(textBox116.Text);
            p_trh_in = Convert.ToDouble(textBox117.Text);
            ...
            m_eta_trh = Convert.ToDouble(textBox115.Text);
            ...
            luis.RecompCycle_PC_Two_RCMCI_withReheating(luis, ref cicloPC_Two_RCMCI_withReheating,
            w_dot_net, t_pc_in, t_mc4_in, t_mc3_in, t_mc2_in, t_t_in, t_trh_in, p_trh_in,
            p_pc_in, p_pc_out, p_mc4_in, p_mc4_out, p_mc3_in, p_mc3_out,
            p_mc2_in, p_mc2_out, ua_lt, ua_ht, m_eta_mc4, m_eta_pc, m_eta_rc,
            m_eta_mc3, m_eta_mc2, m_eta_t, m_eta_trh, n_sub_hxrs, m_recomp_frac, tol, eta_thermal,
            -dp_lt1, -dp_lt2, -dp_ht1, -dp_ht2, -dp_pc1, -dp_pc4, -dp_pc3, -dp_pc2,
            -dp_phx, -dp_rhx);

            massflow2 = cicloPC_Two_RCMCI_withReheating.m_dot_turbine;
            w_dot_net2 = cicloPC_Two_RCMCI_withReheating.W_dot_net;
            eta_thermal2 = cicloPC_Two_RCMCI_withReheating.eta_thermal;
            ...
            temp21 = cicloPC_Two_RCMCI_withReheating.temp[0];
            temp22 = cicloPC_Two_RCMCI_withReheating.temp[1];
            temp23 = cicloPC_Two_RCMCI_withReheating.temp[2];
            temp24 = cicloPC_Two_RCMCI_withReheating.temp[3];
            temp25 = cicloPC_Two_RCMCI_withReheating.temp[4];
            temp26 = cicloPC_Two_RCMCI_withReheating.temp[5];
            temp27 = cicloPC_Two_RCMCI_withReheating.temp[6];
            temp28 = cicloPC_Two_RCMCI_withReheating.temp[7];
            temp29 = cicloPC_Two_RCMCI_withReheating.temp[8];
            temp210 = cicloPC_Two_RCMCI_withReheating.temp[9];
            temp211 = cicloPC_Two_RCMCI_withReheating.temp[10];
            temp212 = cicloPC_Two_RCMCI_withReheating.temp[11];
            temp213 = cicloPC_Two_RCMCI_withReheating.temp[12];
            temp214 = cicloPC_Two_RCMCI_withReheating.temp[13];
            temp215 = cicloPC_Two_RCMCI_withReheating.temp[14];
            temp216 = cicloPC_Two_RCMCI_withReheating.temp[15];
            temp217 = cicloPC_Two_RCMCI_withReheating.temp[16];
            temp218 = cicloPC_Two_RCMCI_withReheating.temp[17];

            pres21 = cicloPC_Two_RCMCI_withReheating.pres[0];
            pres22 = cicloPC_Two_RCMCI_withReheating.pres[1];
            pres23 = cicloPC_Two_RCMCI_withReheating.pres[2];
            pres24 = cicloPC_Two_RCMCI_withReheating.pres[3];
            pres25 = cicloPC_Two_RCMCI_withReheating.pres[4];
            pres26 = cicloPC_Two_RCMCI_withReheating.pres[5];
            pres27 = cicloPC_Two_RCMCI_withReheating.pres[6];
            pres28 = cicloPC_Two_RCMCI_withReheating.pres[7];
            pres29 = cicloPC_Two_RCMCI_withReheating.pres[8];
            pres210 = cicloPC_Two_RCMCI_withReheating.pres[9];
            pres211 = cicloPC_Two_RCMCI_withReheating.pres[10];
            pres212 = cicloPC_Two_RCMCI_withReheating.pres[11];
            pres213 = cicloPC_Two_RCMCI_withReheating.pres[12];
            pres214 = cicloPC_Two_RCMCI_withReheating.pres[13];
            pres215 = cicloPC_Two_RCMCI_withReheating.pres[14];
            pres216 = cicloPC_Two_RCMCI_withReheating.pres[15];
            pres217 = cicloPC_Two_RCMCI_withReheating.pres[16];
            pres218 = cicloPC_Two_RCMCI_withReheating.pres[17];
            ...
            {
                PHX = cicloPC_Two_RCMCI_withReheating.PHX.Q_dot;
                RHX = cicloPC_Two_RCMCI_withReheating.RHX.Q_dot;
                recomp_frac2 = cicloPC_Two_RCMCI_withReheating.recomp_frac;
                LT_Q = cicloPC_Two_RCMCI_withReheating.LT.Q_dot;
                LT_mdotc = cicloPC_Two_RCMCI_withReheating.LT.m_dot_design[0];
                LT_mdoth = cicloPC_Two_RCMCI_withReheating.LT.m_dot_design[1];
                LT_Tcin = cicloPC_Two_RCMCI_withReheating.LT.T_c_in;
                LT_Thin = cicloPC_Two_RCMCI_withReheating.LT.T_h_in;
                LT_Pcin = cicloPC_Two_RCMCI_withReheating.LT.P_c_in;
                LT_Phin = cicloPC_Two_RCMCI_withReheating.LT.P_h_in;
                LT_Pcout = cicloPC_Two_RCMCI_withReheating.LT.P_c_out;
                LT_Phout = cicloPC_Two_RCMCI_withReheating.LT.P_h_out;
                LT_Effc = cicloPC_Two_RCMCI_withReheating.LT.eff;

                HT_Q = cicloPC_Two_RCMCI_withReheating.HT.Q_dot;
                HT_mdotc = cicloPC_Two_RCMCI_withReheating.HT.m_dot_design[0];
                HT_mdoth = cicloPC_Two_RCMCI_withReheating.HT.m_dot_design[1];
                HT_Tcin = cicloPC_Two_RCMCI_withReheating.HT.T_c_in;
                HT_Thin = cicloPC_Two_RCMCI_withReheating.HT.T_h_in;
                HT_Pcin = cicloPC_Two_RCMCI_withReheating.HT.P_c_in;
                HT_Phin = cicloPC_Two_RCMCI_withReheating.HT.P_h_in;
                HT_Pcout = cicloPC_Two_RCMCI_withReheating.HT.P_c_out;
                HT_Phout = cicloPC_Two_RCMCI_withReheating.HT.P_h_out;
                HT_Effc = cicloPC_Two_RCMCI_withReheating.HT.eff;

                PC1 = -cicloPC_Two_RCMCI_withReheating.PC1.Q_dot;
                PC2 = -cicloPC_Two_RCMCI_withReheating.PC2.Q_dot;
                PC3 = -cicloPC_Two_RCMCI_withReheating.PC3.Q_dot;
                PC4 = -cicloPC_Two_RCMCI_withReheating.PC4.Q_dot;
        ...
        {
            PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results_dialog = new PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results(this);
            PC_Two_RCMCI_with_ReHeating_Optimization_Analysis_Results_dialog.Show();
        }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            Precooler_dialog2.textBox8.Text = Convert.ToString(pres215);
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            Precooler_dialog4.textBox6.Text = Convert.ToString(temp212);
            Precooler_dialog4.textBox12.Text = Convert.ToString(pres212);
            Precooler_dialog4.textBox8.Text = Convert.ToString(pres21);
