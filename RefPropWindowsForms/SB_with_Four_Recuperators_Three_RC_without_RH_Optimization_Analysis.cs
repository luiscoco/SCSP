...
{
    public partial class SB_with_Four_Recuperators_Three_RC_without_RH_Optimization_Analysis : Form
    {
        SB_with_Four_Recuperators_and_Three_Recompressors_without_ReHeating puntero_aplicacion;

        public SB_with_Four_Recuperators_Three_RC_without_RH_Optimization_Analysis(SB_with_Four_Recuperators_and_Three_Recompressors_without_ReHeating puntero1)
        {
