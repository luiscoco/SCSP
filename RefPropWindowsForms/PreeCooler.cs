...
{
    public partial class PreeCooler : Form
    {
        ...
        public Refrigerant Refrigerante;
        ...
        private void PreeCooler_Load(object sender, EventArgs e)
        {
            
        }

        //Results: UA, min_DT
        public Double UA, min_DT;

        public Double Cp_HTF_in;

        public Double wmm_c,wmm_h;
        ...
        public void PreeCooler1(core HXwindow)
        {
        ...
        public void Calculate_Cooler()
        {
            ...
            P_h_in = Convert.ToDouble(textBox12.Text);
            P_h_out = Convert.ToDouble(textBox8.Text);
            ...
            Double Cp_Refrigerant_Precooler;

            //Fixed_CR: input the CR and calculate the mass_flow
            if (radioButton9.Checked == true)
            {
                ...
                CR = Convert.ToDouble(textBox26.Text);
            }            

            //CR_Calculated True: input the mass_flow and calculate the CR
            ...
            //Water 25ºC Cp=4.18
            Cp_Refrigerant_Precooler = 4.18;

            //wmm_c =  Refrigerante.MolecularWeight;
            wmm_h = CorePointer.working_fluid.MolecularWeight;

            P_h_in = Math.Round(P_h_in, 2);
            P_h_out = Math.Round(P_h_out, 2);

            CorePointer.calculate_Precooler_UA(Cp_Refrigerant_Precooler, N_sub_hxrs, Q_dot, ref m_dot_c, m_dot_h, T_c_in, T_h_in, P_c_in, P_c_out, P_h_in, P_h_out,
                ref error_code, ref UA, ref min_DT, ref T_h, ref T_c, ref Effec, ref P_h, ref P_c, ref UA_local, ref NTU, ref CR, ref CR_Calculated);
            ...
            for (int contador = 0; contador < N_sub_hxrs; contador++)
            {
                ...
                //
                //Refrigerante.FindStateWithTP(Tave_c[contador], P_c[contador]);
                Density_c[contador] = (-0.0025*(Tave_c[contador]*Tave_c[contador])) + (1.1409*Tave_c[contador]) + 876.93;
            }
            ...
            {
                //
                CorePointer.working_fluid.FindStateWithTD(Tave_h[contador], Density_h[contador] / wmm_h);
                Viscosity_h[contador] = (CorePointer.working_fluid.viscosity) / 1000000;
                //
                //Refrigerante.FindStateWithTD(Tave_c[contador], Density_c[contador] / wmm_c);
                Viscosity_c[contador] = (-0.000000000343402 * Math.Pow(Tave_c[contador], 3)) + (0.000000428026546 * Math.Pow(Tave_c[contador], 2)) - (0.000178915519431 * Tave_c[contador]) + 0.025281975551944;
            }
            ...
            for (int contador = 0; contador < N_sub_hxrs; contador++)
            {
                ...
                //
                //Refrigerante.FindStateWithTD(Tave_c[contador], Density_c[contador] / wmm_c);
                Thermal_Conductivity_c[contador] = (-8E-06 * Tave_c[contador] * Tave_c[contador]) + (0.0065 * Tave_c[contador]) - 0.5994;
            }
            ...
            for (int contador = 0; contador < N_sub_hxrs; contador++)
            {
                ...
                //
                //Refrigerante.FindStateWithTP(Tave_c[contador], P_c[contador]);
                Cp_c[contador] = (1E-05 * Tave_c[contador] * Tave_c[contador]) - (0.0078 * Tave_c[contador]) + 5.4169;
            }
            ...
            for (int contador = 0; contador < N_sub_hxrs; contador++)
            {
                //
                CorePointer.working_fluid.FindStateWithTP(Tave_h[contador], P_h[contador]);
                Prandtl_h[contador] = (Viscosity_h[contador] * Cp_h[contador] / Thermal_Conductivity_h[contador] / wmm_h / 1000) * 1000000;
                //
                //Refrigerante.FindStateWithTP(Tave_c[contador], P_c[contador]);
                Prandtl_c[contador] = (Viscosity_c[contador] * Cp_c[contador] / Thermal_Conductivity_c[contador] / 1000) * 1000000;
            }
            ...
            for (int contador = 0; contador < N_sub_hxrs; contador++)
            {
                Nusselt_c[contador] = 0.023 * (Math.Pow(Reynold_c[contador], 0.8)) * (Math.Pow(Prandtl_c[contador], 0.3));
            ...
            chart2.ChartAreas["ChartArea1"].AxisY.Interval = 300;
            chart2.ChartAreas["ChartArea1"].AxisY.RoundAxisValues();

            textBox25.Text = Convert.ToString(HTC_hd[0] - 300);
            ...
            chart2.ChartAreas["ChartArea1"].AxisY.Maximum = Convert.ToDouble(decimal.Round(HTC_cd[0] + 500, 1, MidpointRounding.AwayFromZero));
            ...
            {
                textBox26.Text = Convert.ToString(CR);
            }

            //Fixed_CR
            else if (radioButton9.Checked == true)
            {
                textBox3.Text = Convert.ToString(m_dot_c);
            }
        }
