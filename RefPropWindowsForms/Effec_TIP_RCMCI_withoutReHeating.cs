...
{
    public partial class Effec_TIP_RCMCI_withoutReHeating : Form
    {
        ...
        public Effec_TIP_RCMCI_withoutReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            UA_Total_increment = Convert.ToDouble(textBox72.Text);
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
                ...
                TIP_min = Convert.ToDouble(textBox64.Text);
                ...
                TIP_max = Convert.ToDouble(textBox68.Text);
                TIP_increment = Convert.ToDouble(textBox73.Text);
                ...
                {
                    textBox16.Text = Convert.ToString(TIP_temp_value);
                    ...
                    //PR_Fraction & TIP
                    PR_frac_point.SetValueXY(TIP_temp_value, pr_mc2_guess2);
            ...
            if (radioButton1.Checked == true)
            {
                ...
                {
                    chart1.ChartAreas["ChartArea1"].AxisX.Minimum = Convert.ToDouble(textBox61.Text);
                    chart1.ChartAreas["ChartArea1"].AxisX.Maximum = Convert.ToDouble(textBox60.Text);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_RCMCI_Without_ReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_RCMCI_Without_ReHeating(this, "Main_SF");
