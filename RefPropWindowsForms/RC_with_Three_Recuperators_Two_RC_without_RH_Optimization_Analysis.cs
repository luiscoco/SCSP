...
{
    public partial class RC_with_Three_Recuperators_Two_RC_without_RH_Optimization_Analysis : Form
    {
        RC_with_Three_Recuperators_and_Two_Recompressors_without_ReHeating puntero_aplicacion;

        public RC_with_Three_Recuperators_Two_RC_without_RH_Optimization_Analysis(RC_with_Three_Recuperators_and_Two_Recompressors_without_ReHeating puntero1)
        {
