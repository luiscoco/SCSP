        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                {
                    ...
                    var initialValue = new[] { 0.2, initial_CIP_value + 2000.0, initial_CIP_value + 3000.0, initial_CIP_value + 4000.0, initial_CIP_value + 6000.0, initial_CIP_value + 5000.0 };
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                {
                    ...
                    var initialValue = new[] { 0.2, initial_CIP_value + 2000.0, initial_CIP_value + 3000.0, initial_CIP_value + 4000.0, initial_CIP_value + 6000.0, initial_CIP_value + 5000.0, 0.5 };
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        if (i == Convert.ToDouble(textBox57.Text))
                        {
                            ...
                            xlWorkSheet1.Cells[4, 13] = "HTR Eff.(%)";
                            xlWorkSheet1.Cells[4, 14] = "HTR Pinch(ºC)";
                            xlWorkSheet1.Cells[4, 15] = "Main_PTC_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 16] = "Main_PTC_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 17] = "Main_LF_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 18] = "Main_LF_Pressure_Drop(bar)";
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                ...
                                variables[4], puntero_aplicacion.t_rht2_in2, variables[5],
                                variables[2], variables[3], variables[1],
                                i, variables[2], variables[3],
                                i, puntero_aplicacion.p_mc3_out2, puntero_aplicacion.ua_lt2,
                                puntero_aplicacion.ua_ht2, puntero_aplicacion.eta2_mc2, puntero_aplicacion.eta_rc2,
                                puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta3_mc2, puntero_aplicacion.eta_t2,
                                puntero_aplicacion.eta_trh1, puntero_aplicacion.eta_trh2, puntero_aplicacion.n_sub_hxrs2,
                                variables[0], puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2,
                                ...
                                HT_Eff_list.Add(cicloRCMCI_withTwoIntercooling_withTwoRH.HT.eff);
                                LT_Eff_list.Add(cicloRCMCI_withTwoIntercooling_withTwoRH.LT.eff);
                    ...
                    else if (checkBox2.Checked == true)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                ...
                                variables[2], variables[3], variables[1],
                                i, variables[2], variables[3],
                                i, puntero_aplicacion.p_mc3_out2,
                                variables[6], UA_Total, puntero_aplicacion.eta2_mc2, puntero_aplicacion.eta_rc2,
                                puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta3_mc2, puntero_aplicacion.eta_t2,
                                puntero_aplicacion.eta_trh1, puntero_aplicacion.eta_trh2, puntero_aplicacion.n_sub_hxrs2,
                                variables[0], puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2,
