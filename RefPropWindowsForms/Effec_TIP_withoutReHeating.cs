...
{
    public partial class Effec_TIP_withoutReHeating : Form
    {
        ...
        public Effec_TIP_withoutReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            UA_Total_min = Convert.ToDouble(textBox6.Text);
            UA_Total_max = Convert.ToDouble(textBox24.Text);
            UA_Total_increment = Convert.ToDouble(textBox28.Text);
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
               ...
               TIP_min = Convert.ToDouble(textBox3.Text);

                if (TIP_min < 15000)
                {
                    MessageBox.Show("Error, TIP should be above 15000");
                }

                TIP_max = Convert.ToDouble(textBox8.Text);
                TIP_increment = Convert.ToDouble(textBox27.Text);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            //if (Convert.ToDouble(textBox17.Text) < 20000)
            //{
            //   textBox60.Text = "2.5";
            //}

            //else if (Convert.ToDouble(textBox17.Text) > 20000)
            //{
                if (Convert.ToDouble(textBox7.Text) > 25000)
                {
                    textBox60.Text = "4.0";
                }

                else if ((Convert.ToDouble(textBox7.Text) < 25000))
                {
                    textBox60.Text = "3.0";
                }
            //}
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_RC_WithoutReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_TIP_RC_WithoutReHeating(this, "Main_SF");
