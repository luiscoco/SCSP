...
{
    public partial class Two_PC_Two_RCMCI_withoutReheating_Optimization_Analysis_Results : Form
    {
        Two_PC_Two_RCMCI_withoutReheating puntero_aplicacion;

        public Two_PC_Two_RCMCI_withoutReheating_Optimization_Analysis_Results(Two_PC_Two_RCMCI_withoutReheating puntero1)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                core.Two_PC_Two_RCMCI_withoutReheating cicloTwo_PC_Two_RCMCI_withoutReheating = new core.Two_PC_Two_RCMCI_withoutReheating();
                ...
                xlWorkSheet1.Cells[4, 10] = "CIT(K)";
                xlWorkSheet1.Cells[4, 11] = "LT UA(kW/K)";
                xlWorkSheet1.Cells[4, 12] = "HT UA(kW/K)";
                xlWorkSheet1.Cells[4, 13] = "Rec.Frac.";
                xlWorkSheet1.Cells[4, 14] = "Eff.(%)";
                xlWorkSheet1.Cells[4, 15] = "LTR Eff.(%)";
                xlWorkSheet1.Cells[4, 16] = "LTR Pinch(ºC)";
                ...
                using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500.0, 
                                                  initial_CIP_value + 1000.0, initial_CIP_value + 1500.0, initial_CIP_value + 2000.0 });
                    ...
                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 250.0 });

                    var initialValue = new[] { 0.2, initial_CIP_value + 4500.0, initial_CIP_value + 5500.0, 
                                               initial_CIP_value + 6500.0, initial_CIP_value + 7500.0, initial_CIP_value + 8500.0 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_Two_RCMCI_withoutReheating(puntero_aplicacion.luis,
                        ref cicloTwo_PC_Two_RCMCI_withoutReheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in,
                        puntero_aplicacion.t_pc2_in, puntero_aplicacion.t_mc5_in, puntero_aplicacion.t_mc4_in,
                        puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_t_in, variables[1],
                        variables[2], variables[2], variables[3],
                        variables[3], variables[4], variables[4],
                        variables[5], variables[5], puntero_aplicacion.p_mc3_out, 
                        ...
                        puntero_aplicacion.n_sub_hxrs, variables[0], puntero_aplicacion.tol, 
                        ...
                        -puntero_aplicacion.dp_pc5, -puntero_aplicacion.dp_phx);

                        counter++;

                        puntero_aplicacion.massflow2 = cicloTwo_PC_Two_RCMCI_withoutReheating.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloTwo_PC_Two_RCMCI_withoutReheating.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloTwo_PC_Two_RCMCI_withoutReheating.eta_thermal;
                        ...
                        puntero_aplicacion.temp21 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[0];
                        puntero_aplicacion.temp22 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[1];
                        puntero_aplicacion.temp23 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[2];
                        puntero_aplicacion.temp24 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[3];
                        puntero_aplicacion.temp25 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[4];
                        puntero_aplicacion.temp26 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[5];
                        puntero_aplicacion.temp27 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[6];
                        puntero_aplicacion.temp28 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[7];
                        puntero_aplicacion.temp29 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[8];
                        puntero_aplicacion.temp210 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[9];
                        puntero_aplicacion.temp211 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[10];
                        puntero_aplicacion.temp212 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[11];
                        puntero_aplicacion.temp213 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[12];
                        puntero_aplicacion.temp214 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[13];
                        puntero_aplicacion.temp215 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[14];
                        puntero_aplicacion.temp216 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[15];
                        puntero_aplicacion.temp217 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[16];
                        puntero_aplicacion.temp218 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[17];

                        puntero_aplicacion.pres21 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[0];
                        puntero_aplicacion.pres22 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[1];
                        puntero_aplicacion.pres23 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[2];
                        puntero_aplicacion.pres24 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[3];
                        puntero_aplicacion.pres25 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[4];
                        puntero_aplicacion.pres26 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[5];
                        puntero_aplicacion.pres27 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[6];
                        puntero_aplicacion.pres28 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[7];
                        puntero_aplicacion.pres29 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[8];
                        puntero_aplicacion.pres210 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[9];
                        puntero_aplicacion.pres211 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[10];
                        puntero_aplicacion.pres212 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[11];
                        puntero_aplicacion.pres213 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[12];
                        puntero_aplicacion.pres214 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[13];
                        puntero_aplicacion.pres215 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[14];
                        puntero_aplicacion.pres216 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[15];
                        puntero_aplicacion.pres217 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[16];
                        puntero_aplicacion.pres218 = cicloTwo_PC_Two_RCMCI_withoutReheating.pres[17];

                        puntero_aplicacion.PHX1 = cicloTwo_PC_Two_RCMCI_withoutReheating.PHX.Q_dot;

                        puntero_aplicacion.LT_Q = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.eff;

                        puntero_aplicacion.HT_Q = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.eff;

                        puntero_aplicacion.PC1 = -cicloTwo_PC_Two_RCMCI_withoutReheating.PC1.Q_dot;
                        puntero_aplicacion.PC2 = -cicloTwo_PC_Two_RCMCI_withoutReheating.PC2.Q_dot;
                        puntero_aplicacion.PC3 = -cicloTwo_PC_Two_RCMCI_withoutReheating.PC3.Q_dot;
                        puntero_aplicacion.PC4 = -cicloTwo_PC_Two_RCMCI_withoutReheating.PC4.Q_dot;
                        puntero_aplicacion.PC5 = -cicloTwo_PC_Two_RCMCI_withoutReheating.PC5.Q_dot;
                        ...
                        double LTR_min_DT_1 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[7] - cicloTwo_PC_Two_RCMCI_withoutReheating.temp[2];
                        double LTR_min_DT_2 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[8] - cicloTwo_PC_Two_RCMCI_withoutReheating.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[7] - cicloTwo_PC_Two_RCMCI_withoutReheating.temp[3];
                        double HTR_min_DT_2 = cicloTwo_PC_Two_RCMCI_withoutReheating.temp[6] - cicloTwo_PC_Two_RCMCI_withoutReheating.temp[4];
                        ...
                        //CIT
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = Convert.ToString(puntero_aplicacion.t_mc4_in - 273.15);
                        //LT UA(kW/K)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = Convert.ToString(puntero_aplicacion.ua_lt);
                        //HT UA(kW/K)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = Convert.ToString(puntero_aplicacion.ua_ht);
                        //Rec.Frac.
                        xlWorkSheet1.Cells[counter_Excel + 1, 13] = puntero_aplicacion.recomp_frac2.ToString();
                        //Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 14] = (puntero_aplicacion.eta_thermal2 * 100).ToString();
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 15] = cicloTwo_PC_Two_RCMCI_withoutReheating.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 16] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 17] = cicloTwo_PC_Two_RCMCI_withoutReheating.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "Two_PC_Two_RCMCI_withoutRH" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            //    xlWorkSheet1.Cells[4, 9] = "CIT(K)";
            //    xlWorkSheet1.Cells[4, 10] = "LT UA(kW/K)";
            //    xlWorkSheet1.Cells[4, 11] = "HT UA(kW/K)";
            //    xlWorkSheet1.Cells[4, 12] = "Rec.Frac.";
            //    xlWorkSheet1.Cells[4, 13] = "Eff.(%)";
            //    xlWorkSheet1.Cells[4, 14] = "LTR Eff.(%)";
            //    xlWorkSheet1.Cells[4, 15] = "LTR Pinch(ºC)";
            //    xlWorkSheet1.Cells[4, 16] = "HTR Eff.(%)";
            //    xlWorkSheet1.Cells[4, 17] = "HTR Pinch(ºC)";

            //    using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
            //    {
            //        solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500, initial_CIP_value + 1000, initial_CIP_value + 1500, 0.0 });
            ...
            //        Func<double[], double> funcion = delegate (double[] variables)
            //        {
            //            puntero_aplicacion.luis.RecompCycle_PC_Two_RCMCI_withoutReheating_for_optimization(puntero_aplicacion.luis,
            //            ref cicloPC_Two_RCMCI_withoutReheating,
            //            puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc_in, puntero_aplicacion.t_mc4_in,
            //            puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_mc2_in, puntero_aplicacion.t_t_in,
            //            variables[1], variables[2], variables[2],
            //            variables[3], variables[3], variables[4],
            //            variables[4], puntero_aplicacion.p_mc2_out, variables[5], UA_Total,
            //            puntero_aplicacion.m_eta_mc4, puntero_aplicacion.m_eta_pc,
            //            puntero_aplicacion.m_eta_rc, puntero_aplicacion.m_eta_mc3, puntero_aplicacion.m_eta_mc2,
            //            puntero_aplicacion.m_eta_t, puntero_aplicacion.n_sub_hxrs, variables[0],
            ...
            //            -puntero_aplicacion.dp_pc2, -puntero_aplicacion.dp_phx);

            //            counter++;

            //            puntero_aplicacion.massflow2 = cicloPC_Two_RCMCI_withoutReheating.m_dot_turbine;
            //            puntero_aplicacion.w_dot_net2 = cicloPC_Two_RCMCI_withoutReheating.W_dot_net;
            //            puntero_aplicacion.eta_thermal2 = cicloPC_Two_RCMCI_withoutReheating.eta_thermal;
            //            puntero_aplicacion.recomp_frac2 = variables[0];
            ...
            //            puntero_aplicacion.temp21 = cicloPC_Two_RCMCI_withoutReheating.temp[0];
            //            puntero_aplicacion.temp22 = cicloPC_Two_RCMCI_withoutReheating.temp[1];
            //            puntero_aplicacion.temp23 = cicloPC_Two_RCMCI_withoutReheating.temp[2];
            //            puntero_aplicacion.temp24 = cicloPC_Two_RCMCI_withoutReheating.temp[3];
            //            puntero_aplicacion.temp25 = cicloPC_Two_RCMCI_withoutReheating.temp[4];
            //            puntero_aplicacion.temp26 = cicloPC_Two_RCMCI_withoutReheating.temp[5];
            //            puntero_aplicacion.temp27 = cicloPC_Two_RCMCI_withoutReheating.temp[6];
            //            puntero_aplicacion.temp28 = cicloPC_Two_RCMCI_withoutReheating.temp[7];
            //            puntero_aplicacion.temp29 = cicloPC_Two_RCMCI_withoutReheating.temp[8];
            //            puntero_aplicacion.temp210 = cicloPC_Two_RCMCI_withoutReheating.temp[9];
            //            puntero_aplicacion.temp211 = cicloPC_Two_RCMCI_withoutReheating.temp[10];
            //            puntero_aplicacion.temp212 = cicloPC_Two_RCMCI_withoutReheating.temp[11];
            //            puntero_aplicacion.temp213 = cicloPC_Two_RCMCI_withoutReheating.temp[12];
            //            puntero_aplicacion.temp214 = cicloPC_Two_RCMCI_withoutReheating.temp[13];
            //            puntero_aplicacion.temp215 = cicloPC_Two_RCMCI_withoutReheating.temp[14];
            //            puntero_aplicacion.temp216 = cicloPC_Two_RCMCI_withoutReheating.temp[15];

            //            puntero_aplicacion.pres21 = cicloPC_Two_RCMCI_withoutReheating.pres[0];
            //            puntero_aplicacion.pres22 = cicloPC_Two_RCMCI_withoutReheating.pres[1];
            //            puntero_aplicacion.pres23 = cicloPC_Two_RCMCI_withoutReheating.pres[2];
            //            puntero_aplicacion.pres24 = cicloPC_Two_RCMCI_withoutReheating.pres[3];
            //            puntero_aplicacion.pres25 = cicloPC_Two_RCMCI_withoutReheating.pres[4];
            //            puntero_aplicacion.pres26 = cicloPC_Two_RCMCI_withoutReheating.pres[5];
            //            puntero_aplicacion.pres27 = cicloPC_Two_RCMCI_withoutReheating.pres[6];
            //            puntero_aplicacion.pres28 = cicloPC_Two_RCMCI_withoutReheating.pres[7];
            //            puntero_aplicacion.pres29 = cicloPC_Two_RCMCI_withoutReheating.pres[8];
            //            puntero_aplicacion.pres210 = cicloPC_Two_RCMCI_withoutReheating.pres[9];
            //            puntero_aplicacion.pres211 = cicloPC_Two_RCMCI_withoutReheating.pres[10];
            //            puntero_aplicacion.pres212 = cicloPC_Two_RCMCI_withoutReheating.pres[11];
            //            puntero_aplicacion.pres213 = cicloPC_Two_RCMCI_withoutReheating.pres[12];
            //            puntero_aplicacion.pres214 = cicloPC_Two_RCMCI_withoutReheating.pres[13];
            //            puntero_aplicacion.pres215 = cicloPC_Two_RCMCI_withoutReheating.pres[14];
            //            puntero_aplicacion.pres216 = cicloPC_Two_RCMCI_withoutReheating.pres[15];

            //            puntero_aplicacion.PHX1 = cicloPC_Two_RCMCI_withoutReheating.PHX.Q_dot;

            //            puntero_aplicacion.LT_Q = cicloPC_Two_RCMCI_withoutReheating.LT.Q_dot;
            //            puntero_aplicacion.LT_mdotc = cicloPC_Two_RCMCI_withoutReheating.LT.m_dot_design[0];
            //            puntero_aplicacion.LT_mdoth = cicloPC_Two_RCMCI_withoutReheating.LT.m_dot_design[1];
            //            puntero_aplicacion.LT_Tcin = cicloPC_Two_RCMCI_withoutReheating.LT.T_c_in;
            //            puntero_aplicacion.LT_Thin = cicloPC_Two_RCMCI_withoutReheating.LT.T_h_in;
            //            puntero_aplicacion.LT_Pcin = cicloPC_Two_RCMCI_withoutReheating.LT.P_c_in;
            //            puntero_aplicacion.LT_Phin = cicloPC_Two_RCMCI_withoutReheating.LT.P_h_in;
            //            puntero_aplicacion.LT_Pcout = cicloPC_Two_RCMCI_withoutReheating.LT.P_c_out;
            //            puntero_aplicacion.LT_Phout = cicloPC_Two_RCMCI_withoutReheating.LT.P_h_out;
            //            puntero_aplicacion.LT_Effc = cicloPC_Two_RCMCI_withoutReheating.LT.eff;

            //            puntero_aplicacion.HT_Q = cicloPC_Two_RCMCI_withoutReheating.HT.Q_dot;
            //            puntero_aplicacion.HT_mdotc = cicloPC_Two_RCMCI_withoutReheating.HT.m_dot_design[0];
            //            puntero_aplicacion.HT_mdoth = cicloPC_Two_RCMCI_withoutReheating.HT.m_dot_design[1];
            //            puntero_aplicacion.HT_Tcin = cicloPC_Two_RCMCI_withoutReheating.HT.T_c_in;
            //            puntero_aplicacion.HT_Thin = cicloPC_Two_RCMCI_withoutReheating.HT.T_h_in;
            //            puntero_aplicacion.HT_Pcin = cicloPC_Two_RCMCI_withoutReheating.HT.P_c_in;
            //            puntero_aplicacion.HT_Phin = cicloPC_Two_RCMCI_withoutReheating.HT.P_h_in;
            //            puntero_aplicacion.HT_Pcout = cicloPC_Two_RCMCI_withoutReheating.HT.P_c_out;
            //            puntero_aplicacion.HT_Phout = cicloPC_Two_RCMCI_withoutReheating.HT.P_h_out;
            //            puntero_aplicacion.HT_Effc = cicloPC_Two_RCMCI_withoutReheating.HT.eff;

            //            puntero_aplicacion.PC1 = -cicloPC_Two_RCMCI_withoutReheating.PC1.Q_dot;
            //            puntero_aplicacion.PC2 = -cicloPC_Two_RCMCI_withoutReheating.PC2.Q_dot;
            //            puntero_aplicacion.PC3 = -cicloPC_Two_RCMCI_withoutReheating.PC3.Q_dot;
            //            puntero_aplicacion.PC4 = -cicloPC_Two_RCMCI_withoutReheating.PC4.Q_dot;
            ...
            //            double LTR_min_DT_1 = cicloPC_Two_RCMCI_withoutReheating.temp[7] - cicloPC_Two_RCMCI_withoutReheating.temp[2];
            //            double LTR_min_DT_2 = cicloPC_Two_RCMCI_withoutReheating.temp[8] - cicloPC_Two_RCMCI_withoutReheating.temp[1];
            //            double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

            //            double HTR_min_DT_1 = cicloPC_Two_RCMCI_withoutReheating.temp[7] - cicloPC_Two_RCMCI_withoutReheating.temp[3];
            //            double HTR_min_DT_2 = cicloPC_Two_RCMCI_withoutReheating.temp[6] - cicloPC_Two_RCMCI_withoutReheating.temp[4];
            //            double HTR_min_DT_paper = Math.Min(HTR_min_DT_1, HTR_min_DT_2);
            ...
            //            //CIT
            //            xlWorkSheet1.Cells[counter_Excel + 1, 9] = Convert.ToString(puntero_aplicacion.t_mc4_in - 273.15);
            //            //LT UA(kW/K)
            //            xlWorkSheet1.Cells[counter_Excel + 1, 10] = Convert.ToString(puntero_aplicacion.ua_lt);
            //            //HT UA(kW/K)
            //            xlWorkSheet1.Cells[counter_Excel + 1, 11] = Convert.ToString(puntero_aplicacion.ua_ht);
            //            //Rec.Frac.
            //            xlWorkSheet1.Cells[counter_Excel + 1, 12] = puntero_aplicacion.recomp_frac2.ToString();
            //            //Eff.(%)
            //            xlWorkSheet1.Cells[counter_Excel + 1, 13] = (puntero_aplicacion.eta_thermal2 * 100).ToString();
            //            //LTR Eff.(%)
            //            xlWorkSheet1.Cells[counter_Excel + 1, 14] = cicloPC_Two_RCMCI_withoutReheating.LT.eff.ToString();
            //            //LTR Pinch(ºC)
            //            xlWorkSheet1.Cells[counter_Excel + 1, 15] = LTR_min_DT_paper.ToString();
            //            //HTR Eff.(%)
            //            xlWorkSheet1.Cells[counter_Excel + 1, 16] = cicloPC_Two_RCMCI_withoutReheating.HT.eff.ToString();
            //            //HTR Pinch(ºC)
            //            xlWorkSheet1.Cells[counter_Excel + 1, 17] = HTR_min_DT_paper.ToString();
            ...
            //        //Closing Excel Book
            //        xlWorkBook1.SaveAs(textBox3.Text + "PC_Two_RCMCI_withoutRH" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
