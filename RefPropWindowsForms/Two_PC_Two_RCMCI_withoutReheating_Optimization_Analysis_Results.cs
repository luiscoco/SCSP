    ...
    public partial class Two_PC_Two_RCMCI_withoutReheating_Optimization_Analysis_Results : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500.0,
                                                  initial_CIP_value + 1000.0, initial_CIP_value + 1500.0, initial_CIP_value + 2000.0, 0.0 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out,
                                                  puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, 1.0 });

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 250.0, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value + 4500.0, initial_CIP_value + 5500.0,
                                               initial_CIP_value + 6500.0, initial_CIP_value + 7500.0, initial_CIP_value + 8500.0, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_Two_RCMCI_withoutReheating_for_optimization(puntero_aplicacion.luis,
                        ref cicloTwo_PC_Two_RCMCI_withoutReheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in,
                        puntero_aplicacion.t_pc2_in, puntero_aplicacion.t_mc5_in, puntero_aplicacion.t_mc4_in,
                        puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_t_in, variables[1],
                        variables[2], variables[2], variables[3],
                        variables[3], variables[4], variables[4],
                        variables[5], variables[5], puntero_aplicacion.p_mc3_out,
                        variables[6], UA_Total, puntero_aplicacion.m_eta_mc5,
                        puntero_aplicacion.m_eta_pc1, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_rc,
                        puntero_aplicacion.m_eta_mc4, puntero_aplicacion.m_eta_mc3, puntero_aplicacion.m_eta_t,
                        puntero_aplicacion.n_sub_hxrs, variables[0], puntero_aplicacion.tol,
                        puntero_aplicacion.eta_thermal, -puntero_aplicacion.dp_lt1, -puntero_aplicacion.dp_lt2,
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_Two_PC_Two_RCMCI_withoutReheating(puntero_aplicacion.luis,
                                ref cicloTwo_PC_Two_RCMCI_withoutReheating, puntero_aplicacion.w_dot_net, i,
                                i, i, i, i, puntero_aplicacion.t_t_in, variables[1],
                                variables[2], variables[2], variables[3],
                                variables[3], variables[4], variables[4],
                                variables[5], variables[5], puntero_aplicacion.p_mc3_out,
                                puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht, puntero_aplicacion.m_eta_mc5,
                                ...
                                PHX_Q2_list.Add(cicloTwo_PC_Two_RCMCI_withoutReheating.PHX.Q_dot);

                                HT_Eff_list.Add(cicloTwo_PC_Two_RCMCI_withoutReheating.HT.eff);
                                LT_Eff_list.Add(cicloTwo_PC_Two_RCMCI_withoutReheating.LT.eff);
                    ...
                    else if (checkBox2.Checked == true)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_Two_PC_Two_RCMCI_withoutReheating_for_optimization(puntero_aplicacion.luis,
                                ref cicloTwo_PC_Two_RCMCI_withoutReheating, puntero_aplicacion.w_dot_net, i, i, i, i, i, 
                                puntero_aplicacion.t_t_in, variables[1], variables[2], variables[2], variables[3],
