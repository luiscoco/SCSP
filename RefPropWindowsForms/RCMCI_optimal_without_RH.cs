...
{
    public partial class RCMCI_optimal_without_RH : Form
    {
        ...
        const string refpropDLL_path4 = "RCMCI_Ethane_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path5 = "RCMCI_Methane_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path6 = "RCMCI_Nitrogen_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path7 = "RCMCI_SF6_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path8 = "RCMCI_Xenon_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path2 = "RCMCI_CO2_Optimal_without_RH_Newuoa.dll";
        ...
        const string refpropDLL_path3 = "RCMCI_CO2_Optimal_without_RH_Uobyqa.dll";
        ...
        public RCMCI_optimal_without_RH()
        {
            InitializeComponent();
        }
        ...
        //Heat Balance Results PHX1, PC11, PC21
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox4.Text == "Parabolic")
            {
                ...
                SF_PHX.PTC_Solar_Field_ciclo_RCMCI_Optimization_withoutReHeating(this, 11, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_ciclo_RCMCI_Optimization_withoutReHeating(this, 11, "Main_SF");
            ...
            Generator_dialog.RCMCI_Optimization_withoutReHeating(this, 11);
            ...
            Net_Power_dialog.RCMCI_Optimization_withoutReHeating(this, 11);
            ...
            Final_Report_dialog.Ciclo_RCMCI_Optimization_withoutReHeating(this, 11);
            Final_Report_dialog.Show();  
        }

        //Main Compressor 1 Design
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            ...
            Diagrams_dialog.RCMCI_Optimization_withoutReHeating(this, 11);
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            if (comboBox11.Text == "Parabolic")
            {
                ...
                DP_PHX1 = Convert.ToDouble(textBox51.Text);
                ...
                SF_PHX.PTC_Solar_Field_uno(luis);
                SF_PHX.PTC_Solar_Field_ciclo_RCMCI_Optimization_withoutReHeating(this, 11, "Main_SF1_Dual_Loop");
                SF_PHX.button3_Click(this, e);
                SF_PHX.Show();
            }
            ...
            else if (comboBox11.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_uno(luis);
                SF_PHX_LF.LF_Solar_Field_ciclo_RCMCI_Optimization_withoutReHeating(this, 11, "Main_SF1_Dual_Loop");
                SF_PHX_LF.Load_ComboBox7();
                SF_PHX_LF.button3_Click(this, e);
                SF_PHX_LF.Show();
            }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            if (comboBox10.Text == "Parabolic")
            {
                ...
                SF_PHX.textBox35.Text = Convert.ToString(pres26);
                SF_PHX.PTC_Solar_Field_uno(luis);
                SF_PHX.PTC_Solar_Field_ciclo_RCMCI_Optimization_withoutReHeating(this, 11, "Main_SF2_Dual_Loop");
                SF_PHX.button3_Click(this, e);
                SF_PHX.Show();
            }
            ...
            else if (comboBox10.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.textBox35.Text = Convert.ToString(pres26);
                SF_PHX_LF.LF_Solar_Field_uno(luis);
                SF_PHX_LF.LF_Solar_Field_ciclo_RCMCI_Optimization_withoutReHeating(this, 11, "Main_SF2_Dual_Loop");
                SF_PHX_LF.Load_ComboBox7();
                SF_PHX_LF.button3_Click(this, e);
                SF_PHX_LF.Show();
            }
