...
{
    public partial class RCMCI_with_Four_Reheatings : Form
    {
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            eta_trh42 = Convert.ToDouble(textBox113.Text);
            ...
            dp2_rhx41 = Convert.ToDouble(textBox112.Text);
            ...
            luis.RecompCycle_RCMCI_withFourReheating(luis, ref cicloRCMCIwithFourReheating, 
            w_dot_net2, t_mc2_in2, t_t_in2, t_rht1_in2, p_rhx1_in2, t_rht2_in2, p_rhx2_in2,
            t_rht3_in2, p_rhx3_in2, t_rht4_in2, p_rhx4_in2, p_mc2_in2, p_mc2_out2, p_mc1_in2,
            t_mc1_in2, p_mc1_out2, ua_lt2, ua_ht2, eta2_mc2, eta_rc2, eta1_mc2, eta_t2, eta_trh12,
            eta_trh22, eta_trh32, eta_trh42, n_sub_hxrs2, recomp_frac2, tol2, eta_thermal2,
            ...
            -dp2_rhx41, -dp2_rhx42, -dp11_pc2, -dp12_pc2);

            massflow2 = cicloRCMCIwithFourReheating.m_dot_turbine;
            w_dot_net2 = cicloRCMCIwithFourReheating.W_dot_net;
            eta_thermal2 = cicloRCMCIwithFourReheating.eta_thermal;
            recomp_frac2 = cicloRCMCIwithFourReheating.recomp_frac;

            temp21 = cicloRCMCIwithFourReheating.temp[0];
            temp22 = cicloRCMCIwithFourReheating.temp[1];
            temp23 = cicloRCMCIwithFourReheating.temp[2];
            temp24 = cicloRCMCIwithFourReheating.temp[3];
            temp25 = cicloRCMCIwithFourReheating.temp[4];
            temp26 = cicloRCMCIwithFourReheating.temp[5];
            temp27 = cicloRCMCIwithFourReheating.temp[6];
            temp28 = cicloRCMCIwithFourReheating.temp[7];
            temp29 = cicloRCMCIwithFourReheating.temp[8];
            temp210 = cicloRCMCIwithFourReheating.temp[9];
            temp211 = cicloRCMCIwithFourReheating.temp[10];
            temp212 = cicloRCMCIwithFourReheating.temp[11];
            temp213 = cicloRCMCIwithFourReheating.temp[12];
            temp214 = cicloRCMCIwithFourReheating.temp[13];
            temp215 = cicloRCMCIwithFourReheating.temp[14];
            temp216 = cicloRCMCIwithFourReheating.temp[15];
            temp217 = cicloRCMCIwithFourReheating.temp[16];
            temp218 = cicloRCMCIwithFourReheating.temp[17];
            temp219 = cicloRCMCIwithFourReheating.temp[18];
            temp220 = cicloRCMCIwithFourReheating.temp[19];

            pres21 = cicloRCMCIwithFourReheating.pres[0];
            pres22 = cicloRCMCIwithFourReheating.pres[1];
            pres23 = cicloRCMCIwithFourReheating.pres[2];
            pres24 = cicloRCMCIwithFourReheating.pres[3];
            pres25 = cicloRCMCIwithFourReheating.pres[4];
            pres26 = cicloRCMCIwithFourReheating.pres[5];
            pres27 = cicloRCMCIwithFourReheating.pres[6];
            pres28 = cicloRCMCIwithFourReheating.pres[7];
            pres29 = cicloRCMCIwithFourReheating.pres[8];
            pres210 = cicloRCMCIwithFourReheating.pres[9];
            pres211 = cicloRCMCIwithFourReheating.pres[10];
            pres212 = cicloRCMCIwithFourReheating.pres[11];
            pres213 = cicloRCMCIwithFourReheating.pres[12];
            pres214 = cicloRCMCIwithFourReheating.pres[13];
            pres215 = cicloRCMCIwithFourReheating.pres[14];
            pres216 = cicloRCMCIwithFourReheating.pres[15];
            pres217 = cicloRCMCIwithFourReheating.pres[16];
            pres218 = cicloRCMCIwithFourReheating.pres[17];
            pres219 = cicloRCMCIwithFourReheating.pres[18];
            pres220 = cicloRCMCIwithFourReheating.pres[19];
            ...
            {
                PHX1 = cicloRCMCIwithFourReheating.PHX.Q_dot;
                RHX1 = cicloRCMCIwithFourReheating.RHX1.Q_dot;
                RHX2 = cicloRCMCIwithFourReheating.RHX2.Q_dot;
                RHX3 = cicloRCMCIwithFourReheating.RHX3.Q_dot;
                RHX4 = cicloRCMCIwithFourReheating.RHX4.Q_dot;

                LT_Q = cicloRCMCIwithFourReheating.LT.Q_dot;
                LT_mdotc = cicloRCMCIwithFourReheating.LT.m_dot_design[0];
                LT_mdoth = cicloRCMCIwithFourReheating.LT.m_dot_design[1];
                LT_Tcin = cicloRCMCIwithFourReheating.LT.T_c_in;
                LT_Thin = cicloRCMCIwithFourReheating.LT.T_h_in;
                LT_Pcin = cicloRCMCIwithFourReheating.LT.P_c_in;
                LT_Phin = cicloRCMCIwithFourReheating.LT.P_h_in;
                LT_Pcout = cicloRCMCIwithFourReheating.LT.P_c_out;
                LT_Phout = cicloRCMCIwithFourReheating.LT.P_h_out;
                LT_Effc = cicloRCMCIwithFourReheating.LT.eff;

                HT_Q = cicloRCMCIwithFourReheating.HT.Q_dot;
                HT_mdotc = cicloRCMCIwithFourReheating.HT.m_dot_design[0];
                HT_mdoth = cicloRCMCIwithFourReheating.HT.m_dot_design[1];
                HT_Tcin = cicloRCMCIwithFourReheating.HT.T_c_in;
                HT_Thin = cicloRCMCIwithFourReheating.HT.T_h_in;
                HT_Pcin = cicloRCMCIwithFourReheating.HT.P_c_in;
                HT_Phin = cicloRCMCIwithFourReheating.HT.P_h_in;
                HT_Pcout = cicloRCMCIwithFourReheating.HT.P_c_out;
                HT_Phout = cicloRCMCIwithFourReheating.HT.P_h_out;
                HT_Effc = cicloRCMCIwithFourReheating.HT.eff;

                PC11 = -cicloRCMCIwithFourReheating.PC.Q_dot;
                PC21 = -cicloRCMCIwithFourReheating.COOLER.Q_dot;
        ...
        {
            RCMCI_with_Four_ReHeating_Optimization_Analysis_Results RCMCI_with_Four_ReHeating_Optimization_Analysis_Results_dialog = new RCMCI_with_Four_ReHeating_Optimization_Analysis_Results(this);
            RCMCI_with_Four_ReHeating_Optimization_Analysis_Results_dialog.Show();
        }
    }
}
