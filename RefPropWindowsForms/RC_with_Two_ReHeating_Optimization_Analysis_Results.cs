...
namespace RefPropWindowsForms
{
    public partial class RC_with_Two_ReHeating_Optimization_Analysis_Results : Form
    {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 4, 0.00001, 10000))
                {
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "RC_with_Two_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "CIT_Optimization_RC_with_Two_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
