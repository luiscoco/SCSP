...
{
    public partial class RC_with_Two_ReHeating_Optimization_Analysis_Results : Form
    {
        RC_with_Two_ReHeating puntero_aplicacion;

        public RC_with_Two_ReHeating_Optimization_Analysis_Results(RC_with_Two_ReHeating puntero1)
        {
        ...
        //NLopt optimization analysis button
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                //xlWorkSheet1.Cells[4, 17] = "PTC_RHX1_Apperture_Area(m2)";
                //xlWorkSheet1.Cells[4, 18] = "PTC_RHX1_Pressure_Drop(bar)";
                //xlWorkSheet1.Cells[4, 19] = "LF_RHX1_Apperture_Area(m2)";
                //xlWorkSheet1.Cells[4, 20] = "LF_RHX1_Pressure_Drop(bar)";
                //xlWorkSheet1.Cells[4, 21] = "PTC_RHX2Apperture_Area(m2)";
                //xlWorkSheet1.Cells[4, 22] = "PTC_RHX2_Pressure_Drop(bar)";
                ...
                using (var solver = new NLoptSolver(algorithm_type, 4, 0.01, 10000))
                {
                    ...
                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        ...
                        //PTC.textBox1.Text = Convert.ToString(puntero_aplicacion.PHX_Q2);
                        ...
                        //LF.textBox1.Text = Convert.ToString(puntero_aplicacion.PHX_Q2);
                        ...
                        ////PTC.textBox31.Text = this.textBox31.Text;
                        ////PTC.textBox36.Text = this.textBox36.Text;
                        //PTC_RHX1.textBox1.Text = Convert.ToString(puntero_aplicacion.RHX1_Q2);
                        ...
                        ////LF.textBox31.Text = this.textBox31.Text;
                        ////LF.textBox36.Text = this.textBox36.Text;
                        //LF_RHX1.textBox1.Text = Convert.ToString(puntero_aplicacion.RHX1_Q2);
                        ...
                        ////PTC.textBox31.Text = this.textBox31.Text;
                        ////PTC.textBox36.Text = this.textBox36.Text;
                        //PTC_RHX2.textBox1.Text = Convert.ToString(puntero_aplicacion.RHX2_Q2);
                        //PTC_RHX2.textBox2.Text = Convert.ToString(puntero_aplicacion.massflow2);
                        //PTC_RHX2.textBox3.Text = Convert.ToString(puntero_aplicacion.temp213);
                        //PTC_RHX2.textBox6.Text = Convert.ToString(puntero_aplicacion.temp214);
                        //PTC_RHX2.textBox4.Text = Convert.ToString(puntero_aplicacion.pres213);
                        //PTC_RHX2.textBox5.Text = Convert.ToString(puntero_aplicacion.pres214);
                        ...
                        ////LF.textBox31.Text = this.textBox31.Text;
                        ////LF.textBox36.Text = this.textBox36.Text;
                        //LF_RHX2.textBox1.Text = Convert.ToString(puntero_aplicacion.RHX2_Q2);
                        //LF_RHX2.textBox2.Text = Convert.ToString(puntero_aplicacion.massflow2);
                        //LF_RHX2.textBox3.Text = Convert.ToString(puntero_aplicacion.temp213);
                        //LF_RHX2.textBox6.Text = Convert.ToString(puntero_aplicacion.temp214);
                        //LF_RHX2.textBox4.Text = Convert.ToString(puntero_aplicacion.pres213);
                        //LF_RHX2.textBox5.Text = Convert.ToString(puntero_aplicacion.pres214);
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 9] = cicloRC_withTwoRH.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = cicloRC_withTwoRH.HT.eff.ToString();
                        //HTR Pinch(ºC)
                        ...
                        //xlWorkSheet1.Cells[counter_Excel + 1, 17] = puntero_aplicacion.PTC_ReHeating1_SF_Effective_Apperture_Area.ToString();
                        ////PTC_RHX1_Pressure_Drop(bar)
                        //xlWorkSheet1.Cells[counter_Excel + 1, 18] = puntero_aplicacion.PTC_ReHeating1_SF_Pressure_drop.ToString();
                        ////LF_RHX1_Apperture_Area(m2)
                        //xlWorkSheet1.Cells[counter_Excel + 1, 19] = puntero_aplicacion.LF_ReHeating1_SF_Effective_Apperture_Area.ToString();
                        ////LF_RHX1_Pressure_Drop(bar)
                        //xlWorkSheet1.Cells[counter_Excel + 1, 20] = puntero_aplicacion.LF_ReHeating1_SF_Pressure_drop.ToString();
                        ////PTC_RHX2_Apperture_Area(m2)
                        //xlWorkSheet1.Cells[counter_Excel + 1, 21] = puntero_aplicacion.PTC_ReHeating2_SF_Effective_Apperture_Area.ToString();
                        ////PTC_RHX2_Pressure_Drop(bar)
                        //xlWorkSheet1.Cells[counter_Excel + 1, 22] = puntero_aplicacion.PTC_ReHeating2_SF_Pressure_drop.ToString();
                        ////LF_RHX2_Apperture_Area(m2)
                        //xlWorkSheet1.Cells[counter_Excel + 1, 23] = puntero_aplicacion.LF_ReHeating2_SF_Effective_Apperture_Area.ToString();
                        ////LF_RHX2_Pressure_Drop(bar)
                        //xlWorkSheet1.Cells[counter_Excel + 1, 24] = puntero_aplicacion.LF_ReHeating2_SF_Pressure_drop.ToString();
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "SolarPaces2019_Paper_Results_RC_with_Two_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 5, 0.01, 10000))
                {
                    ...
                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycledesign_withTwoReheating_for_Optimization(puntero_aplicacion.luis,
                            ref cicloRC_withTwoRH, puntero_aplicacion.w_dot_net2, puntero_aplicacion.t_mc_in2,
                            puntero_aplicacion.t_t_in2, variables[1], puntero_aplicacion.p_mc_out2,
                           ...
                           -puntero_aplicacion.dp2_pc2, -puntero_aplicacion.dp2_phx1, -puntero_aplicacion.dp2_rhx1,
                           -puntero_aplicacion.dp2_rhx2, -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht2,
                           variables[2], UA_Total, variables[0], puntero_aplicacion.eta_mc,
                           puntero_aplicacion.eta_rc, puntero_aplicacion.eta_t, puntero_aplicacion.eta_trh1,
                           puntero_aplicacion.eta_trh2, puntero_aplicacion.n_sub_hxrs2, puntero_aplicacion.tol2);
                        ...
                        xlWorkSheet1.Cells[counter_Excel + 1, 6] = puntero_aplicacion.p_rhx1_in2.ToString();
                        //P_rhx2_in
                        xlWorkSheet1.Cells[counter_Excel + 1, 6] = puntero_aplicacion.p_rhx2_in2.ToString();
                        //Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 7] = (puntero_aplicacion.eta_thermal2 * 100).ToString();
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 8] = cicloRC_withTwoRH.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 9] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = cicloRC_withTwoRH.HT.eff.ToString();
                        //HTR Pinch(ºC)
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
            {
                ...
                if (checkBox2.Checked == false)
                {
                    ...
                    if (i == Convert.ToDouble(textBox57.Text))
                    {
                        ...
                        xlWorkSheet1.Cells[4, 19] = "LF_RHX1_Apperture_Area(m2)";
                        xlWorkSheet1.Cells[4, 20] = "LF_RHX1_Pressure_Drop(bar)";
                        xlWorkSheet1.Cells[4, 21] = "PTC_RHX2_Apperture_Area(m2)";
                        xlWorkSheet1.Cells[4, 22] = "PTC_RHX2_Pressure_Drop(bar)";
                        xlWorkSheet1.Cells[4, 23] = "LF_RHX2_Apperture_Area(m2)";
                        xlWorkSheet1.Cells[4, 24] = "LF_RHX2_Pressure_Drop(bar)";
                    }
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 4, 0.01, 10000))
                    {
                        solver.SetLowerBounds(new[] { 0.1, initial_Pressure_value, initial_Pressure_value + 2000, initial_Pressure_value + 1000 });
                        solver.SetUpperBounds(new[] { 1.0, 125000, puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000 });

                        solver.SetInitialStepSize(new[] { 0.01, 200, 1000, 1000 });

                        var initialValue = new[] { 0.1, initial_Pressure_value, 14000, 11000 };
                        ...
                        Func<double[], double> funcion = delegate (double[] variables)
                        {
                            ...
                            PHX_Q2_list.Add(cicloRC_withTwoRH.PHX.Q_dot);
                            RHX1_Q2_list.Add(cicloRC_withTwoRH.RHX1.Q_dot);
                            RHX2_Q2_list.Add(cicloRC_withTwoRH.RHX2.Q_dot);
                            ua_LT_list.Add(puntero_aplicacion.ua_lt2);
                            ua_HT_list.Add(puntero_aplicacion.ua_ht2);

                            HT_Eff_list.Add(cicloRC_withTwoRH.HT.eff);
                            LT_Eff_list.Add(cicloRC_withTwoRH.LT.eff);
                ...
                else if (checkBox2.Checked == true)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 5, 0.01, 10000))
                    {
                        solver.SetLowerBounds(new[] { 0.1, initial_Pressure_value, 0.2, initial_Pressure_value + 2000, initial_Pressure_value + 1000 });
                        solver.SetUpperBounds(new[] { 1.0, 125000, 0.8, puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000 });

                        solver.SetInitialStepSize(new[] { 0.05, 200, 0.05, 1000, 1000 });

                        var initialValue = new[] { 0.2, initial_Pressure_value, 0.2, 14000, 11000 };
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "SolarPaces2019_Paper_CIT_Optimization_RC_with_Two_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void RC_with_Two_ReHeating_Optimization_Analysis_Results_Load(object sender, EventArgs e)
        {
