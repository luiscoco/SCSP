...
{
    public partial class PCRC_with_Three_ReHeating : Form
    {
        public double MixtureCriticalPressure;
        public double MixtureCriticalTemperature;
        ...
        public PTC_Solar_Field SF_PHX_PTC;
        ...
        public Double RHX1_UA, RHX_NTU, RHX1_CR, RHX_min_DT, RHX1_Effectiveness, RHX1_Q_per_module, RHX1_number_modules, RHX1_min_DT_input;
        ...
        public Double PHX1, RHX1, RHX2, RHX3, PC1, COOLER1;
        ...
        public Double m_eta_trh32;
        public Double m_w_dot_net2;

        public PCRC_with_Three_ReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "NewMixture")
            {
                ...
                luis.core1(this.comboBox2.Text + "=" + textBox35.Text + "," +
                           ...
                           this.comboBox17.Text + "=" + textBox88.Text, category);
            }
            ...
            p_rhx2_in2 = Convert.ToDouble(textBox91.Text);
            t_rht2_in2 = Convert.ToDouble(textBox90.Text);
            p_rhx3_in2 = Convert.ToDouble(textBox100.Text);
            t_rht3_in2 = Convert.ToDouble(textBox99.Text);
            ...
            dp2_rhx21 = Convert.ToDouble(textBox89.Text);
            dp2_rhx31 = Convert.ToDouble(textBox98.Text);
            ...
            m_eta_t2 = Convert.ToDouble(textBox19.Text);
            m_eta_trh12 = Convert.ToDouble(textBox18.Text);
            m_eta_trh22 = Convert.ToDouble(textBox92.Text);
            m_eta_trh32 = Convert.ToDouble(textBox97.Text);
            ...
            luis.RecompCycle_PCRC_withThreeReheating(luis, ref cicloPCRC_withThreeRH, m_w_dot_net2,
            t_mc_in2, t_t_in2, t_rht1_in2, p_rhx1_in2, t_rht2_in2, p_rhx2_in2, t_rht3_in2, p_rhx3_in2, p_mc_in2, p_mc_out2, p_pc_in2, t_pc_in2, p_pc_out2,
            ua_lt2, ua_ht2, m_eta_mc2, m_eta_rc2, m_eta_pc2, m_eta_t2, m_eta_trh12, m_eta_trh22, m_eta_trh32, n_sub_hxrs2,
            m_recomp_frac2, tol2, eta_thermal2, -dp2_lt1, -dp2_lt2, -dp2_ht1, -dp2_ht2, -dp2_pc1, -dp2_pc2, -dp2_phx1, -dp2_phx2, 
            -dp2_rhx11, -dp2_rhx12, -dp2_rhx21, -dp2_rhx22, -dp2_rhx31, -dp2_rhx32, - dp2_cooler1, -dp2_cooler2);

            massflow2 = cicloPCRC_withThreeRH.m_dot_turbine;
            w_dot_net2 = cicloPCRC_withThreeRH.W_dot_net;
            eta_thermal2 = cicloPCRC_withThreeRH.eta_thermal;
            ...
            eta_trh32 = m_eta_trh32;

            temp21 = cicloPCRC_withThreeRH.temp[0];
            temp22 = cicloPCRC_withThreeRH.temp[1];
            temp23 = cicloPCRC_withThreeRH.temp[2];
            temp24 = cicloPCRC_withThreeRH.temp[3];
            temp25 = cicloPCRC_withThreeRH.temp[4];
            temp26 = cicloPCRC_withThreeRH.temp[5];
            temp27 = cicloPCRC_withThreeRH.temp[6];
            temp28 = cicloPCRC_withThreeRH.temp[7];
            temp29 = cicloPCRC_withThreeRH.temp[8];
            temp210 = cicloPCRC_withThreeRH.temp[9];
            temp211 = cicloPCRC_withThreeRH.temp[10];
            temp212 = cicloPCRC_withThreeRH.temp[11];
            temp213 = cicloPCRC_withThreeRH.temp[12];
            temp214 = cicloPCRC_withThreeRH.temp[13];
            temp215 = cicloPCRC_withThreeRH.temp[14];
            temp216 = cicloPCRC_withThreeRH.temp[15];
            temp217 = cicloPCRC_withThreeRH.temp[16];
            temp218 = cicloPCRC_withThreeRH.temp[17];

            pres21 = cicloPCRC_withThreeRH.pres[0];
            pres22 = cicloPCRC_withThreeRH.pres[1];
            pres23 = cicloPCRC_withThreeRH.pres[2];
            pres24 = cicloPCRC_withThreeRH.pres[3];
            pres25 = cicloPCRC_withThreeRH.pres[4];
            pres26 = cicloPCRC_withThreeRH.pres[5];
            pres27 = cicloPCRC_withThreeRH.pres[6];
            pres28 = cicloPCRC_withThreeRH.pres[7];
            pres29 = cicloPCRC_withThreeRH.pres[8];
            pres210 = cicloPCRC_withThreeRH.pres[9];
            pres211 = cicloPCRC_withThreeRH.pres[10];
            pres212 = cicloPCRC_withThreeRH.pres[11];
            pres213 = cicloPCRC_withThreeRH.pres[12];
            pres214 = cicloPCRC_withThreeRH.pres[13];
            pres215 = cicloPCRC_withThreeRH.pres[14];
            pres216 = cicloPCRC_withThreeRH.pres[15];
            pres217 = cicloPCRC_withThreeRH.pres[16];
            pres218 = cicloPCRC_withThreeRH.pres[17];
            ...
            textBox94.Text = Convert.ToString(temp215);
            textBox93.Text = Convert.ToString(temp216);
            textBox102.Text = Convert.ToString(temp217);
            textBox101.Text = Convert.ToString(temp218);
            ...
            textBox96.Text = Convert.ToString(pres215);
            textBox95.Text = Convert.ToString(pres216);
            textBox104.Text = Convert.ToString(pres217);
            textBox103.Text = Convert.ToString(pres218);
            ...
            {
                PHX1 = cicloPCRC_withThreeRH.PHX.Q_dot;
                RHX1 = cicloPCRC_withThreeRH.RHX1.Q_dot;
                RHX2 = cicloPCRC_withThreeRH.RHX2.Q_dot;
                recomp_frac2 = cicloPCRC_withThreeRH.recomp_frac;

                LT_Q = cicloPCRC_withThreeRH.LT.Q_dot;
                LT_mdotc = cicloPCRC_withThreeRH.LT.m_dot_design[0];
                LT_mdoth = cicloPCRC_withThreeRH.LT.m_dot_design[1];
                LT_Tcin = cicloPCRC_withThreeRH.LT.T_c_in;
                LT_Thin = cicloPCRC_withThreeRH.LT.T_h_in;
                LT_Pcin = cicloPCRC_withThreeRH.LT.P_c_in;
                LT_Phin = cicloPCRC_withThreeRH.LT.P_h_in;
                LT_Pcout = cicloPCRC_withThreeRH.LT.P_c_out;
                LT_Phout = cicloPCRC_withThreeRH.LT.P_h_out;
                LT_Effc = cicloPCRC_withThreeRH.LT.eff;

                HT_Q = cicloPCRC_withThreeRH.HT.Q_dot;
                HT_mdotc = cicloPCRC_withThreeRH.HT.m_dot_design[0];
                HT_mdoth = cicloPCRC_withThreeRH.HT.m_dot_design[1];
                HT_Tcin = cicloPCRC_withThreeRH.HT.T_c_in;
                HT_Thin = cicloPCRC_withThreeRH.HT.T_h_in;
                HT_Pcin = cicloPCRC_withThreeRH.HT.P_c_in;
                HT_Phin = cicloPCRC_withThreeRH.HT.P_h_in;
                HT_Pcout = cicloPCRC_withThreeRH.HT.P_c_out;
                HT_Phout = cicloPCRC_withThreeRH.HT.P_h_out;
                HT_Effc = cicloPCRC_withThreeRH.HT.eff;

                PC1 = -cicloPCRC_withThreeRH.PC.Q_dot;
                COOLER1 = -cicloPCRC_withThreeRH.COOLER.Q_dot;
        ...
        {
            PCRC_with_Three_ReHeating_Optimization_Analysis_Results PCRC_with_Three_ReHeating_Optimization_Analysis_Results_window = new PCRC_with_Three_ReHeating_Optimization_Analysis_Results(this);
        ...
        //Pre-Compressor calculation button
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            {
                SF_PHX_PTC = new PTC_Solar_Field();

                if (comboBox6.Text == "Solar Salt")
                {
                    SF_PHX_PTC.comboBox1.Text = "Solar Salt";
                }
                else if (comboBox6.Text == "Hitec XL")
                {
                    SF_PHX_PTC.comboBox1.Text = "Hitec XL";
                }
                else if (comboBox6.Text == "Therminol VP1")
                {
                    SF_PHX_PTC.comboBox1.Text = "Therminol VP1";
                }
                else if (comboBox6.Text == "Syltherm_800")
                {
                    SF_PHX_PTC.comboBox1.Text = "Syltherm_800";
                }
                else if (comboBox6.Text == "Dowtherm_A")
                {
                    SF_PHX_PTC.comboBox1.Text = "Dowtherm_A";
                }
                else if (comboBox6.Text == "Therminol_75")
                {
                    SF_PHX_PTC.comboBox1.Text = "Therminol_75";
                }
                else if (comboBox6.Text == "Liquid Sodium")
                {
                    SF_PHX_PTC.comboBox1.Text = "Liquid Sodium";
                }

                SF_PHX_PTC.textBox41.Text = Convert.ToString(PHX1);
                SF_PHX_PTC.textBox40.Text = Convert.ToString(massflow2);
                SF_PHX_PTC.textBox38.Text = Convert.ToString(temp25);
                SF_PHX_PTC.textBox36.Text = Convert.ToString(pres25);
                SF_PHX_PTC.textBox35.Text = Convert.ToString(pres26);
                SF_PHX_PTC.textBox37.Text = Convert.ToString(temp26);
                SF_PHX_PTC.PTC_Solar_Field_uno(luis);
                SF_PHX_PTC.PTC_Solar_Field_ciclo_PCRC_with_Three_ReHeating(this, 18, "Main_SF");
                SF_PHX_PTC.button3_Click(this, e);
                SF_PHX_PTC.Show();
            }
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_ciclo_PCRC_with_Three_ReHeating(this, 18, "Main_SF");
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (comboBox5.Text == "Parabolic")
            {
                ...
                SF_RHX1_PTC.textBox37.Text = Convert.ToString(temp212);
                SF_RHX1_PTC.PTC_Solar_Field_uno(luis);
                SF_RHX1_PTC.PTC_Solar_Field_ciclo_PCRC_with_Three_ReHeating(this, 18, "ReHeating1_SF");
            ...
            else if (comboBox5.Text == "Fresnel")
            {
                ...
                SF_RHX1_LF.textBox37.Text = Convert.ToString(temp212);
                SF_RHX1_LF.LF_Solar_Field_uno(luis);
                SF_RHX1_LF.LF_Solar_Field_ciclo_PCRC_with_Three_ReHeating(this, 18, "ReHeating1_SF");
        ...
        private void button31_Click(object sender, EventArgs e)
        {
            if (comboBox20.Text == "Parabolic")
            {
                ...
                SF_RHX2_PTC.textBox37.Text = Convert.ToString(temp216);
                SF_RHX2_PTC.PTC_Solar_Field_uno(luis);
                SF_RHX2_PTC.PTC_Solar_Field_ciclo_PCRC_with_Three_ReHeating(this, 18, "ReHeating2_SF");
            ...
            else if (comboBox20.Text == "Fresnel")
            {
                ...
                SF_RHX2_LF.textBox41.Text = Convert.ToString(RHX2);
                ...
                SF_RHX2_LF.textBox37.Text = Convert.ToString(temp216);
                SF_RHX2_LF.LF_Solar_Field_uno(luis);
                SF_RHX2_LF.LF_Solar_Field_ciclo_PCRC_with_Three_ReHeating(this, 18, "ReHeating2_SF");
        ...
        private void button33_Click(object sender, EventArgs e)
        {
            ...
            {
                SF_RHX3_PTC = new PTC_Solar_Field();

                if (comboBox21.Text == "Solar Salt")
                {
                    SF_RHX3_PTC.comboBox1.Text = "Solar Salt";
                }
                else if (comboBox21.Text == "Hitec XL")
                {
                    SF_RHX3_PTC.comboBox1.Text = "Hitec XL";
                }
                else if (comboBox21.Text == "Therminol VP1")
                {
                    SF_RHX3_PTC.comboBox1.Text = "Therminol VP1";
                }
                else if (comboBox21.Text == "Syltherm_800")
                {
                    SF_RHX3_PTC.comboBox1.Text = "Syltherm_800";
                }
                else if (comboBox21.Text == "Dowtherm_A")
                {
                    SF_RHX3_PTC.comboBox1.Text = "Dowtherm_A";
                }
                else if (comboBox21.Text == "Therminol_75")
                {
                    SF_RHX3_PTC.comboBox1.Text = "Therminol_75";
                }
                else if (comboBox21.Text == "Liquid Sodium")
                {
                    SF_RHX3_PTC.comboBox1.Text = "Liquid Sodium";
                }

                SF_RHX3_PTC.textBox41.Text = Convert.ToString(RHX3);
                SF_RHX3_PTC.textBox40.Text = Convert.ToString(massflow2);
                SF_RHX3_PTC.textBox38.Text = Convert.ToString(temp217);
                SF_RHX3_PTC.textBox36.Text = Convert.ToString(pres217);
                SF_RHX3_PTC.textBox35.Text = Convert.ToString(pres218);
                SF_RHX3_PTC.textBox37.Text = Convert.ToString(temp218);
                SF_RHX3_PTC.PTC_Solar_Field_uno(luis);
                SF_RHX3_PTC.PTC_Solar_Field_ciclo_PCRC_with_Three_ReHeating(this, 18, "ReHeating3_SF");
                SF_RHX3_PTC.button3_Click(this, e);
                SF_RHX3_PTC.Show();
            }

            else if (comboBox22.Text == "Fresnel")
            {
                SF_RHX3_LF = new Fresnel();

                if (comboBox21.Text == "Solar Salt")
                {
                    SF_RHX3_LF.comboBox1.Text = "Solar Salt";
                }
                else if (comboBox21.Text == "Hitec XL")
                {
                    SF_RHX3_LF.comboBox1.Text = "Hitec XL";
                }
                else if (comboBox21.Text == "Therminol VP1")
                {
                    SF_RHX3_LF.comboBox1.Text = "Therminol VP1";
                }
                else if (comboBox21.Text == "Syltherm_800")
                {
                    SF_RHX3_LF.comboBox1.Text = "Syltherm_800";
                }
                else if (comboBox21.Text == "Dowtherm_A")
                {
                    SF_RHX3_LF.comboBox1.Text = "Dowtherm_A";
                }
                else if (comboBox21.Text == "Therminol_75")
                {
                    SF_RHX3_LF.comboBox1.Text = "Therminol_75";
                }
                else if (comboBox21.Text == "Liquid Sodium")
                {
                    SF_RHX3_LF.comboBox1.Text = "Liquid Sodium";
                }

                SF_RHX3_LF.textBox41.Text = Convert.ToString(RHX3);
                SF_RHX3_LF.textBox40.Text = Convert.ToString(massflow2);
                SF_RHX3_LF.textBox38.Text = Convert.ToString(temp217);
                SF_RHX3_LF.textBox36.Text = Convert.ToString(pres217);
                SF_RHX3_LF.textBox35.Text = Convert.ToString(pres218);
                SF_RHX3_LF.textBox37.Text = Convert.ToString(temp218);
                SF_RHX3_LF.LF_Solar_Field_uno(luis);
                SF_RHX3_LF.LF_Solar_Field_ciclo_PCRC_with_Three_ReHeating(this, 18, "ReHeating3_SF");
                SF_RHX3_LF.Load_ComboBox7();
                SF_RHX3_LF.button3_Click(this, e);
                SF_RHX3_LF.Show();
            }
        }
    }
