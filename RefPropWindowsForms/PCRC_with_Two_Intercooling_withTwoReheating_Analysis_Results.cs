        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                {
                    ...
                    var initialValue = new[] { 0.2, initial_CIP_value + 3000.0, initial_CIP_value + 4500.0, initial_CIP_value + 5500.0, initial_CIP_value + 7500.0, initial_CIP_value + 8500.0 };
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value, initial_CIP_value, initial_CIP_value, initial_CIP_value, 0.0 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc_out2 / 1.3, puntero_aplicacion.p_mc_out2 / 1.3, puntero_aplicacion.p_mc_out2 / 1.3, puntero_aplicacion.p_mc_out2, puntero_aplicacion.p_mc_out2, 1.0 });

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 1000, 1000, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value + 3000.0, initial_CIP_value + 4500.0, initial_CIP_value + 5500.0, initial_CIP_value + 7500.0, initial_CIP_value + 8500.0, 0.5};

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_PCRC_withTwoIntercooling_withTwoReheating_for_optimization(puntero_aplicacion.luis,
                        ref cicloPCRC_withTwoIntercoolingwithTwoRH,
                        puntero_aplicacion.w_dot_net2, puntero_aplicacion.t_t_in2, variables[4],
                        puntero_aplicacion.t_rht1_in2, variables[5],
                        puntero_aplicacion.t_rht2_in2, puntero_aplicacion.t_mc_in2, variables[3],
                        ...
                        puntero_aplicacion.t_pc1_in2, variables[3], variables[1],
                        puntero_aplicacion.t_pc2_in2, variables[2],
                        variables[6], UA_Total, puntero_aplicacion.eta_mc2,
                        puntero_aplicacion.eta_rc2, puntero_aplicacion.eta_pc12,
                        puntero_aplicacion.eta_pc22, puntero_aplicacion.eta_t2, puntero_aplicacion.eta_trh12,
                        puntero_aplicacion.eta_trh22, puntero_aplicacion.n_sub_hxrs2,
                        variables[0], puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2,
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                        {
                            ...
                            var initialValue = new[] { 0.2, initial_CIP_value + 2000.0, initial_CIP_value + 3500.0, initial_CIP_value + 4500.0, initial_CIP_value + 7500.0, initial_CIP_value + 8500.0 };
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                ...
                                puntero_aplicacion.w_dot_net2, puntero_aplicacion.t_t_in2, variables[4],
                                puntero_aplicacion.t_rht1_in2, variables[5],
                                puntero_aplicacion.t_rht2_in2, i, variables[3],
                                puntero_aplicacion.p_mc_out2, variables[2],
                                ...
                                PHX_Q_list.Add(cicloPCRC_withTwoIntercoolingwithTwoRH.PHX.Q_dot);
                                RHX1_Q_list.Add(cicloPCRC_withTwoIntercoolingwithTwoRH.RHX1.Q_dot);
                                RHX2_Q_list.Add(cicloPCRC_withTwoIntercoolingwithTwoRH.RHX2.Q_dot);

                                HT_Eff_list.Add(cicloPCRC_withTwoIntercoolingwithTwoRH.HT.eff);
                                LT_Eff_list.Add(cicloPCRC_withTwoIntercoolingwithTwoRH.LT.eff);
