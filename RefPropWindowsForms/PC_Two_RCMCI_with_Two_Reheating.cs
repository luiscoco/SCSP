...
{
    public partial class PC_Two_RCMCI_with_Two_Reheating : Form
    {
        //Input Data:
        ...
        public Double LF_Reheating1_Net_Absorbed_SF, LF_Reheating1n_Collector_Efficiency, LF_Reheating1_SF_Pressure_drop, LF_Reheating1_calculated_mass_flux, LF_Reheating1_calculated_Number_Rows;
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            dp_rhx2 = Convert.ToDouble(textBox124.Text);
            ...
            luis.RecompCycle_PC_Two_RCMCI_with_Two_Reheating(luis, ref cicloPC_Two_RCMCI_with_Two_Reheating,
            w_dot_net, t_pc_in, t_mc4_in, t_mc3_in, t_mc2_in, t_t_in, t_trh1_in, p_trh1_in, t_trh2_in, p_trh2_in,
            p_pc_in, p_pc_out, p_mc4_in, p_mc4_out, p_mc3_in, p_mc3_out, p_mc2_in, p_mc2_out, ua_lt, ua_ht,
            m_eta_mc4, m_eta_pc, m_eta_rc, m_eta_mc3, m_eta_mc2, m_eta_t, m_eta_trh1, m_eta_trh2, n_sub_hxrs, 
            m_recomp_frac, tol, eta_thermal, -dp_lt1, -dp_lt2, -dp_ht1, -dp_ht2, -dp_pc1, -dp_pc4, -dp_pc3, -dp_pc2,
            -dp_phx, -dp_rhx1, -dp_rhx2);

            massflow2 = cicloPC_Two_RCMCI_with_Two_Reheating.m_dot_turbine;
            w_dot_net2 = cicloPC_Two_RCMCI_with_Two_Reheating.W_dot_net;
            eta_thermal2 = cicloPC_Two_RCMCI_with_Two_Reheating.eta_thermal;
            ...
            temp21 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[0];
            temp22 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[1];
            temp23 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[2];
            temp24 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[3];
            temp25 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[4];
            temp26 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[5];
            temp27 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[6];
            temp28 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[7];
            temp29 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[8];
            temp210 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[9];
            temp211 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[10];
            temp212 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[11];
            temp213 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[12];
            temp214 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[13];
            temp215 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[14];
            temp216 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[15];
            temp217 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[16];
            temp218 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[17];
            temp219 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[16];
            temp220 = cicloPC_Two_RCMCI_with_Two_Reheating.temp[17];

            pres21 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[0];
            pres22 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[1];
            pres23 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[2];
            pres24 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[3];
            pres25 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[4];
            pres26 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[5];
            pres27 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[6];
            pres28 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[7];
            pres29 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[8];
            pres210 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[9];
            pres211 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[10];
            pres212 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[11];
            pres213 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[12];
            pres214 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[13];
            pres215 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[14];
            pres216 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[15];
            pres217 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[16];
            pres218 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[17];
            pres219 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[18];
            pres220 = cicloPC_Two_RCMCI_with_Two_Reheating.pres[19];
            ...
            if (checkBox1.Checked == false)
            {
                ...
                LT_mdotc = cicloPC_Two_RCMCI_with_Two_Reheating.LT.m_dot_design[0];
                LT_mdoth = cicloPC_Two_RCMCI_with_Two_Reheating.LT.m_dot_design[1];
                LT_Tcin = cicloPC_Two_RCMCI_with_Two_Reheating.LT.T_c_in;
                LT_Thin = cicloPC_Two_RCMCI_with_Two_Reheating.LT.T_h_in;
                LT_Pcin = cicloPC_Two_RCMCI_with_Two_Reheating.LT.P_c_in;
                LT_Phin = cicloPC_Two_RCMCI_with_Two_Reheating.LT.P_h_in;
                LT_Pcout = cicloPC_Two_RCMCI_with_Two_Reheating.LT.P_c_out;
                LT_Phout = cicloPC_Two_RCMCI_with_Two_Reheating.LT.P_h_out;
                LT_Effc = cicloPC_Two_RCMCI_with_Two_Reheating.LT.eff;

                HT_Q = cicloPC_Two_RCMCI_with_Two_Reheating.HT.Q_dot;
                HT_mdotc = cicloPC_Two_RCMCI_with_Two_Reheating.HT.m_dot_design[0];
                HT_mdoth = cicloPC_Two_RCMCI_with_Two_Reheating.HT.m_dot_design[1];
                HT_Tcin = cicloPC_Two_RCMCI_with_Two_Reheating.HT.T_c_in;
                HT_Thin = cicloPC_Two_RCMCI_with_Two_Reheating.HT.T_h_in;
                HT_Pcin = cicloPC_Two_RCMCI_with_Two_Reheating.HT.P_c_in;
                HT_Phin = cicloPC_Two_RCMCI_with_Two_Reheating.HT.P_h_in;
                HT_Pcout = cicloPC_Two_RCMCI_with_Two_Reheating.HT.P_c_out;
                HT_Phout = cicloPC_Two_RCMCI_with_Two_Reheating.HT.P_h_out;
                HT_Effc = cicloPC_Two_RCMCI_with_Two_Reheating.HT.eff;

                PC1 = -cicloPC_Two_RCMCI_with_Two_Reheating.PC1.Q_dot;
                PC2 = -cicloPC_Two_RCMCI_with_Two_Reheating.PC2.Q_dot;
                PC3 = -cicloPC_Two_RCMCI_with_Two_Reheating.PC3.Q_dot;
                PC4 = -cicloPC_Two_RCMCI_with_Two_Reheating.PC4.Q_dot;
        ...
        {
            PC_Two_RCMCI_with_Two_ReHeating_Optimization_Analysis_Results PC_Two_RCMCI_with_Two_ReHeating_Optimization_Analysis_Results_dialog = new PC_Two_RCMCI_with_Two_ReHeating_Optimization_Analysis_Results(this);
            PC_Two_RCMCI_with_Two_ReHeating_Optimization_Analysis_Results_dialog.Show();
        }
