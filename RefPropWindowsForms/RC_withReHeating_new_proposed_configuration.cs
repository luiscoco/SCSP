    ...
    public partial class RC_withReHeating_new_proposed_configuration : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                SF_PHX.textBox41.Text = Convert.ToString(RHX1_Q2);
                ...
                SF_PHX.PTC_Solar_Field_ciclo_RC_Design_withReHeating_new_configuration(this, 23, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_ciclo_RC_Design_withReHeating_new_configuration(this, 23, "Main_SF");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (comboBox5.Text == "Parabolic")
            {
                ...
                SF_PHX.textBox41.Text = Convert.ToString(RHX2_Q2);
                SF_PHX.textBox40.Text = Convert.ToString(massflow2);
                SF_PHX.textBox38.Text = Convert.ToString(temp213);
                SF_PHX.textBox36.Text = Convert.ToString(pres213);
                SF_PHX.textBox35.Text = Convert.ToString(pres214);
                SF_PHX.textBox37.Text = Convert.ToString(temp214);
                SF_PHX.PTC_Solar_Field_uno(luis);
                SF_PHX.PTC_Solar_Field_ciclo_RC_Design_withReHeating_new_configuration(this, 23, "ReHeating_SF");
                SF_PHX.button3_Click(this, e);
                SF_PHX.Show();
            }
            ...
            else if (comboBox5.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_uno(luis);
                SF_PHX_LF.LF_Solar_Field_ciclo_RC_Design_withReHeating_new_configuration(this, 23, "ReHeating_SF");
                SF_PHX_LF.Load_ComboBox7();
                SF_PHX_LF.button3_Click(this, e);
                SF_PHX_LF.Show();
            }
