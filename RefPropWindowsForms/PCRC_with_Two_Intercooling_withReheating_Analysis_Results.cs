...
namespace RefPropWindowsForms
{
    public partial class PCRC_with_Two_Intercooling_withReheating_Analysis_Results : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 5, 0.000001, 10000))
                {
                    ...
                    var initialValue = new[] { 0.2, initial_CIP_value + 3500.0, initial_CIP_value + 4500.0, initial_CIP_value + 5500.0, initial_CIP_value + 7500.0 };
                    ...
                    //Closing Excel Book 
                    xlWorkBook1.SaveAs(textBox4.Text + "PCRC_with_Two_Intercooling_with_ReHeating" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true) 
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                {
                    ...
                    var initialValue = new[] { 0.2, initial_CIP_value + 3500.0, initial_CIP_value + 4500.0, initial_CIP_value + 5500.0, initial_CIP_value + 7500.0, 0.5 };
        ...
        private void button2_Click(object sender, EventArgs e)
        {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 5, 0.000001, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                ...
                                ref cicloPCRCwithTwoIntercoolingWithReheating, puntero_aplicacion.w_dot_net2,
                                puntero_aplicacion.t_t_in2, variables[4], puntero_aplicacion.t_rht_in2,
                                i, variables[3], puntero_aplicacion.p_mc_out2,
                                variables[2], i, variables[3],
                                ...
                                PHX_Q_list.Add(cicloPCRCwithTwoIntercoolingWithReheating.PHX.Q_dot);
                                RHX_Q_list.Add(cicloPCRCwithTwoIntercoolingWithReheating.RHX.Q_dot);

                                HT_Eff_list.Add(cicloPCRCwithTwoIntercoolingWithReheating.HT.eff);
                                LT_Eff_list.Add(cicloPCRCwithTwoIntercoolingWithReheating.LT.eff);
                            ...
                            LF_RHX.comboBox14.Text = puntero_aplicacion.comboBox6.Text;
                            //LF.textBox31.Text = this.textBox31.Text;
                            //LF.textBox36.Text = this.textBox36.Text;
                            ...
                            //P_rhx_in
                            xlWorkSheet1.Cells[counter_Excel + 1, 4] = p_rhx_in2_list[maxIndex].ToString();
                            //CIT
                            xlWorkSheet1.Cells[counter_Excel + 1, 5] = Convert.ToString(i - 273.15);
                            //LT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 6] = ua_lt2_list[maxIndex].ToString();
                            //HT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 7] = ua_ht2_list[maxIndex].ToString();
                            //Rec.Frac.
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox4.Text + "CIT_Optimization_PCRC_with_Two_Intercooling_with_ReHeating" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
