...
{
    public partial class Effec_Recomp_Fract_PCRC_withReHeating : Form
    {
        ...
        public Effec_Recomp_Fract_PCRC_withReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_PCRC_WithReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_PCRC_WithReHeating(this, "Main_SF");
                Main_LF_SF_PHX_Data_Input_Dialogue.comboBox1.Text = comboBox7.Text;
                Main_LF_SF_PHX_Data_Input_Dialogue.Show();
            }
        }
        //ReHeating_SF_Input_Data
        private void button7_Click(object sender, EventArgs e)
        {
            if (comboBox5.Text == "Parabolic")
            {
                ReHeating_PTC_SF_PHX_Data_Input_Dialogue = new PTC_SF_PHX_Data_Input();
                ReHeating_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_PCRC_WithReHeating(this, "ReHeating_SF");
            ...
            else if (comboBox5.Text == "Fresnel")
            {
                ...
                ReHeating_LF_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_PCRC_WithReHeating(this, "ReHeating_SF");
