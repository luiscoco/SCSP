...
namespace RefPropWindowsForms
{
    public partial class WizardSeventeen : Form
    {
        ...
        {
            puntero.SB_with_Three_Recuperators_and_One_Recompressor_without_ReHeating_dialog = new SB_with_Three_Recuperators_and_One_Recompressor_without_ReHeating(puntero);
