...
{
    public partial class PCRC_with_Three_ReHeating_Optimization_Analysis_Results : Form
    {
        PCRC_with_Three_ReHeating puntero_aplicacion;

        public PCRC_with_Three_ReHeating_Optimization_Analysis_Results(PCRC_with_Three_ReHeating puntero1)
        {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 6, 0.01, 10000))
                {
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox4.Text + "SolarPaces2019_Paper_Results_PCRC_with_Three_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 7, 0.01, 10000))
                {
                    ...
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, (initial_CIP_value + 500), initial_CIP_value + 3000, initial_CIP_value + 2000, initial_CIP_value + 1000, 0.2 });
                    solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, puntero_aplicacion.p_mc_out2 - 3000, 0.8 });

                    solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 1000, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value, (initial_CIP_value + 500), 15000, 13000, 11000, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {

                        puntero_aplicacion.luis.RecompCycle_PCRC_withThreeReheating_for_Optimization(puntero_aplicacion.luis,
                        ref cicloPCRC_withThreeRH, puntero_aplicacion.m_w_dot_net2,
                        puntero_aplicacion.t_mc_in2, puntero_aplicacion.t_t_in2,
                        puntero_aplicacion.t_rht1_in2, variables[3],
                        puntero_aplicacion.t_rht2_in2, variables[4],
                        ...
                        variables[2], puntero_aplicacion.p_mc_out2, variables[1],
                        puntero_aplicacion.t_pc_in2, variables[2],
                        variables[6], UA_Total, puntero_aplicacion.m_eta_mc2,
                        puntero_aplicacion.m_eta_rc2, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_t2,
                        puntero_aplicacion.m_eta_trh12, puntero_aplicacion.m_eta_trh22,
                        puntero_aplicacion.m_eta_trh32, puntero_aplicacion.n_sub_hxrs2,
                        variables[0], puntero_aplicacion.tol2,
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
            {
                ...
                if (checkBox2.Checked == false)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 6, 0.01, 10000))
                    {
                        ...
                        solver.SetLowerBounds(new[] { 0.1, initial_pc_in_value, (initial_pc_in_value + 500), puntero_aplicacion.MixtureCriticalPressure + 3000, puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000 });
                        solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, puntero_aplicacion.p_mc_out2 - 3000 });

                        solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 1000 });

                        var initialValue = new[] { 0.2, initial_pc_in_value, (initial_pc_in_value + 500), 15000, 13000, 11000 };
                        ...
                        Func<double[], double> funcion = delegate (double[] variables)
                        {
                            ...
                            PHX_Q_list.Add(cicloPCRC_withThreeRH.PHX.Q_dot);
                            RHX1_Q_list.Add(cicloPCRC_withThreeRH.RHX1.Q_dot);
                            RHX2_Q_list.Add(cicloPCRC_withThreeRH.RHX2.Q_dot);
                            RHX3_Q_list.Add(cicloPCRC_withThreeRH.RHX3.Q_dot);

                            HT_Eff_list.Add(cicloPCRC_withThreeRH.HT.eff);
                            LT_Eff_list.Add(cicloPCRC_withThreeRH.LT.eff);
                ...
                else if (checkBox2.Checked == true)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 7, 0.01, 10000))
                    {
                        ...
                        solver.SetLowerBounds(new[] { 0.1, initial_pc_in_value, (initial_pc_in_value + 500), puntero_aplicacion.MixtureCriticalPressure + 3000, puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000, 0.2 });
                        solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc_out2 / 1.5), puntero_aplicacion.p_mc_out2 - 1000, puntero_aplicacion.p_mc_out2 - 2000, puntero_aplicacion.p_mc_out2 - 3000, 0.8 });

                        solver.SetInitialStepSize(new[] { 0.05, 100, 100, 1000, 1000, 1000, 0.05 });

                        var initialValue = new[] { 0.2, initial_pc_in_value, (initial_pc_in_value + 500), 15000, 13000, 11000, 0.5 };
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox4.Text + "SolarPaces2019_Paper_CIT_Optimization_PCRC_with_Three_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void PCRC_with_Three_ReHeating_Optimization_Analysis_Results_Load(object sender, EventArgs e)
        {
