...
namespace RefPropWindowsForms
{
    public partial class Two_PC_RCMCI_withReheating : Form
    {
        ...
        {
            Two_PC_RCMCI_withReheating_Optimization_Analysis_Results Two_PC_RCMCI_withReheating_Optimization_Analysis_Results_dialog = new Two_PC_RCMCI_withReheating_Optimization_Analysis_Results();
