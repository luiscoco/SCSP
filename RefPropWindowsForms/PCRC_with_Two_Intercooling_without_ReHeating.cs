...
namespace RefPropWindowsForms
{
    public partial class PCRC_with_Two_Intercooling_without_ReHeating : Form
    {
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            {
                PHX1 = cicloPCRC_withTwoIntercoolingwithoutRH.PHX.Q_dot;

                LT_Q = cicloPCRC_withTwoIntercoolingwithoutRH.LT.Q_dot;
                LT_mdotc = cicloPCRC_withTwoIntercoolingwithoutRH.LT.m_dot_design[0];
                LT_mdoth = cicloPCRC_withTwoIntercoolingwithoutRH.LT.m_dot_design[1];
                LT_Tcin = cicloPCRC_withTwoIntercoolingwithoutRH.LT.T_c_in;
                LT_Thin = cicloPCRC_withTwoIntercoolingwithoutRH.LT.T_h_in;
                LT_Pcin = cicloPCRC_withTwoIntercoolingwithoutRH.LT.P_c_in;
                LT_Phin = cicloPCRC_withTwoIntercoolingwithoutRH.LT.P_h_in;
                LT_Pcout = cicloPCRC_withTwoIntercoolingwithoutRH.LT.P_c_out;
                LT_Phout = cicloPCRC_withTwoIntercoolingwithoutRH.LT.P_h_out;
                LT_Effc = cicloPCRC_withTwoIntercoolingwithoutRH.LT.eff;

                HT_Q = cicloPCRC_withTwoIntercoolingwithoutRH.HT.Q_dot;
                HT_mdotc = cicloPCRC_withTwoIntercoolingwithoutRH.HT.m_dot_design[0];
                HT_mdoth = cicloPCRC_withTwoIntercoolingwithoutRH.HT.m_dot_design[1];
                HT_Tcin = cicloPCRC_withTwoIntercoolingwithoutRH.HT.T_c_in;
                HT_Thin = cicloPCRC_withTwoIntercoolingwithoutRH.HT.T_h_in;
                HT_Pcin = cicloPCRC_withTwoIntercoolingwithoutRH.HT.P_c_in;
                HT_Phin = cicloPCRC_withTwoIntercoolingwithoutRH.HT.P_h_in;
                HT_Pcout = cicloPCRC_withTwoIntercoolingwithoutRH.HT.P_c_out;
                HT_Phout = cicloPCRC_withTwoIntercoolingwithoutRH.HT.P_h_out;
                HT_Effc = cicloPCRC_withTwoIntercoolingwithoutRH.HT.eff;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (comboBox5.Text == "Parabolic")
            {
                ...
                SF_PHX.PTC_Solar_Field_ciclo_PCRC_with_Two_Intercooling_without_ReHeating(this, 27, "Main_SF");
            ...
            else if (comboBox5.Text == "Fresnel")
            {
                ...
                SF_PHX_LF.LF_Solar_Field_ciclo_PCRC_with_Two_Intercooling_without_ReHeating(this, 27, "Main_SF");
