...
{
    public partial class Effec_Recomp_Fract_RCMCI_withoutReHeating : Form
    {
        ...
        const string refpropDLL_path1 = "RCMCI_CO2_Optimal_without_RH_Subplex.dll";
        ...
        public static extern void carbondioxidesubplex_(ref Double w_dot_net1, ref Double t_mc1_in1, ref Double t_mc2_in1, ref Double t_t_in1, ref Double p_mc1_in_guess1,
                                                 ref Boolean fixed_p_mc1_in1, ref Double ua_rec_total1, ref Double eta_mc1, ref Double eta_mc2, ref Double eta_rc1,
                                                 ref Double eta_t1, ref Int64 n_sub_hxrs1, ref Double p_high_limit1, ref Double p_mc2_out_guess1, ref Boolean fixed_p_mc2_out1,
                                                 ...
                                                 ref Double dp2_pc1, ref Double dp2_pc2, ref Double dp_phx1, ref Double dp_phx2,
                                                 ...
                                                 ref Double HT_Pcout, ref Double HT_Phout, ref Double HT_Q, ref Double LT_UA, ref Double HT_UA, ref Double LT_Effc, ref Double HT_Effc, ref Double PHX, ref Double PC1, ref Double PC2);

        const string refpropDLL_path2 = "RCMCI_Ethane_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path3 = "RCMCI_Methane_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path4 = "RCMCI_Nitrogen_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path5 = "RCMCI_SF6_Optimal_without_RH_Subplex.dll";
        ...
        const string refpropDLL_path6 = "RCMCI_Xenon_Optimal_without_RH_Subplex.dll";
        ...
        public Effec_Recomp_Fract_RCMCI_withoutReHeating()
        {
            InitializeComponent();
        }
        ...
        { 
            ...
            if (comboBox2.Text == "CO2")
            {
                ...
                carbondioxidesubplex_(ref w_dot_net2, ref t_mc1_in2, ref t_mc2_in2, ref t_t_in2, ref p_mc1_in_guess2,
                             ref fixed_p_mc1_in2, ref ua_rec_total2, ref eta1_mc2, ref eta2_mc2, ref eta_rc2,
                             ref eta_t2, ref n_sub_hxrs2, ref p_high_limit2, ref p_mc2_out_guess2, ref fixed_p_mc2_out2,
                             ...
                             ref dp2_pc1, ref dp2_pc2, ref dp2_phx1, ref dp2_phx2,
                ...
                textBox28.Text = Convert.ToString(pres24);
                ...
                textBox58.Text = Convert.ToString(pres213);
                textBox54.Text = Convert.ToString(pres214);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            UA_Total_min = Convert.ToDouble(textBox65.Text);
            UA_Total_max = Convert.ToDouble(textBox69.Text);
            UA_Total_increment = Convert.ToDouble(textBox60.Text);          
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
                ...
                recomp_min = Convert.ToDouble(textBox64.Text);
                ...
                recomp_max = Convert.ToDouble(textBox68.Text);
                recomp_increment = Convert.ToDouble(textBox61.Text);
                ...
                for (int i = 0; i < Convert.ToInt64(maxiter); i++)
                {
                    ...
                    PR_frac_point.SetValueXY(recomp_temp_value, pr_mc2_guess2);
            ...
            //Net Plant Efficiency &  Recomp_Frac
            if (radioButton1.Checked == true)
            {
                Recomp_Frac = new double[eta_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + eta_list[element] + " Effic.: " + eta_list[element1] + " UA: " + eta_list[element2]);
                    Recomp_Frac[contador] = eta_list[element];
            ...
            //LT_Fraction &  Recomp_Frac
            else if (radioButton2.Checked == true)
            {
                Recomp_Frac = new double[LT_frac_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + LT_frac_list[element] + " Effic.: " + LT_frac_list[element1] + " UA: " + LT_frac_list[element2]);
                    Recomp_Frac[contador] = LT_frac_list[element];
            ...
            {
                Recomp_Frac = new double[LT_UA_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + LT_UA_list[element] + " Effic.: " + LT_UA_list[element1] + " UA: " + LT_UA_list[element2]);
                    Recomp_Frac[contador] = LT_UA_list[element];
            ...
            {
                Recomp_Frac = new double[HT_UA_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + HT_UA_list[element] + " Effic.: " + HT_UA_list[element1] + " UA: " + HT_UA_list[element2]);
                    Recomp_Frac[contador] = HT_UA_list[element];
            ...
            {
                Recomp_Frac = new double[PR_frac_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PR_frac_list[element] + " Effic.: " + PR_frac_list[element1] + " UA: " + PR_frac_list[element2]);
                    Recomp_Frac[contador] = PR_frac_list[element];
            ...
            {
                Recomp_Frac = new double[CIP_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + CIP_list[element] + " Effic.: " + CIP_list[element1] + " UA: " + CIP_list[element2]);
                    Recomp_Frac[contador] = CIP_list[element];
            ...
            //LT_HX_Eff &  Recomp_Frac
            else if (radioButton8.Checked == true)
            {
                Recomp_Frac = new double[LT_HX_Eff_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + LT_HX_Eff_list[element] + " Effic.: " + LT_HX_Eff_list[element1] + " UA: " + LT_HX_Eff_list[element2]);
                    Recomp_Frac[contador] = LT_HX_Eff_list[element];
            ...
            //LT_HX_min_DT &  Recomp_Frac
            else if (radioButton9.Checked == true)
            {
                Recomp_Frac = new double[LT_HX_min_DT_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + LT_HX_min_DT_list[element] + " Effic.: " + LT_HX_min_DT_list[element1] + " UA: " + LT_HX_min_DT_list[element2]);
                    Recomp_Frac[contador] = LT_HX_min_DT_list[element];
            ...
            //HT_HX_Eff &  Recomp_Frac
            else if (radioButton11.Checked == true)
            {
                Recomp_Frac = new double[HT_HX_Eff_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + HT_HX_Eff_list[element] + " Effic.: " + HT_HX_Eff_list[element1] + " UA: " + HT_HX_Eff_list[element2]);
                    Recomp_Frac[contador] = HT_HX_Eff_list[element];
            ...
            //HT_HX_min_DT &  Recomp_Frac
            else if (radioButton10.Checked == true)
            {
                Recomp_Frac = new double[HT_HX_min_DT_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + HT_HX_min_DT_list[element] + " Effic.: " + HT_HX_min_DT_list[element1] + " UA: " + HT_HX_min_DT_list[element2]);
                    Recomp_Frac[contador] = HT_HX_min_DT_list[element];
            ...
            //Main_SF_Effective_Aperture_Area &  Recomp_Frac
            else if (radioButton20.Checked == true)
            {
                Recomp_Frac = new double[Main_SF_Effective_Aperture_Area_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + Main_SF_Effective_Aperture_Area_list[element] + " Effic.: " + Main_SF_Effective_Aperture_Area_list[element1] + " UA: " + Main_SF_Effective_Aperture_Area_list[element2]);
                    Recomp_Frac[contador] = Main_SF_Effective_Aperture_Area_list[element];
            ...
            //Main_SF_Pressure_Drop &  Recomp_Frac
            else if (radioButton15.Checked == true)
            {
                Recomp_Frac = new double[Main_SF_Pressure_Drop_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + Main_SF_Pressure_Drop_list[element] + " Effic.: " + Main_SF_Pressure_Drop_list[element1] + " UA: " + Main_SF_Pressure_Drop_list[element2]);
                    Recomp_Frac[contador] = Main_SF_Pressure_Drop_list[element];
            ...
            {
                Recomp_Frac = new double[PHX_Eff_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PHX_Eff_list[element] + " Effic.: " + PHX_Eff_list[element1] + " UA: " + PHX_Eff_list[element2]);
                    Recomp_Frac[contador] = PHX_Eff_list[element];
            ...
            {
                Recomp_Frac = new double[PHX_UA_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PHX_UA_list[element] + " Effic.: " + PHX_UA_list[element1] + " UA: " + PHX_UA_list[element2]);
                    Recomp_Frac[contador] = PHX_UA_list[element];
            ...
            {
                Recomp_Frac = new double[PHX_Q_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PHX_Q_list[element] + " Effic.: " + PHX_Q_list[element1] + " UA: " + PHX_Q_list[element2]);
                    Recomp_Frac[contador] = PHX_Q_list[element];
            ...
            {
                Recomp_Frac = new double[PC1_Eff_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PC1_Eff_list[element] + " Effic.: " + PC1_Eff_list[element1] + " UA: " + PC1_Eff_list[element2]);
                    Recomp_Frac[contador] = PC1_Eff_list[element];
            ...
            {
                Recomp_Frac = new double[PC1_UA_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PC1_UA_list[element] + " Effic.: " + PC1_UA_list[element1] + " UA: " + PC1_UA_list[element2]);
                    Recomp_Frac[contador] = PC1_UA_list[element];
            ...
            {
                Recomp_Frac = new double[PC1_Q_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PC1_Q_list[element] + " Effic.: " + PC1_Q_list[element1] + " UA: " + PC1_Q_list[element2]);
                    Recomp_Frac[contador] = PC1_Q_list[element];
            ...
            {
                Recomp_Frac = new double[PC2_Eff_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PC2_Eff_list[element] + " Effic.: " + PC2_Eff_list[element1] + " UA: " + PC2_Eff_list[element2]);
                    Recomp_Frac[contador] = PC2_Eff_list[element];
            ...
            {
                Recomp_Frac = new double[PC2_UA_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PC2_UA_list[element] + " Effic.: " + PC2_UA_list[element1] + " UA: " + PC2_UA_list[element2]);
                    Recomp_Frac[contador] = PC2_UA_list[element];
            ...
            {
                Recomp_Frac = new double[PC2_Q_list.Count / 3];
                ...
                {
                    comboBox8.Items.Add(" Recomp_Frac: " + PC2_Q_list[element] + " Effic.: " + PC2_Q_list[element1] + " UA: " + PC2_Q_list[element2]);
                    Recomp_Frac[contador] = PC2_Q_list[element];
            ...
            if (radioButton1.Checked == true)
            {
                ...
                {
                    chart1.ChartAreas["ChartArea1"].AxisX.Minimum = Convert.ToDouble(textBox70.Text);
                    chart1.ChartAreas["ChartArea1"].AxisX.Maximum = Convert.ToDouble(textBox71.Text);
                    chart1.ChartAreas["ChartArea1"].AxisY.Minimum = Convert.ToDouble(textBox55.Text);
                    chart1.ChartAreas["ChartArea1"].AxisY.Maximum = Convert.ToDouble(textBox51.Text);
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_RCMCI_Without_ReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_Recomp_Fract_RCMCI_Without_ReHeating(this, "Main_SF");
