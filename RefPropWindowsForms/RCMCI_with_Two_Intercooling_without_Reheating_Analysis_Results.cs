        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 4, 0.000001, 10000))
                {
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "RCMCI_with_Two_Intercooling_without_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
