...
{
    public partial class PCRCMCI_with_Two_ReHeating : Form
    {
        //Input Data:
        ...
        public PCRCMCI_with_Two_ReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            luis.RecompCycle_PCRCMCI_withTwoReheating(luis, ref cicloPCRCMCI_withTwoRH, w_dot_net,
            ...
            m_eta_mc2, m_eta_pc, m_eta_rc, m_eta_mc1, m_eta_t, m_eta_trh1, m_eta_trh2, n_sub_hxrs, m_recomp_frac,
            tol, eta_thermal, -dp_lt1, -dp_lt2, -dp_ht1, -dp_ht2, -dp_pc1, -dp_pc2, -dp_pc3, -dp_phx, -dp_rhx1, -dp_rhx2);

            massflow2 = cicloPCRCMCI_withTwoRH.m_dot_turbine;
            w_dot_net2 = cicloPCRCMCI_withTwoRH.W_dot_net;
            eta_thermal2 = cicloPCRCMCI_withTwoRH.eta_thermal;
            ...
            temp21 = cicloPCRCMCI_withTwoRH.temp[0];
            temp22 = cicloPCRCMCI_withTwoRH.temp[1];
            temp23 = cicloPCRCMCI_withTwoRH.temp[2];
            temp24 = cicloPCRCMCI_withTwoRH.temp[3];
            temp25 = cicloPCRCMCI_withTwoRH.temp[4];
            temp26 = cicloPCRCMCI_withTwoRH.temp[5];
            temp27 = cicloPCRCMCI_withTwoRH.temp[6];
            temp28 = cicloPCRCMCI_withTwoRH.temp[7];
            temp29 = cicloPCRCMCI_withTwoRH.temp[8];
            temp210 = cicloPCRCMCI_withTwoRH.temp[9];
            temp211 = cicloPCRCMCI_withTwoRH.temp[10];
            temp212 = cicloPCRCMCI_withTwoRH.temp[11];
            temp213 = cicloPCRCMCI_withTwoRH.temp[12];
            temp214 = cicloPCRCMCI_withTwoRH.temp[13];
            temp215 = cicloPCRCMCI_withTwoRH.temp[14];
            temp216 = cicloPCRCMCI_withTwoRH.temp[15];
            temp217 = cicloPCRCMCI_withTwoRH.temp[16];
            temp218 = cicloPCRCMCI_withTwoRH.temp[17];

            pres21 = cicloPCRCMCI_withTwoRH.pres[0];
            pres22 = cicloPCRCMCI_withTwoRH.pres[1];
            pres23 = cicloPCRCMCI_withTwoRH.pres[2];
            pres24 = cicloPCRCMCI_withTwoRH.pres[3];
            pres25 = cicloPCRCMCI_withTwoRH.pres[4];
            pres26 = cicloPCRCMCI_withTwoRH.pres[5];
            pres27 = cicloPCRCMCI_withTwoRH.pres[6];
            pres28 = cicloPCRCMCI_withTwoRH.pres[7];
            pres29 = cicloPCRCMCI_withTwoRH.pres[8];
            pres210 = cicloPCRCMCI_withTwoRH.pres[9];
            pres211 = cicloPCRCMCI_withTwoRH.pres[10];
            pres212 = cicloPCRCMCI_withTwoRH.pres[11];
            pres213 = cicloPCRCMCI_withTwoRH.pres[12];
            pres214 = cicloPCRCMCI_withTwoRH.pres[13];
            pres215 = cicloPCRCMCI_withTwoRH.pres[14];
            pres216 = cicloPCRCMCI_withTwoRH.pres[15];
            pres217 = cicloPCRCMCI_withTwoRH.pres[16];
            pres218 = cicloPCRCMCI_withTwoRH.pres[17];
            ...
            {
                PHX1 = cicloPCRCMCI_withTwoRH.PHX.Q_dot;
                RHX1 = cicloPCRCMCI_withTwoRH.RHX1.Q_dot;
                RHX2 = cicloPCRCMCI_withTwoRH.RHX2.Q_dot;

                recomp_frac2 = cicloPCRCMCI_withTwoRH.recomp_frac;

                LT_Q = cicloPCRCMCI_withTwoRH.LT.Q_dot;
                LT_mdotc = cicloPCRCMCI_withTwoRH.LT.m_dot_design[0];
                LT_mdoth = cicloPCRCMCI_withTwoRH.LT.m_dot_design[1];
                LT_Tcin = cicloPCRCMCI_withTwoRH.LT.T_c_in;
                LT_Thin = cicloPCRCMCI_withTwoRH.LT.T_h_in;
                LT_Pcin = cicloPCRCMCI_withTwoRH.LT.P_c_in;
                LT_Phin = cicloPCRCMCI_withTwoRH.LT.P_h_in;
                LT_Pcout = cicloPCRCMCI_withTwoRH.LT.P_c_out;
                LT_Phout = cicloPCRCMCI_withTwoRH.LT.P_h_out;
                LT_Effc = cicloPCRCMCI_withTwoRH.LT.eff;

                HT_Q = cicloPCRCMCI_withTwoRH.HT.Q_dot;
                HT_mdotc = cicloPCRCMCI_withTwoRH.HT.m_dot_design[0];
                HT_mdoth = cicloPCRCMCI_withTwoRH.HT.m_dot_design[1];
                HT_Tcin = cicloPCRCMCI_withTwoRH.HT.T_c_in;
                HT_Thin = cicloPCRCMCI_withTwoRH.HT.T_h_in;
                HT_Pcin = cicloPCRCMCI_withTwoRH.HT.P_c_in;
                HT_Phin = cicloPCRCMCI_withTwoRH.HT.P_h_in;
                HT_Pcout = cicloPCRCMCI_withTwoRH.HT.P_c_out;
                HT_Phout = cicloPCRCMCI_withTwoRH.HT.P_h_out;
                HT_Effc = cicloPCRCMCI_withTwoRH.HT.eff;

                PC1 = -cicloPCRCMCI_withTwoRH.PC1.Q_dot;
                PC2 = -cicloPCRCMCI_withTwoRH.PC2.Q_dot;
                PC3 = -cicloPCRCMCI_withTwoRH.PC3.Q_dot;
