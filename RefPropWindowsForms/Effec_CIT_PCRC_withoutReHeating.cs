...
{
    public partial class Effec_CIT_PCRC_withoutReHeating : Form
    {
        ...
        public Effec_CIT_PCRC_withoutReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
                ...
                {
                    textBox7.Text = Convert.ToString(CIT_temp_value);
                    textBox4.Text = Convert.ToString(CIT_temp_value);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_PCRC_Without_ReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_PCRC_Without_ReHeating(this, "Main_SF");
