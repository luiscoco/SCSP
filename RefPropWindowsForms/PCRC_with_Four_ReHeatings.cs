...
{
    public partial class PCRC_with_Four_ReHeatings : Form
    {
        ...
        //ReHeating3 Heat Exchanger (RHX4)
        ...
        public Double PHX1, RHX1, RHX2, RHX3, RHX4, PC1, COOLER1;
        ...
        public PCRC_with_Four_ReHeatings()
        {
            InitializeComponent();
        }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            p_rhx4_in2 = Convert.ToDouble(textBox112.Text);
            t_rht4_in2 = Convert.ToDouble(textBox10.Text);
            dp2_lt1 = Convert.ToDouble(textBox5.Text);
            dp2_ht1 = Convert.ToDouble(textBox12.Text);
            dp2_pc1 = Convert.ToDouble(textBox11.Text);
            dp2_phx1 = Convert.ToDouble(textBox111.Text);
            ...
            dp2_rhx41 = Convert.ToDouble(textBox110.Text);
            ...
            m_eta_trh42 = Convert.ToDouble(textBox109.Text);
            ...
            luis.RecompCycle_PCRC_withFourReheating(luis, ref cicloPCRC_withFourRH, 
            m_w_dot_net2, t_mc_in2, t_t_in2, t_rht1_in2, p_rhx1_in2, t_rht2_in2, 
            p_rhx2_in2, t_rht3_in2, p_rhx3_in2, t_rht4_in2, p_rhx4_in2, p_mc_in2,
            p_mc_out2, p_pc_in2, t_pc_in2, p_pc_out2, ua_lt2, ua_ht2, m_eta_mc2,
            m_eta_rc2, m_eta_pc2, m_eta_t2, m_eta_trh12, m_eta_trh22, m_eta_trh32, 
            m_eta_trh42, n_sub_hxrs2, m_recomp_frac2, tol2, eta_thermal2, -dp2_lt1,
            -dp2_lt2, -dp2_ht1, -dp2_ht2, -dp2_pc1, -dp2_pc2, -dp2_phx1, -dp2_phx2,
            -dp2_rhx11, -dp2_rhx12, -dp2_rhx21, -dp2_rhx22, -dp2_rhx31, -dp2_rhx32,
            -dp2_rhx41, -dp2_rhx42, -dp2_cooler1, -dp2_cooler2);

            massflow2 = cicloPCRC_withFourRH.m_dot_turbine;
            w_dot_net2 = cicloPCRC_withFourRH.W_dot_net;
            eta_thermal2 = cicloPCRC_withFourRH.eta_thermal;
            ...
            temp21 = cicloPCRC_withFourRH.temp[0];
            temp22 = cicloPCRC_withFourRH.temp[1];
            temp23 = cicloPCRC_withFourRH.temp[2];
            temp24 = cicloPCRC_withFourRH.temp[3];
            temp25 = cicloPCRC_withFourRH.temp[4];
            temp26 = cicloPCRC_withFourRH.temp[5];
            temp27 = cicloPCRC_withFourRH.temp[6];
            temp28 = cicloPCRC_withFourRH.temp[7];
            temp29 = cicloPCRC_withFourRH.temp[8];
            temp210 = cicloPCRC_withFourRH.temp[9];
            temp211 = cicloPCRC_withFourRH.temp[10];
            temp212 = cicloPCRC_withFourRH.temp[11];
            temp213 = cicloPCRC_withFourRH.temp[12];
            temp214 = cicloPCRC_withFourRH.temp[13];
            temp215 = cicloPCRC_withFourRH.temp[14];
            temp216 = cicloPCRC_withFourRH.temp[15];
            temp217 = cicloPCRC_withFourRH.temp[16];
            temp218 = cicloPCRC_withFourRH.temp[17];
            temp219 = cicloPCRC_withFourRH.temp[18];
            temp220 = cicloPCRC_withFourRH.temp[19];

            pres21 = cicloPCRC_withFourRH.pres[0];
            pres22 = cicloPCRC_withFourRH.pres[1];
            pres23 = cicloPCRC_withFourRH.pres[2];
            pres24 = cicloPCRC_withFourRH.pres[3];
            pres25 = cicloPCRC_withFourRH.pres[4];
            pres26 = cicloPCRC_withFourRH.pres[5];
            pres27 = cicloPCRC_withFourRH.pres[6];
            pres28 = cicloPCRC_withFourRH.pres[7];
            pres29 = cicloPCRC_withFourRH.pres[8];
            pres210 = cicloPCRC_withFourRH.pres[9];
            pres211 = cicloPCRC_withFourRH.pres[10];
            pres212 = cicloPCRC_withFourRH.pres[11];
            pres213 = cicloPCRC_withFourRH.pres[12];
            pres214 = cicloPCRC_withFourRH.pres[13];
            pres215 = cicloPCRC_withFourRH.pres[14];
            pres216 = cicloPCRC_withFourRH.pres[15];
            pres217 = cicloPCRC_withFourRH.pres[16];
            pres218 = cicloPCRC_withFourRH.pres[17];
            pres219 = cicloPCRC_withFourRH.pres[18];
            pres220 = cicloPCRC_withFourRH.pres[19];
            ...
            String point13_state, point14_state, point15_state, point16_state, point17_state, point18_state, point19_state, point20_state;
            ...
            {
                PHX1 = cicloPCRC_withFourRH.PHX.Q_dot;
                RHX1 = cicloPCRC_withFourRH.RHX1.Q_dot;
                RHX2 = cicloPCRC_withFourRH.RHX2.Q_dot;
                recomp_frac2 = cicloPCRC_withFourRH.recomp_frac;

                LT_Q = cicloPCRC_withFourRH.LT.Q_dot;
                LT_mdotc = cicloPCRC_withFourRH.LT.m_dot_design[0];
                LT_mdoth = cicloPCRC_withFourRH.LT.m_dot_design[1];
                LT_Tcin = cicloPCRC_withFourRH.LT.T_c_in;
                LT_Thin = cicloPCRC_withFourRH.LT.T_h_in;
                LT_Pcin = cicloPCRC_withFourRH.LT.P_c_in;
                LT_Phin = cicloPCRC_withFourRH.LT.P_h_in;
                LT_Pcout = cicloPCRC_withFourRH.LT.P_c_out;
                LT_Phout = cicloPCRC_withFourRH.LT.P_h_out;
                LT_Effc = cicloPCRC_withFourRH.LT.eff;

                HT_Q = cicloPCRC_withFourRH.HT.Q_dot;
                HT_mdotc = cicloPCRC_withFourRH.HT.m_dot_design[0];
                HT_mdoth = cicloPCRC_withFourRH.HT.m_dot_design[1];
                HT_Tcin = cicloPCRC_withFourRH.HT.T_c_in;
                HT_Thin = cicloPCRC_withFourRH.HT.T_h_in;
                HT_Pcin = cicloPCRC_withFourRH.HT.P_c_in;
                HT_Phin = cicloPCRC_withFourRH.HT.P_h_in;
                HT_Pcout = cicloPCRC_withFourRH.HT.P_c_out;
                HT_Phout = cicloPCRC_withFourRH.HT.P_h_out;
                HT_Effc = cicloPCRC_withFourRH.HT.eff;

                PC1 = -cicloPCRC_withFourRH.PC.Q_dot;
                COOLER1 = -cicloPCRC_withFourRH.COOLER.Q_dot;
