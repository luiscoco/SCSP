...
namespace RefPropWindowsForms
{
    public partial class Two_PC_RCMCI_withoutReheating : Form
    {
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            luis.RecompCycle_Two_PC_RCMCI_without_Reheating(luis, ref cicloTwo_PC_RCMCI_withoutReheating,
            w_dot_net, t_pc1_in, t_pc2_in, t_mc4_in, t_mc3_in, t_t_in,
            p_pc1_in, p_pc1_out, p_pc2_in, p_pc2_out, p_mc4_in, p_mc4_out,
            p_mc3_in, p_mc3_out, ua_lt, ua_ht, m_eta_mc4, m_eta_pc1, m_eta_pc2,
            m_eta_rc, m_eta_mc3, m_eta_t, n_sub_hxrs, m_recomp_frac, tol,
            eta_thermal, -dp_lt1, -dp_lt2, -dp_ht1, -dp_ht2, -dp_pc1, -dp_pc2, -dp_pc3,
            -dp_pc4, -dp_phx);

            massflow2 = cicloTwo_PC_RCMCI_withoutReheating.m_dot_turbine;
            w_dot_net2 = cicloTwo_PC_RCMCI_withoutReheating.W_dot_net;
            eta_thermal2 = cicloTwo_PC_RCMCI_withoutReheating.eta_thermal;
            ...
            temp21 = cicloTwo_PC_RCMCI_withoutReheating.temp[0];
            temp22 = cicloTwo_PC_RCMCI_withoutReheating.temp[1];
            temp23 = cicloTwo_PC_RCMCI_withoutReheating.temp[2];
            temp24 = cicloTwo_PC_RCMCI_withoutReheating.temp[3];
            temp25 = cicloTwo_PC_RCMCI_withoutReheating.temp[4];
            temp26 = cicloTwo_PC_RCMCI_withoutReheating.temp[5];
            temp27 = cicloTwo_PC_RCMCI_withoutReheating.temp[6];
            temp28 = cicloTwo_PC_RCMCI_withoutReheating.temp[7];
            temp29 = cicloTwo_PC_RCMCI_withoutReheating.temp[8];
            temp210 = cicloTwo_PC_RCMCI_withoutReheating.temp[9];
            temp211 = cicloTwo_PC_RCMCI_withoutReheating.temp[10];
            temp212 = cicloTwo_PC_RCMCI_withoutReheating.temp[11];
            temp213 = cicloTwo_PC_RCMCI_withoutReheating.temp[12];
            temp214 = cicloTwo_PC_RCMCI_withoutReheating.temp[13];
            temp215 = cicloTwo_PC_RCMCI_withoutReheating.temp[14];
            temp216 = cicloTwo_PC_RCMCI_withoutReheating.temp[15];

            pres21 = cicloTwo_PC_RCMCI_withoutReheating.pres[0];
            pres22 = cicloTwo_PC_RCMCI_withoutReheating.pres[1];
            pres23 = cicloTwo_PC_RCMCI_withoutReheating.pres[2];
            pres24 = cicloTwo_PC_RCMCI_withoutReheating.pres[3];
            pres25 = cicloTwo_PC_RCMCI_withoutReheating.pres[4];
            pres26 = cicloTwo_PC_RCMCI_withoutReheating.pres[5];
            pres27 = cicloTwo_PC_RCMCI_withoutReheating.pres[6];
            pres28 = cicloTwo_PC_RCMCI_withoutReheating.pres[7];
            pres29 = cicloTwo_PC_RCMCI_withoutReheating.pres[8];
            pres210 = cicloTwo_PC_RCMCI_withoutReheating.pres[9];
            pres211 = cicloTwo_PC_RCMCI_withoutReheating.pres[10];
            pres212 = cicloTwo_PC_RCMCI_withoutReheating.pres[11];
            pres213 = cicloTwo_PC_RCMCI_withoutReheating.pres[12];
            pres214 = cicloTwo_PC_RCMCI_withoutReheating.pres[13];
            pres215 = cicloTwo_PC_RCMCI_withoutReheating.pres[14];
            pres216 = cicloTwo_PC_RCMCI_withoutReheating.pres[15];
            ...
            {
                PHX1 = cicloTwo_PC_RCMCI_withoutReheating.PHX.Q_dot;
                recomp_frac2 = cicloTwo_PC_RCMCI_withoutReheating.recomp_frac;
                LT_Q = cicloTwo_PC_RCMCI_withoutReheating.LT.Q_dot;
                LT_mdotc = cicloTwo_PC_RCMCI_withoutReheating.LT.m_dot_design[0];
                LT_mdoth = cicloTwo_PC_RCMCI_withoutReheating.LT.m_dot_design[1];
                LT_Tcin = cicloTwo_PC_RCMCI_withoutReheating.LT.T_c_in;
                LT_Thin = cicloTwo_PC_RCMCI_withoutReheating.LT.T_h_in;
                LT_Pcin = cicloTwo_PC_RCMCI_withoutReheating.LT.P_c_in;
                LT_Phin = cicloTwo_PC_RCMCI_withoutReheating.LT.P_h_in;
                LT_Pcout = cicloTwo_PC_RCMCI_withoutReheating.LT.P_c_out;
                LT_Phout = cicloTwo_PC_RCMCI_withoutReheating.LT.P_h_out;
                LT_Effc = cicloTwo_PC_RCMCI_withoutReheating.LT.eff;

                HT_Q = cicloTwo_PC_RCMCI_withoutReheating.HT.Q_dot;
                HT_mdotc = cicloTwo_PC_RCMCI_withoutReheating.HT.m_dot_design[0];
                HT_mdoth = cicloTwo_PC_RCMCI_withoutReheating.HT.m_dot_design[1];
                HT_Tcin = cicloTwo_PC_RCMCI_withoutReheating.HT.T_c_in;
                HT_Thin = cicloTwo_PC_RCMCI_withoutReheating.HT.T_h_in;
                HT_Pcin = cicloTwo_PC_RCMCI_withoutReheating.HT.P_c_in;
                HT_Phin = cicloTwo_PC_RCMCI_withoutReheating.HT.P_h_in;
                HT_Pcout = cicloTwo_PC_RCMCI_withoutReheating.HT.P_c_out;
                HT_Phout = cicloTwo_PC_RCMCI_withoutReheating.HT.P_h_out;
                HT_Effc = cicloTwo_PC_RCMCI_withoutReheating.HT.eff;

                PC1 = -cicloTwo_PC_RCMCI_withoutReheating.PC1.Q_dot;
                PC2 = -cicloTwo_PC_RCMCI_withoutReheating.PC2.Q_dot;
                PC3 = -cicloTwo_PC_RCMCI_withoutReheating.PC3.Q_dot;
                PC4 = -cicloTwo_PC_RCMCI_withoutReheating.PC4.Q_dot;
        ...
        //Optmization Analysis
        private void button37_Click(object sender, EventArgs e)
        {
            Two_PC_RCMCI_withoutReheating_Optimization_Analysis_Results Two_PC_RCMCI_withoutReheating_Optimization_Analysis_Results_dialog = new Two_PC_RCMCI_withoutReheating_Optimization_Analysis_Results(this);
            Two_PC_RCMCI_withoutReheating_Optimization_Analysis_Results_dialog.Show();
        }
        ...
        {
            Precooler_dialog1 = new PreeCooler();
            Precooler_dialog1.textBox2.Text = Convert.ToString(-PC2);
            Precooler_dialog1.textBox4.Text = Convert.ToString(massflow2);
            Precooler_dialog1.textBox6.Text = Convert.ToString(temp212);
            Precooler_dialog1.textBox12.Text = Convert.ToString(pres212);
        ...
        {
            Precooler_dialog1 = new PreeCooler();
            Precooler_dialog1.textBox2.Text = Convert.ToString(-PC4);
            Precooler_dialog1.textBox4.Text = Convert.ToString(massflow2 * (1 - recomp_frac2));
            Precooler_dialog1.textBox6.Text = Convert.ToString(temp214);
            Precooler_dialog1.textBox12.Text = Convert.ToString(pres214);
        ...
        {
            Precooler_dialog1 = new PreeCooler();
            Precooler_dialog1.textBox2.Text = Convert.ToString(-PC3);
            Precooler_dialog1.textBox4.Text = Convert.ToString(massflow2 * (1 - recomp_frac2));
            Precooler_dialog1.textBox6.Text = Convert.ToString(temp22);
            Precooler_dialog1.textBox12.Text = Convert.ToString(pres22);
            Precooler_dialog1.textBox8.Text = Convert.ToString(pres215);
            Precooler_dialog1.PreeCooler1(luis);
            Precooler_dialog1.Calculate_Cooler();
            Precooler_dialog1.Show();
        }
