...
{
    public partial class SB_with_Two_Recuperators_with_LTR_PreHeating_without_ReHeating : Form
    {
        ...
        public Double PHX_Q2, AHX_Q2, PC_Q2;
        public Double LT_Effc, HT_Effc;
        public Double N_design2 = 0;

        public SB_with_Two_Recuperators_with_LTR_PreHeating_without_ReHeating(MainWindow punteroMainWindow1)
        {
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            Double T_ahx_out = Convert.ToDouble(textBox6.Text);
            Double p_mc_in2 = Convert.ToDouble(textBox3.Text);
            Double ahx_frac = Convert.ToDouble(textBox13.Text);
            ...
            Double dp2_ahx1 = Convert.ToDouble(textBox15.Text);
            ...
            core.RecompCycle_LTR_PreHeating_withoutRH cicloRC = new core.RecompCycle_LTR_PreHeating_withoutRH();

            luis.SimpleBrayton_with_Two_Recuperators_LTR_PreHeating_without_ReHeating(luis,
            ref cicloRC, w_dot_net2, t_mc_in2, t_t_in2, p_mc_in2, p_mc_out2, -dp2_lt1, -dp2_ht1,
            -dp2_pc2, -dp2_phx1, -dp2_ahx1, -dp2_lt2, -dp2_ht2, ua_lt2, ua_ht2, ahx_frac, 
            T_ahx_out, eta_mc2, eta_t2, n_sub_hxrs2, tol2);

            massflow2 = cicloRC.m_dot_turbine;
            w_dot_net2 = cicloRC.W_dot_net;
            eta_thermal2 = cicloRC.eta_thermal;
            ahx_frac = cicloRC.ahx_frac;
            ...
            textBox32.Text = Convert.ToString(pres210);
            textBox84.Text = Convert.ToString(pres211);
            textBox82.Text = Convert.ToString(pres212);
            ...
            textBox34.Text = Convert.ToString(temp29);
            textBox18.Text = Convert.ToString(temp210);
            textBox83.Text = Convert.ToString(temp211);
            textBox40.Text = Convert.ToString(temp212);
