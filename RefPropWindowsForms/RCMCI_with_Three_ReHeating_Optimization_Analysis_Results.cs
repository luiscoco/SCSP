...
{
    public partial class RCMCI_with_Three_ReHeating_Optimization_Analysis_Results : Form
    {
        public RCMCI_with_Three_Reheatings puntero_aplicacion;

        public RCMCI_with_Three_ReHeating_Optimization_Analysis_Results(RCMCI_with_Three_Reheatings puntero1)
        {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                core.RCMCIwithThreeReheating cicloRCMCI_withThreeRH = new core.RCMCIwithThreeReheating();
                ...
                {
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, initial_CIP_value + 200, initial_CIP_value + 3000, initial_CIP_value + 2000, initial_CIP_value + 1000 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out2 - 4000, puntero_aplicacion.p_mc2_out2 - 3000, puntero_aplicacion.p_mc2_out2 - 1000, puntero_aplicacion.p_mc2_out2 - 2000, puntero_aplicacion.p_mc2_out2 - 3000 });

                    solver.SetInitialStepSize(new[] { 0.01, 1000, 1000, 1000, 1000, 1000 });

                    var initialValue = new[] { 0.1, initial_CIP_value, initial_CIP_value + 500, 15000, 13000, 11000 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_RCMCI_withThreeReheating(puntero_aplicacion.luis, 
                        ref cicloRCMCI_withThreeRH, puntero_aplicacion.w_dot_net2,
                        puntero_aplicacion.t_mc2_in2, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2,
                        variables[3], puntero_aplicacion.t_rht2_in2, variables[4],
                        puntero_aplicacion.t_rht3_in2, variables[5], variables[2],
                        ...
                        puntero_aplicacion.eta_rc2, puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta_t2, puntero_aplicacion.eta_trh12, 
                        puntero_aplicacion.eta_trh22, puntero_aplicacion.eta_trh32, puntero_aplicacion.n_sub_hxrs2,
                        ...
                        puntero_aplicacion.massflow2 = cicloRCMCI_withThreeRH.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloRCMCI_withThreeRH.W_dot_net;

                        puntero_aplicacion.eta_thermal2 = cicloRCMCI_withThreeRH.eta_thermal;
                        ...
                        puntero_aplicacion.temp21 = cicloRCMCI_withThreeRH.temp[0];
                        puntero_aplicacion.temp22 = cicloRCMCI_withThreeRH.temp[1];
                        puntero_aplicacion.temp23 = cicloRCMCI_withThreeRH.temp[2];
                        puntero_aplicacion.temp24 = cicloRCMCI_withThreeRH.temp[3];
                        puntero_aplicacion.temp25 = cicloRCMCI_withThreeRH.temp[4];
                        puntero_aplicacion.temp26 = cicloRCMCI_withThreeRH.temp[5];
                        puntero_aplicacion.temp27 = cicloRCMCI_withThreeRH.temp[6];
                        puntero_aplicacion.temp28 = cicloRCMCI_withThreeRH.temp[7];
                        puntero_aplicacion.temp29 = cicloRCMCI_withThreeRH.temp[8];
                        puntero_aplicacion.temp210 = cicloRCMCI_withThreeRH.temp[9];
                        puntero_aplicacion.temp211 = cicloRCMCI_withThreeRH.temp[10];
                        puntero_aplicacion.temp212 = cicloRCMCI_withThreeRH.temp[11];
                        puntero_aplicacion.temp213 = cicloRCMCI_withThreeRH.temp[12];
                        puntero_aplicacion.temp214 = cicloRCMCI_withThreeRH.temp[13];
                        puntero_aplicacion.temp215 = cicloRCMCI_withThreeRH.temp[14];
                        puntero_aplicacion.temp216 = cicloRCMCI_withThreeRH.temp[15];
                        puntero_aplicacion.temp217 = cicloRCMCI_withThreeRH.temp[16];
                        puntero_aplicacion.temp218 = cicloRCMCI_withThreeRH.temp[17];

                        puntero_aplicacion.pres21 = cicloRCMCI_withThreeRH.pres[0];
                        puntero_aplicacion.pres22 = cicloRCMCI_withThreeRH.pres[1];
                        puntero_aplicacion.pres23 = cicloRCMCI_withThreeRH.pres[2];
                        puntero_aplicacion.pres24 = cicloRCMCI_withThreeRH.pres[3];
                        puntero_aplicacion.pres25 = cicloRCMCI_withThreeRH.pres[4];
                        puntero_aplicacion.pres26 = cicloRCMCI_withThreeRH.pres[5];
                        puntero_aplicacion.pres27 = cicloRCMCI_withThreeRH.pres[6];
                        puntero_aplicacion.pres28 = cicloRCMCI_withThreeRH.pres[7];
                        puntero_aplicacion.pres29 = cicloRCMCI_withThreeRH.pres[8];
                        puntero_aplicacion.pres210 = cicloRCMCI_withThreeRH.pres[9];
                        puntero_aplicacion.pres211 = cicloRCMCI_withThreeRH.pres[10];
                        puntero_aplicacion.pres212 = cicloRCMCI_withThreeRH.pres[11];
                        puntero_aplicacion.pres213 = cicloRCMCI_withThreeRH.pres[12];
                        puntero_aplicacion.pres214 = cicloRCMCI_withThreeRH.pres[13];
                        puntero_aplicacion.pres215 = cicloRCMCI_withThreeRH.pres[14];
                        puntero_aplicacion.pres216 = cicloRCMCI_withThreeRH.pres[15];
                        puntero_aplicacion.pres217 = cicloRCMCI_withThreeRH.pres[16];
                        puntero_aplicacion.pres218 = cicloRCMCI_withThreeRH.pres[17];

                        puntero_aplicacion.PHX1 = cicloRCMCI_withThreeRH.PHX.Q_dot;
                        puntero_aplicacion.RHX1 = cicloRCMCI_withThreeRH.RHX1.Q_dot;
                        puntero_aplicacion.RHX2 = cicloRCMCI_withThreeRH.RHX2.Q_dot;
                        puntero_aplicacion.RHX3 = cicloRCMCI_withThreeRH.RHX3.Q_dot;

                        puntero_aplicacion.LT_Q = cicloRCMCI_withThreeRH.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloRCMCI_withThreeRH.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloRCMCI_withThreeRH.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloRCMCI_withThreeRH.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloRCMCI_withThreeRH.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloRCMCI_withThreeRH.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloRCMCI_withThreeRH.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloRCMCI_withThreeRH.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloRCMCI_withThreeRH.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloRCMCI_withThreeRH.LT.eff;

                        puntero_aplicacion.HT_Q = cicloRCMCI_withThreeRH.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloRCMCI_withThreeRH.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloRCMCI_withThreeRH.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloRCMCI_withThreeRH.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloRCMCI_withThreeRH.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloRCMCI_withThreeRH.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloRCMCI_withThreeRH.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloRCMCI_withThreeRH.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloRCMCI_withThreeRH.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloRCMCI_withThreeRH.HT.eff;

                        puntero_aplicacion.PC11 = -cicloRCMCI_withThreeRH.PC.Q_dot;
                        puntero_aplicacion.PC21 = -cicloRCMCI_withThreeRH.COOLER.Q_dot;
                        ...
                        double LTR_min_DT_1 = cicloRCMCI_withThreeRH.temp[7] - cicloRCMCI_withThreeRH.temp[2];
                        double LTR_min_DT_2 = cicloRCMCI_withThreeRH.temp[8] - cicloRCMCI_withThreeRH.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloRCMCI_withThreeRH.temp[7] - cicloRCMCI_withThreeRH.temp[3];
                        double HTR_min_DT_2 = cicloRCMCI_withThreeRH.temp[6] - cicloRCMCI_withThreeRH.temp[4];
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = cicloRCMCI_withThreeRH.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 13] = cicloRCMCI_withThreeRH.HT.eff.ToString();
                        //HTR Pinch(ºC)
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, initial_CIP_value + 200, initial_CIP_value + 3000, initial_CIP_value + 2000, initial_CIP_value + 1000, 0.2 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out2 - 4000, puntero_aplicacion.p_mc2_out2 - 3000, puntero_aplicacion.p_mc2_out2 - 1000, puntero_aplicacion.p_mc2_out2 - 2000, puntero_aplicacion.p_mc2_out2 - 3000, 0.8 });

                    solver.SetInitialStepSize(new[] { 0.01, 1000, 1000, 1000, 1000, 1000, 0.05 });

                    var initialValue = new[] { 0.1, initial_CIP_value, initial_CIP_value + 500, 15000, 13000, 11000, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_RCMCI_withThreeReheating_for_Optimization(puntero_aplicacion.luis,
                        ref cicloRCMCI_withThreeRH, puntero_aplicacion.w_dot_net2,
                        puntero_aplicacion.t_mc2_in2, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2,
                        variables[3], puntero_aplicacion.t_rht2_in2, variables[4],
                        puntero_aplicacion.t_rht3_in2, variables[5], variables[2],
                        puntero_aplicacion.p_mc2_out2, variables[1], puntero_aplicacion.t_mc1_in2,
                        variables[2], variables[6], UA_Total, puntero_aplicacion.eta2_mc2,
                        puntero_aplicacion.eta_rc2, puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta_t2, puntero_aplicacion.eta_trh12,
                        puntero_aplicacion.eta_trh22, puntero_aplicacion.eta_trh32, puntero_aplicacion.n_sub_hxrs2,
                        variables[0], puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2,
                        -puntero_aplicacion.dp2_lt1, -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht1,
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "SolarPaces2019_Paper_Results_RCMCI_with_Three_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
            {
                ...
                if (checkBox2.Checked == false)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 6, 0.01, 10000))
                    {
                        solver.SetLowerBounds(new[] { 0.1, initial_mc1_in_value, initial_mc1_in_value + 200, puntero_aplicacion.MixtureCriticalPressure + 3000, puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000 });
                        solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out2 - 4000, puntero_aplicacion.p_mc2_out2 - 3000, puntero_aplicacion.p_mc2_out2 - 1000, puntero_aplicacion.p_mc2_out2 - 2000, puntero_aplicacion.p_mc2_out2 - 3000 });

                        solver.SetInitialStepSize(new[] { 0.01, 1000, 1000, 1000, 1000, 1000 });

                        var initialValue = new[] { 0.1, initial_mc1_in_value, initial_mc1_in_value + 500, 15000, 13000, 11000 };
                        ...
                        Func<double[], double> funcion = delegate (double[] variables)
                        {
                            ...
                            HT_Eff_list.Add(cicloRCMCI_withThreeRH.HT.eff);
                            LT_Eff_list.Add(cicloRCMCI_withThreeRH.LT.eff);
                ...
                else if (checkBox2.Checked == true)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 7, 0.01, 10000))
                    {
                        solver.SetLowerBounds(new[] { 0.1, initial_mc1_in_value, initial_mc1_in_value + 200, puntero_aplicacion.MixtureCriticalPressure + 3000, puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000, 0.2 });
                        solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out2 - 4000, puntero_aplicacion.p_mc2_out2 - 3000, puntero_aplicacion.p_mc2_out2 - 1000, puntero_aplicacion.p_mc2_out2 - 2000, puntero_aplicacion.p_mc2_out2 - 3000, 0.8 });

                        solver.SetInitialStepSize(new[] { 0.01, 1000, 1000, 1000, 1000, 1000, 0.05 });

                        var initialValue = new[] { 0.1, initial_mc1_in_value, initial_mc1_in_value + 500, 15000, 13000, 11000, 0.5 };
                        ...
                        Func<double[], double> funcion = delegate (double[] variables)
                        {
                            ...
                            -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht1,
                            -puntero_aplicacion.dp2_ht2, -puntero_aplicacion.dp11_pc1, -puntero_aplicacion.dp12_pc1,
                            -puntero_aplicacion.dp2_phx1, -puntero_aplicacion.dp2_phx2,
                            -puntero_aplicacion.dp2_rhx11, -puntero_aplicacion.dp2_rhx12, -puntero_aplicacion.dp2_rhx21,
                            -puntero_aplicacion.dp2_rhx22, -puntero_aplicacion.dp2_rhx31, -puntero_aplicacion.dp2_rhx32,
                            ...
                            t15_list.Add(puntero_aplicacion.temp215);
                            t16_list.Add(puntero_aplicacion.temp216);
                            t17_list.Add(puntero_aplicacion.temp216);
                            t18_list.Add(puntero_aplicacion.temp216);
                            ...
                            p15_list.Add(puntero_aplicacion.pres215);
                            p16_list.Add(puntero_aplicacion.pres216);
                            p17_list.Add(puntero_aplicacion.pres216);
                            p18_list.Add(puntero_aplicacion.pres216);
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "SolarPaces2019_Paper_CIT_Optimization_RCMCI_with_Three_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void RCMCI_with_Three_ReHeating_Optimization_Analysis_Results_Load(object sender, EventArgs e)
        {
