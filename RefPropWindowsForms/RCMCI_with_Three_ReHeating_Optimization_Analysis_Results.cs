...
namespace RefPropWindowsForms
{
    public partial class RCMCI_with_Three_ReHeating_Optimization_Analysis_Results : Form
    {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "RCMCI_with_Three_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "CIT_Optimization_RCMCI_with_Three_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
