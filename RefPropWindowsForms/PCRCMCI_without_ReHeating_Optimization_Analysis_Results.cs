                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 4, 0.01, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                ...
                                puntero_aplicacion.luis.RecompCycle_PCRCMCI_without_Reheating(puntero_aplicacion.luis, ref cicloPCRCMCI_withoutRH,
                                puntero_aplicacion.w_dot_net, i, i, i,
                                puntero_aplicacion.t_t_in, variables[1], variables[2], variables[3],
                                puntero_aplicacion.p_mc2_out, variables[2], variables[3],
                                puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht, puntero_aplicacion.m_eta_mc2, 
                                puntero_aplicacion.m_eta_pc, puntero_aplicacion.m_eta_rc, puntero_aplicacion.m_eta_mc1, 
                                puntero_aplicacion.m_eta_t, puntero_aplicacion.n_sub_hxrs, variables[0], puntero_aplicacion.tol,
                                puntero_aplicacion.eta_thermal, -puntero_aplicacion.dp_lt1, -puntero_aplicacion.dp_lt2, 
                                -puntero_aplicacion.dp_ht1, -puntero_aplicacion.dp_ht2,
                                -puntero_aplicacion.dp_pc1, -puntero_aplicacion.dp_pc2, -puntero_aplicacion.dp_pc3, 
                                -puntero_aplicacion.dp_phx);
                                ...
                                PHX_Q2_list.Add(cicloPCRCMCI_withoutRH.PHX.Q_dot);

                                HT_Eff_list.Add(cicloPCRCMCI_withoutRH.HT.eff);
                                LT_Eff_list.Add(cicloPCRCMCI_withoutRH.LT.eff);
