...
{
    public partial class Two_PC_RCMCI_with_Two_Reheating_Optimization_Analysis_Results : Form
    {
        Two_PC_RCMCI_with_Two_Reheating puntero_aplicacion;

        public Two_PC_RCMCI_with_Two_Reheating_Optimization_Analysis_Results(Two_PC_RCMCI_with_Two_Reheating puntero1)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                core.Two_PC_RCMCI_with_Two_Reheating cicloTwo_PC_RCMCI_with_Two_Reheating = new core.Two_PC_RCMCI_with_Two_Reheating();
                ...
                using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                {
                    ...
                    initial_CIP_value + 1000, initial_CIP_value + 1500, initial_CIP_value + 3500, initial_CIP_value + 3000 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out,
                    puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out});

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 1000.0,1000.0 });

                    var initialValue = new[] { 0.2, initial_CIP_value, initial_CIP_value + 1500.0, initial_CIP_value + 3000.0, initial_CIP_value + 4000.0, 17000.0, 14000.0 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_with_Two_Reheating(puntero_aplicacion.luis, 
                        ref cicloTwo_PC_RCMCI_with_Two_Reheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in,
                        puntero_aplicacion.t_pc2_in, puntero_aplicacion.t_mc4_in, puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_t_in,
                        puntero_aplicacion.t_trh1_in, variables[5], puntero_aplicacion.t_trh2_in, variables[6], 
                        variables[1], variables[2], variables[2], variables[3], variables[3], variables[4], variables[4],
                        puntero_aplicacion.p_mc3_out, puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht, puntero_aplicacion.m_eta_mc4,
                        ...
                        puntero_aplicacion.m_eta_trh2, puntero_aplicacion.n_sub_hxrs, variables[0], puntero_aplicacion.tol,
                        puntero_aplicacion.eta_thermal, -puntero_aplicacion.dp_lt1, -puntero_aplicacion.dp_lt2, 
                        -puntero_aplicacion.dp_ht1, -puntero_aplicacion.dp_ht2, -puntero_aplicacion.dp_pc1, -puntero_aplicacion.dp_pc2,
                        ...
                        puntero_aplicacion.massflow2 = cicloTwo_PC_RCMCI_with_Two_Reheating.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloTwo_PC_RCMCI_with_Two_Reheating.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloTwo_PC_RCMCI_with_Two_Reheating.eta_thermal;
                        ...
                        puntero_aplicacion.temp21 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[0];
                        puntero_aplicacion.temp22 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[1];
                        puntero_aplicacion.temp23 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[2];
                        puntero_aplicacion.temp24 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[3];
                        puntero_aplicacion.temp25 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[4];
                        puntero_aplicacion.temp26 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[5];
                        puntero_aplicacion.temp27 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[6];
                        puntero_aplicacion.temp28 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[7];
                        puntero_aplicacion.temp29 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[8];
                        puntero_aplicacion.temp210 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[9];
                        puntero_aplicacion.temp211 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[10];
                        puntero_aplicacion.temp212 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[11];
                        puntero_aplicacion.temp213 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[12];
                        puntero_aplicacion.temp214 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[13];
                        puntero_aplicacion.temp215 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[14];
                        puntero_aplicacion.temp216 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[15];
                        puntero_aplicacion.temp217 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[16];
                        puntero_aplicacion.temp218 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[17];
                        puntero_aplicacion.temp219 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[18];
                        puntero_aplicacion.temp220 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[19];

                        puntero_aplicacion.pres21 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[0];
                        puntero_aplicacion.pres22 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[1];
                        puntero_aplicacion.pres23 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[2];
                        puntero_aplicacion.pres24 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[3];
                        puntero_aplicacion.pres25 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[4];
                        puntero_aplicacion.pres26 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[5];
                        puntero_aplicacion.pres27 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[6];
                        puntero_aplicacion.pres28 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[7];
                        puntero_aplicacion.pres29 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[8];
                        puntero_aplicacion.pres210 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[9];
                        puntero_aplicacion.pres211 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[10];
                        puntero_aplicacion.pres212 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[11];
                        puntero_aplicacion.pres213 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[12];
                        puntero_aplicacion.pres214 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[13];
                        puntero_aplicacion.pres215 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[14];
                        puntero_aplicacion.pres216 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[15];
                        puntero_aplicacion.pres217 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[16];
                        puntero_aplicacion.pres218 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[17];
                        puntero_aplicacion.pres219 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[18];
                        puntero_aplicacion.pres220 = cicloTwo_PC_RCMCI_with_Two_Reheating.pres[19];

                        puntero_aplicacion.PHX = cicloTwo_PC_RCMCI_with_Two_Reheating.PHX.Q_dot;
                        puntero_aplicacion.RHX1 = cicloTwo_PC_RCMCI_with_Two_Reheating.RHX1.Q_dot;
                        puntero_aplicacion.RHX2 = cicloTwo_PC_RCMCI_with_Two_Reheating.RHX2.Q_dot;

                        puntero_aplicacion.LT_Q = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.eff;

                        puntero_aplicacion.HT_Q = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.eff;

                        puntero_aplicacion.PC1 = -cicloTwo_PC_RCMCI_with_Two_Reheating.PC1.Q_dot;
                        puntero_aplicacion.PC2 = -cicloTwo_PC_RCMCI_with_Two_Reheating.PC2.Q_dot;
                        puntero_aplicacion.PC3 = -cicloTwo_PC_RCMCI_with_Two_Reheating.PC3.Q_dot;
                        puntero_aplicacion.PC4 = -cicloTwo_PC_RCMCI_with_Two_Reheating.PC4.Q_dot;
                        ...
                        double LTR_min_DT_1 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[7] - cicloTwo_PC_RCMCI_with_Two_Reheating.temp[2];
                        double LTR_min_DT_2 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[8] - cicloTwo_PC_RCMCI_with_Two_Reheating.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[7] - cicloTwo_PC_RCMCI_with_Two_Reheating.temp[3];
                        double HTR_min_DT_2 = cicloTwo_PC_RCMCI_with_Two_Reheating.temp[6] - cicloTwo_PC_RCMCI_with_Two_Reheating.temp[4];
                        ...
                        //CIT
                        xlWorkSheet1.Cells[counter_Excel + 1, 7] = Convert.ToString(puntero_aplicacion.t_mc4_in - 273.15);
                        //LT UA(kW/K)
                        xlWorkSheet1.Cells[counter_Excel + 1, 8] = Convert.ToString(puntero_aplicacion.ua_lt);
                        //HT UA(kW/K)
                        xlWorkSheet1.Cells[counter_Excel + 1, 9] = Convert.ToString(puntero_aplicacion.ua_ht);
                        //Rec.Frac.
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = cicloTwo_PC_RCMCI_with_Two_Reheating.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 13] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 14] = cicloTwo_PC_RCMCI_with_Two_Reheating.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "Two_PC_RCMCI_with_Two_RH" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500,
                    initial_CIP_value + 1000, initial_CIP_value + 1500, initial_CIP_value + 3500, initial_CIP_value + 3000, 0.0});
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out,
                    puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, 1.0});

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 1000.0, 1000.0, 0.05});

                    var initialValue = new[] { 0.2, initial_CIP_value, initial_CIP_value + 1500.0, initial_CIP_value + 3000.0, initial_CIP_value + 4000.0, 17000.0, 14000.0, 0.5};

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_with_Two_Reheating_for_optimization(puntero_aplicacion.luis,
                        ref cicloTwo_PC_RCMCI_with_Two_Reheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in,
                        puntero_aplicacion.t_pc2_in, puntero_aplicacion.t_mc4_in, puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_t_in,
                        puntero_aplicacion.t_trh1_in, variables[5], puntero_aplicacion.t_trh2_in, variables[6],
                        variables[1], variables[2], variables[2], variables[3], variables[3], variables[4], variables[4],
                        puntero_aplicacion.p_mc3_out, variables[7], UA_Total, puntero_aplicacion.m_eta_mc4,
                        puntero_aplicacion.m_eta_pc1, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_rc,
                        puntero_aplicacion.m_eta_mc3, puntero_aplicacion.m_eta_t, puntero_aplicacion.m_eta_trh1,
                        puntero_aplicacion.m_eta_trh2, puntero_aplicacion.n_sub_hxrs, variables[0], puntero_aplicacion.tol,
                        puntero_aplicacion.eta_thermal, -puntero_aplicacion.dp_lt1, -puntero_aplicacion.dp_lt2,
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 7, 0.000001, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_with_Two_Reheating(puntero_aplicacion.luis,
                                ref cicloTwo_PC_RCMCI_with_Two_Reheating, puntero_aplicacion.w_dot_net, i, i, i, i, 
                                puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh1_in, variables[5], puntero_aplicacion.t_trh2_in, 
                                variables[6], variables[1], variables[2], variables[2], variables[3], variables[3], variables[4],
                                variables[4], puntero_aplicacion.p_mc3_out, puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht, 
                                ...
                                puntero_aplicacion.m_eta_trh1, puntero_aplicacion.m_eta_trh2, puntero_aplicacion.n_sub_hxrs, 
                                variables[0], puntero_aplicacion.tol, puntero_aplicacion.eta_thermal, -puntero_aplicacion.dp_lt1,
                                ...
                                PHX_list.Add(cicloTwo_PC_RCMCI_with_Two_Reheating.PHX.Q_dot);
                                RHX1_list.Add(cicloTwo_PC_RCMCI_with_Two_Reheating.RHX1.Q_dot);
                                RHX2_list.Add(cicloTwo_PC_RCMCI_with_Two_Reheating.RHX2.Q_dot);
                            ...
                            listBox26.Items.Add(p_rhx1_in2_list[maxIndex].ToString());
                            listBox25.Items.Add(p_rhx2_in2_list[maxIndex].ToString());
                    ...
                    puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, 1.0});
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_with_Two_Reheating_for_optimization(puntero_aplicacion.luis,
                                ref cicloTwo_PC_RCMCI_with_Two_Reheating, puntero_aplicacion.w_dot_net, i, i, i, i, puntero_aplicacion.t_t_in,
                                puntero_aplicacion.t_trh1_in, variables[5], puntero_aplicacion.t_trh2_in, variables[6],
                                variables[1], variables[2], variables[2], variables[3], variables[3], variables[4], variables[4],
                                puntero_aplicacion.p_mc3_out, variables[7], UA_Total, puntero_aplicacion.m_eta_mc4,
                                puntero_aplicacion.m_eta_pc1, puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_rc,
                            ...
                            xlWorkSheet1.Cells[counter_Excel + 1, 7] = Convert.ToString(i - 273.15);
                            //LT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 8] = ua_LT_list[maxIndex].ToString();
                            //HT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 9] = ua_HT_list[maxIndex].ToString();
                            //Rec.Frac.
                            xlWorkSheet1.Cells[counter_Excel + 1, 10] = recomp_frac2_list[maxIndex].ToString();
                            //Eff.(%)
                            xlWorkSheet1.Cells[counter_Excel + 1, 11] = (eta_thermal2_list[maxIndex] * 100).ToString();
