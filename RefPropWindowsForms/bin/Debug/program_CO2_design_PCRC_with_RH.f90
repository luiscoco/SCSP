...
!
!------------------------------------------------------------w
        subroutine carbondioxide(w_dot_net1,t_mc_in1,t_t_in1,p_mc_in1,p_mc_out1, &
        p_rhx_in1,t_rht_in1,p_pc_in1,t_pc_in1,p_pc_out1,ua_lt1,ua_ht1, &
        eta_mc1,eta_rc1,eta_pc1,eta_t1,eta_trh1, &
      ...
      integer :: i
      real(dp) , INTENT(INOUT):: w_dot_net1,t_mc_in1,t_t_in1,ua_lt1,p_pc_in1,t_pc_in1,p_pc_out1
      real(dp) , INTENT(INOUT):: ua_ht1,eta_mc1,eta_pc1,eta_rc1,eta_t1,eta_trh1,eta_thermal1
      ...
      real(dp) , INTENT(INOUT):: dp_lt1,dp_lt2,dp_ht1,dp_ht2,dp_pc1,dp_pc2,dp_phx1,dp_phx2,dp_rhx1,dp_rhx2,dp_cooler1,dp_cooler2
...
! Define and optimize a design point.
      call design(                         &
           ...
           DP_PC = [-dp_pc1,-dp_pc1],     &  ! pressure drops in precooler (kPa if positive values)
           ...
           eta_pc = eta_pc1,               &  ! design-point efficiency of the recompressor; isentropic if positive, polytropic if negative
        ...
        PC=recomp_cycle1%PC%Q_dot
        COOLER=recomp_cycle1%COOLER%Q_dot
