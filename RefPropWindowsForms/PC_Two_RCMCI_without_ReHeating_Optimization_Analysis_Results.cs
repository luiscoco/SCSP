...
{
    public partial class PC_Two_RCMCI_without_ReHeating_Optimization_Analysis_Results : Form
    {
        PC_Two_RCMCI_withoutReheating puntero_aplicacion;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 5, 0.000001, 10000))
                {
                    ...
                    {
                        puntero_aplicacion.luis.RecompCycle_PC_Two_RCMCI_withoutReheating(puntero_aplicacion.luis, 
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        if (i == Convert.ToDouble(textBox57.Text))
                        {
                            ...
                            xlWorkSheet1.Cells[4, 16] = "HTR Eff.(%)";
                            xlWorkSheet1.Cells[4, 17] = "HTR Pinch(ºC)";
                            xlWorkSheet1.Cells[4, 18] = "PTC_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 19] = "PTC_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 20] = "LF_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 21] = "LF_Pressure_Drop(bar)";
                        }
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 5, 0.000001, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                puntero_aplicacion.luis.RecompCycle_PC_Two_RCMCI_withoutReheating(puntero_aplicacion.luis,
                                ref cicloPC_Two_RCMCI_withoutReheating,
                                puntero_aplicacion.w_dot_net, i, i,
                                ...
                                PHX_Q2_list.Add(cicloPC_Two_RCMCI_withoutReheating.PHX.Q_dot);

                                HT_Eff_list.Add(cicloPC_Two_RCMCI_withoutReheating.HT.eff);
                                LT_Eff_list.Add(cicloPC_Two_RCMCI_withoutReheating.LT.eff);
                    ...
                    else if (checkBox2.Checked == true)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                        {
                            ...
                            xlWorkSheet1.Cells[counter_Excel + 1, 9] = Convert.ToString(i - 273.15);
                            //LT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 10] = ua_LT_list[maxIndex].ToString();
                            //HT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 11] = ua_HT_list[maxIndex].ToString();
                            //Rec.Frac.
                            xlWorkSheet1.Cells[counter_Excel + 1, 12] = recomp_frac2_list[maxIndex].ToString();
                            //Eff.(%)
                            xlWorkSheet1.Cells[counter_Excel + 1, 13] = (eta_thermal2_list[maxIndex] * 100).ToString();
