...
character(len=255), parameter :: mixture_file = 'C:\Dyreby-LUIS COCO\SB and RC sCO2_brayton_mode - without ReHeating\Properties\REFPROP\fluids\HMX.BNC'   ! default mixture coefficients
...
contains
      ...
      hf(1)='C:\Dyreby-LUIS COCO\SB and RC sCO2_brayton_mode - without ReHeating\Properties\REFPROP\fluids\CO2.fld'
      hf(2)='C:\Dyreby-LUIS COCO\SB and RC sCO2_brayton_mode - without ReHeating\Properties\REFPROP\fluids\C6F14.fld'   
