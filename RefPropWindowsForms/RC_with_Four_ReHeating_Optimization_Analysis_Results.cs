...
namespace RefPropWindowsForms
{
    public partial class RC_with_Four_ReHeating_Optimization_Analysis_Results : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        if (i == Convert.ToDouble(textBox57.Text))
                        {
                            ...
                            xlWorkSheet1.Cells[4, 31] = "PTC_RHX4_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 32] = "PTC_RHX4_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 33] = "LF_RHX4_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 34] = "LF_RHX4_Pressure_Drop(bar)";
                        }
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 6, 0.01, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycledesign_withFourReheating(puntero_aplicacion.luis,
                                ref cicloRC_withFourRH, puntero_aplicacion.w_dot_net2, i,
                                puntero_aplicacion.t_t_in2, variables[1], puntero_aplicacion.p_mc_out2,
                                variables[2], puntero_aplicacion.t_rht1_in2, variables[3],
                                puntero_aplicacion.t_rht2_in2, variables[4], puntero_aplicacion.t_rht3_in2,
                                variables[5], puntero_aplicacion.t_rht4_in2, -puntero_aplicacion.dp2_lt1,
                                ...
                                PHX_Q_list.Add(cicloRC_withFourRH.PHX.Q_dot);
                                RHX1_Q2_list.Add(cicloRC_withFourRH.RHX1.Q_dot);
                                RHX2_Q2_list.Add(cicloRC_withFourRH.RHX2.Q_dot);
                                RHX3_Q2_list.Add(cicloRC_withFourRH.RHX3.Q_dot);
                                RHX4_Q2_list.Add(cicloRC_withFourRH.RHX4.Q_dot);
                                ua_LT_list.Add(puntero_aplicacion.ua_lt2);
                                ua_HT_list.Add(puntero_aplicacion.ua_ht2);

                                HT_Eff_list.Add(cicloRC_withFourRH.HT.eff);
                                LT_Eff_list.Add(cicloRC_withFourRH.LT.eff);
                            ...
                            listBox24.Items.Add(p_rhx4_in2_list[maxIndex].ToString());
                            ...
                            xlWorkSheet1.Cells[counter_Excel + 1, 31] = puntero_aplicacion.PTC_ReHeating4_SF_Effective_Apperture_Area.ToString();
                            //PTC_RHX4_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 32] = puntero_aplicacion.PTC_ReHeating4_SF_Pressure_drop.ToString();
                            //LF_RHX4_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 33] = puntero_aplicacion.LF_ReHeating4_SF_Effective_Apperture_Area.ToString();
                            //LF_RHX4_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 34] = puntero_aplicacion.LF_ReHeating4_SF_Pressure_drop.ToString();
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "CIT_Optimization_RC_with_Four_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
