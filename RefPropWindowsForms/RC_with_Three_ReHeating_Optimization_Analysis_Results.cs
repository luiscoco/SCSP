...
namespace RefPropWindowsForms
{
    public partial class RC_with_Three_ReHeating_Optimization_Analysis_Results : Form
    {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 6, 0.01, 10000))
                {
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "SolarPaces2019_Paper_Results_RC_with_Three_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "SolarPaces2019_Paper_CIT_Optimization_RC_with_Three_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
