...
namespace RefPropWindowsForms
{
    public partial class PCRC_with_ReHeating_Optimization_Analysis_Results : Form
    {
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox4.Text + "SolarPaces2019_Paper_CIT_Optimization_PCRC_with_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
