    ...
    public partial class Recompression_Brayton_Power_Cycle : Form
    {
        ...
        private void button26_Click(object sender, EventArgs e)
        {
            ...
            for (double j = Convert.ToDouble(textBox73.Text); j <= Convert.ToDouble(textBox72.Text); j = j + Convert.ToDouble(textBox71.Text))
            {
                ...
                for (double i = Convert.ToDouble(textBox70.Text); i <= Convert.ToDouble(textBox69.Text); i = i + Convert.ToDouble(textBox68.Text))
                {
            ...
            xlWorkBook1.SaveAs("c:\\Users\\luisc\\Desktop\\Paper_Results_RC_with_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void button23_Click_1(object sender, EventArgs e)
        {
            ...
            for (double j = Convert.ToDouble(textBox73.Text); j <= Convert.ToDouble(textBox72.Text); j = j + Convert.ToDouble(textBox71.Text))
            {
                ...
                for (double i = Convert.ToDouble(textBox83.Text); i <= Convert.ToDouble(textBox82.Text); i = i + Convert.ToDouble(textBox81.Text))
                {
                    ...
                    RC_with_Two_ReHeating_Sensing_Analysis_Results_window.listBox1.Items.Add(textBox7.Text);
        ...
        private void button31_Click(object sender, EventArgs e)
        {
            ...
            for (double j = Convert.ToDouble(textBox73.Text); j <= Convert.ToDouble(textBox72.Text); j = j + Convert.ToDouble(textBox71.Text))
            {
                ...
                for (double i = Convert.ToDouble(textBox86.Text); i <= Convert.ToDouble(textBox85.Text); i = i + Convert.ToDouble(textBox84.Text))
                {
                    ...
                    RC_with_Two_ReHeating_Sensing_Analysis_Results_window.listBox1.Items.Add(textBox6.Text);
        ...
        //NLOpt (Optimization algorithms: Nelder-Mead, Cobyla, Bobyqa, Subplex, Newuoa, Praxis)
        ...
        //    {
        //        category = RefrigerantCategory.NewMixture;
        //        luis.core1(this.comboBox2.Text + "=" + textBox60.Text + "," + this.comboBox1.Text + "=" + textBox61.Text, category);
        //    }
        ...
        //    {
        //        solver.SetLowerBounds(new[] { 0.1, luis.working_fluid.CriticalPressure, 11000 });
        //        solver.SetUpperBounds(new[] { 1.0, 125000, 18000 });

        //        solver.SetInitialStepSize(new[] { 0.05, 500, 1000 });

        //        var initialValue = new[] { 0.2, luis.working_fluid.CriticalPressure, 11000 };

        //        Func<double[], double> funcion = delegate (double[] variables)
        //        {
        //           luis.RecompCycledesign_withReheating(luis, ref cicloRC, w_dot_net2, t_mc_in2, t_t_in2, variables[1], p_mc_out2,
        //           variables[2], t_rht_in2, -dp2_lt1, -dp2_ht1, -dp2_pc2, -dp2_phx1, -dp2_rhx1, -dp2_lt2, -dp2_ht2, ua_lt2, ua_ht2, 
        //           variables[0], eta_mc2, eta_rc2, eta_t2, eta_trh2, n_sub_hxrs2, tol2);
        ...
        //            p_mc_in2 = variables[1];
        //            p_rhx_in2 = variables[2];

        //            eta_thermal2_list.Add(eta_thermal2);
        //            recomp_frac2_list.Add(recomp_frac2);
        //            p_mc_in2_list.Add(p_mc_in2);
        //            p_rhx_in2_list.Add(p_rhx_in2);

        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox1.Items.Add(counter.ToString());
        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox2.Items.Add(eta_thermal2.ToString());
        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox3.Items.Add(recomp_frac2.ToString());
        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox4.Items.Add(p_mc_in2.ToString());
        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox5.Items.Add(p_rhx_in2.ToString());
        ...
        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox91.Text = p_mc_in2_list[maxIndex].ToString();
        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox90.Text = recomp_frac2_list[maxIndex].ToString();
        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox2.Text = p_rhx_in2_list[maxIndex].ToString();

        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox86.Text = eta_thermal2_list[maxIndex].ToString();

        //        //textBox7.Text = finalScore.GetValueOrDefault().ToString();
        //    }
        //}
        ...
        //    {
        //        solver.SetLowerBounds(new[] { 0.1, luis.working_fluid.CriticalPressure, 11000, 0.2 });
        //        solver.SetUpperBounds(new[] { 1.0, 125000, 18000, 0.8 });

        //        solver.SetInitialStepSize(new[] { 0.05, 500, 1000, 0.05 });

        //        var initialValue = new[] { 0.2, luis.working_fluid.CriticalPressure, 11000, 0.2 };

        //        Func<double[], double> funcion = delegate (double[] variables)
        //        {
        //            luis.RecompCycledesign_withReheating_for_Optimization(luis, ref cicloRC, w_dot_net2, t_mc_in2, t_t_in2, variables[1], p_mc_out2,
        //            variables[2], t_rht_in2, -dp2_lt1, -dp2_ht1, -dp2_pc2, -dp2_phx1, -dp2_rhx1, -dp2_lt2, -dp2_ht2, variables[3], UA_Total,
        //            variables[0], eta_mc2, eta_rc2, eta_t2, eta_trh2, n_sub_hxrs2, tol2);
        ...
        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox4.Items.Add(p_mc_in2.ToString());
        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox5.Items.Add(p_rhx_in2.ToString());
        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox6.Items.Add(ua_lt2.ToString());
        //            RC_with_ReHeating_Optimization_Analysis_Results_window.listBox7.Items.Add(ua_ht2.ToString());                 
        ...
        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox90.Text = recomp_frac2_list[maxIndex].ToString();
        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox2.Text = p_rhx_in2_list[maxIndex].ToString();
        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox82.Text = ua_LT_list[maxIndex].ToString();
        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox83.Text = ua_HT_list[maxIndex].ToString();

        //        RC_with_ReHeating_Optimization_Analysis_Results_window.textBox86.Text = eta_thermal2_list[maxIndex].ToString();
               
        //        //textBox93.Text = finalScore.GetValueOrDefault().ToString();
        //    }           
        //}       
