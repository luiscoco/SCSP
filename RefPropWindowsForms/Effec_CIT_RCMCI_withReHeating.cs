...
{
    public partial class Effec_CIT_RCMCI_withReHeating : Form
    {
        ...
        public Effec_CIT_RCMCI_withReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
                ...
                CIT_min = Convert.ToDouble(textBox76.Text);
                ...
                CIT_max = Convert.ToDouble(textBox74.Text);
                CIT_increment = Convert.ToDouble(textBox72.Text);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_RCMCI_WithReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_RCMCI_WithReHeating(this, "Main_SF");
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            if (comboBox5.Text == "Parabolic")
            {
                ...
                ReHeating_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_RCMCI_WithReHeating(this, "ReHeating_SF");
            ...
            else if (comboBox5.Text == "Fresnel")
            {
                ...
                ReHeating_LF_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_RCMCI_WithReHeating(this, "ReHeating_SF");
