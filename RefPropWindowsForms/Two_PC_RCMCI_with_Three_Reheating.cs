...
{
    public partial class Two_PC_RCMCI_with_Three_Reheating : Form
    {
        //Input Data:
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            t_trh1_in = Convert.ToDouble(textBox115.Text);
            p_trh1_in = Convert.ToDouble(textBox116.Text);

            t_trh2_in = Convert.ToDouble(textBox125.Text);
            p_trh2_in = Convert.ToDouble(textBox126.Text);

            t_trh3_in = Convert.ToDouble(textBox133.Text);
            p_trh3_in = Convert.ToDouble(textBox132.Text);
            ...
            m_eta_trh1 = Convert.ToDouble(textBox117.Text);
            m_eta_trh2 = Convert.ToDouble(textBox123.Text);
            ...
            luis.RecompCycle_Two_PC_RCMCI_with_Three_Reheating(luis, ref cicloTwo_PC_RCMCI_with_Three_Reheating,
            w_dot_net, t_pc1_in, t_pc2_in, t_mc4_in, t_mc3_in, t_t_in, t_trh1_in, p_trh1_in, t_trh2_in, p_trh2_in,
            t_trh3_in, p_trh3_in, p_pc1_in, p_pc1_out, p_pc2_in, p_pc2_out, p_mc4_in, p_mc4_out, p_mc3_in, p_mc3_out,
            ua_lt, ua_ht, m_eta_mc4, m_eta_pc1, m_eta_pc2, m_eta_rc, m_eta_mc3, m_eta_t, m_eta_trh1, m_eta_trh2,
            m_eta_trh3, n_sub_hxrs, m_recomp_frac, tol, eta_thermal, -dp_lt1, -dp_lt2, -dp_ht1, -dp_ht2, -dp_pc1,
            -dp_pc2, -dp_pc3, -dp_pc4, -dp_phx, -dp_rhx1, -dp_rhx2, -dp_rhx3);

            massflow2 = cicloTwo_PC_RCMCI_with_Three_Reheating.m_dot_turbine;
            w_dot_net2 = cicloTwo_PC_RCMCI_with_Three_Reheating.W_dot_net;
            eta_thermal2 = cicloTwo_PC_RCMCI_with_Three_Reheating.eta_thermal;
            ...
            temp21 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[0];
            temp22 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[1];
            temp23 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[2];
            temp24 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[3];
            temp25 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[4];
            temp26 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[5];
            temp27 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[6];
            temp28 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[7];
            temp29 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[8];
            temp210 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[9];
            temp211 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[10];
            temp212 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[11];
            temp213 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[12];
            temp214 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[13];
            temp215 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[14];
            temp216 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[15];
            temp217 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[16];
            temp218 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[17];
            temp219 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[18];
            temp220 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[19];
            temp221 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[20];
            temp222 = cicloTwo_PC_RCMCI_with_Three_Reheating.temp[21];

            pres21 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[0];
            pres22 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[1];
            pres23 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[2];
            pres24 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[3];
            pres25 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[4];
            pres26 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[5];
            pres27 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[6];
            pres28 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[7];
            pres29 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[8];
            pres210 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[9];
            pres211 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[10];
            pres212 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[11];
            pres213 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[12];
            pres214 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[13];
            pres215 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[14];
            pres216 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[15];
            pres217 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[16];
            pres218 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[17];
            pres219 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[18];
            pres220 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[19];
            pres221 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[20];
            pres222 = cicloTwo_PC_RCMCI_with_Three_Reheating.pres[21];
            ...
            String point7_state, point8_state, point9_state, point10_state, point11_state, point12_state,
                   ...
                   point18_state, point19_state, point20_state, point21_state, point22_state;
            ...
            {
                PHX = cicloTwo_PC_RCMCI_with_Three_Reheating.PHX.Q_dot;
                RHX1 = cicloTwo_PC_RCMCI_with_Three_Reheating.RHX1.Q_dot;
                RHX2 = cicloTwo_PC_RCMCI_with_Three_Reheating.RHX2.Q_dot;
                RHX3 = cicloTwo_PC_RCMCI_with_Three_Reheating.RHX3.Q_dot;

                recomp_frac2 = cicloTwo_PC_RCMCI_with_Three_Reheating.recomp_frac;

                LT_Q = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.Q_dot;
                LT_mdotc = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.m_dot_design[0];
                LT_mdoth = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.m_dot_design[1];
                LT_Tcin = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.T_c_in;
                LT_Thin = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.T_h_in;
                LT_Pcin = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.P_c_in;
                LT_Phin = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.P_h_in;
                LT_Pcout = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.P_c_out;
                LT_Phout = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.P_h_out;
                LT_Effc = cicloTwo_PC_RCMCI_with_Three_Reheating.LT.eff;

                HT_Q = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.Q_dot;
                HT_mdotc = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.m_dot_design[0];
                HT_mdoth = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.m_dot_design[1];
                HT_Tcin = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.T_c_in;
                HT_Thin = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.T_h_in;
                HT_Pcin = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.P_c_in;
                HT_Phin = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.P_h_in;
                HT_Pcout = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.P_c_out;
                HT_Phout = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.P_h_out;
                HT_Effc = cicloTwo_PC_RCMCI_with_Three_Reheating.HT.eff;

                PC1 = -cicloTwo_PC_RCMCI_with_Three_Reheating.PC1.Q_dot;
                PC2 = -cicloTwo_PC_RCMCI_with_Three_Reheating.PC2.Q_dot;
                PC3 = -cicloTwo_PC_RCMCI_with_Three_Reheating.PC3.Q_dot;
                PC4 = -cicloTwo_PC_RCMCI_with_Three_Reheating.PC4.Q_dot;
        ...
        {
            Two_PC_RCMCI_with_Three_Reheating_Optimization_Analysis_Results Two_PC_RCMCI_with_Three_Reheating_Optimization_Analysis_Results_dialog = new Two_PC_RCMCI_with_Three_Reheating_Optimization_Analysis_Results(this);
            Two_PC_RCMCI_with_Three_Reheating_Optimization_Analysis_Results_dialog.Show();
        }
    }
}
