...
{
    public partial class Optimal_Alt_Off_Design_from_Design : Form
    {
        ...
        const string refpropDLL_path2 = "CO2_optimal_offdesign.dll";
        [DllImport(refpropDLL_path2, EntryPoint = "carbondioxideoptimal_", SetLastError = true)]
        public static extern void carbondioxideoptimal_(ref Double w_dot_net1, ref Double t_mc_in1, ref Double t_t_in1, ref Double p_mc_in1, ref Double p_mc_out1,
                                                        ...
                                                        ref Double dp_lt1, ref Double dp_lt2, ref Double dp_ht1, ref Double dp_ht2, ref Double dp_pc1,
                                                        ref Double dp_pc2, ref Double dp_phx1, ref Double dp_phx2, ref Double temp1, ref Double temp2, ref Double temp3,
                                                        ref Double temp4, ref Double temp5, ref Double temp6, ref Double temp7, ref Double temp8, ref Double temp9,
                                                        ref Double temp10, ref Double pres1, ref Double pres2, ref Double pres3, ref Double pres4, ref Double pres5,
                                                        ref Double pres6, ref Double pres7, ref Double pres8, ref Double pres9, ref Double pres10, ref Double m_dot_turbine1,
                                                        ref Double LT_mdoth, ref Double LT_mdotc, ref Double LT_Tcin, ref Double LT_Thin, ref Double LT_Pcin, ref Double LT_Phin,
                                                        ref Double LT_Pcout, ref Double LT_Phout, ref Double LT_Q, ref Double HT_mdoth, ref Double HT_mdotc, ref Double HT_Tcin,
                                                        ref Double HT_Thin, ref Double HT_Pcin, ref Double HT_Phin, ref Double HT_Pcout, ref Double HT_Phout, ref Double HT_Q,
                                                        ref Double LT_UA, ref Double HT_UA, ref Double LT_Effc, ref Double HT_Effc, ref Double N_mc_design, ref Double t_mc_in_off,
                                                        ref Double t_t_in_off, ref Double target_off, ref Int64 target_code_off, ref Double lowest_pressure_off,
                                                        ref Double highest_pressure_off, ref Double recomp_frac_guess_off, ref Boolean fixed_recomp_frac_off, ref Double N_mc_guess_off,
                                                        ref Boolean fixed_N_mc_off, ref Double N_t_guess_off, ref Boolean fixed_N_t_off, ref Double Opt_tol);

        public Optimal_Alt_Off_Design_from_Design()
        {
            InitializeComponent();
        }
        ...
        public Double t_mc_in_off,t_t_in_off,target_off;
        public Int64 target_code_off;
        public Double lowest_pressure_off,highest_pressure_off;
        public Double recomp_frac_guess_off;
        public Boolean fixed_recomp_frac_off;
        public Double N_mc_guess_off;
        public Boolean fixed_N_mc_off;
        public Double N_t_guess_off;
        public Boolean fixed_N_t_off;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            t_mc_in_off = Convert.ToDouble(textBox6.Text);
            t_t_in_off = Convert.ToDouble(textBox9.Text);
            target_off = Convert.ToDouble(textBox30.Text);
            target_code_off = Convert.ToInt64(textBox31.Text);
            lowest_pressure_off = Convert.ToDouble(textBox36.Text);
            highest_pressure_off = Convert.ToDouble(textBox37.Text);
            recomp_frac_guess_off = Convert.ToDouble(textBox51.Text);
            fixed_recomp_frac_off = Convert.ToBoolean(textBox52.Text);
            N_mc_guess_off = Convert.ToDouble(textBox53.Text);
            fixed_N_mc_off = Convert.ToBoolean(textBox54.Text);
            N_t_guess_off = Convert.ToDouble(textBox55.Text);
            fixed_N_t_off = Convert.ToBoolean(textBox56.Text);

            N_mc_design2 = Convert.ToDouble(textBox7.Text);
            Opt_tol2 = Convert.ToDouble(textBox58.Text);

            if (comboBox2.Text == "CO2")
            {
                carbondioxideoptimal_(ref  w_dot_net2, ref  t_mc_in2, ref  t_t_in2, ref  p_mc_in2, ref  p_mc_out2,
                                      ref  ua_lt2, ref  ua_ht2, ref  eta_mc2, ref  eta_rc2, ref  eta_t2,
                                      ref  n_sub_hxrs2, ref  recomp_frac2, ref  tol2, ref  eta_thermal2,
                                      ref  dp2_lt1, ref  dp2_lt2, ref  dp2_ht1, ref  dp2_ht2, ref  dp2_pc1,
                                      ref  dp2_pc2, ref  dp2_phx1, ref  dp2_phx2, ref  temp21, ref  temp22, ref  temp23,
                                      ref  temp24, ref  temp25, ref  temp26, ref  temp27, ref  temp28, ref  temp29,
                                      ref  temp210, ref  pres21, ref  pres22, ref  pres23, ref  pres24, ref  pres25,
                                      ref  pres26, ref  pres27, ref  pres28, ref  pres29, ref  pres210, ref  massflow2,
                                      ref  LT_mdoth, ref  LT_mdotc, ref  LT_Tcin, ref  LT_Thin, ref  LT_Pcin, ref  LT_Phin,
                                      ref  LT_Pcout, ref  LT_Phout, ref  LT_Q, ref  HT_mdoth, ref  HT_mdotc, ref  HT_Tcin,
                                      ref  HT_Thin, ref  HT_Pcin, ref  HT_Phin, ref  HT_Pcout, ref  HT_Phout, ref  HT_Q,
                                      ref  LT_UA, ref  HT_UA, ref  LT_Effc, ref  HT_Effc, ref  N_mc_design2, ref  t_mc_in_off,
                                      ref  t_t_in_off, ref  target_off, ref  target_code_off, ref  lowest_pressure_off,
                                      ref  highest_pressure_off, ref  recomp_frac_guess_off, ref  fixed_recomp_frac_off,
                                      ref  N_mc_guess_off, ref  fixed_N_mc_off, ref  N_t_guess_off, ref fixed_N_t_off, ref Opt_tol2);
                ...
                textBox17.Text = Convert.ToString(LT_UA);
                textBox17.BackColor = Color.Yellow;

                textBox16.Text = Convert.ToString(HT_UA);
                textBox16.BackColor = Color.Yellow;

                textBox51.Text = Convert.ToString(recomp_frac_guess_off);
                textBox51.BackColor = Color.Yellow;

                textBox53.Text = Convert.ToString(N_mc_guess_off);
                textBox53.BackColor = Color.Yellow;

                textBox55.Text = Convert.ToString(N_t_guess_off);
