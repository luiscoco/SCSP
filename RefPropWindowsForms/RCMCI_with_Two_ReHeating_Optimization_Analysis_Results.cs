...
{
    public partial class RCMCI_with_Two_ReHeating_Optimization_Analysis_Results : Form
    {
        RCMCI_with_Two_Reheatings puntero_aplicacion;

        public RCMCI_with_Two_ReHeating_Optimization_Analysis_Results(RCMCI_with_Two_Reheatings puntero1)
        {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                core.RCMCIwithTwoReheating cicloRCMCI_withTwoRH = new core.RCMCIwithTwoReheating();
                ...
                {                            
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, initial_CIP_value + 200, puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out2 - 4000, puntero_aplicacion.p_mc2_out2 - 3000, puntero_aplicacion.p_mc2_out2 - 1000, puntero_aplicacion.p_mc2_out2 - 2000 });

                    solver.SetInitialStepSize(new[] { 0.01, 1000, 1000, 1000, 1000 });

                    var initialValue = new[] { 0.1, initial_CIP_value, initial_CIP_value + 500, 14000, 11000 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {                      
                        puntero_aplicacion.luis.RecompCycle_RCMCI_withTwoReheating(puntero_aplicacion.luis, 
                         ref cicloRCMCI_withTwoRH, puntero_aplicacion.w_dot_net2, puntero_aplicacion.t_mc2_in2, 
                         puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2, variables[3], 
                         puntero_aplicacion.t_rht2_in2, variables[4], variables[2],
                         ...
                         puntero_aplicacion.eta2_mc2, puntero_aplicacion.eta_rc2,
                         puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta_t2, puntero_aplicacion.eta_trh12, 
                         puntero_aplicacion.eta_trh22, puntero_aplicacion.n_sub_hxrs2, variables[0], 
                         puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2,
                         ...
                         -puntero_aplicacion.dp2_rhx22, -puntero_aplicacion.dp11_pc2, -puntero_aplicacion.dp12_pc2);

                        counter++;

                        puntero_aplicacion.massflow2 = cicloRCMCI_withTwoRH.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloRCMCI_withTwoRH.W_dot_net;

                        puntero_aplicacion.eta_thermal2 = cicloRCMCI_withTwoRH.eta_thermal;
                        ...
                        puntero_aplicacion.temp21 = cicloRCMCI_withTwoRH.temp[0];
                        puntero_aplicacion.temp22 = cicloRCMCI_withTwoRH.temp[1];
                        puntero_aplicacion.temp23 = cicloRCMCI_withTwoRH.temp[2];
                        puntero_aplicacion.temp24 = cicloRCMCI_withTwoRH.temp[3];
                        puntero_aplicacion.temp25 = cicloRCMCI_withTwoRH.temp[4];
                        puntero_aplicacion.temp26 = cicloRCMCI_withTwoRH.temp[5];
                        puntero_aplicacion.temp27 = cicloRCMCI_withTwoRH.temp[6];
                        puntero_aplicacion.temp28 = cicloRCMCI_withTwoRH.temp[7];
                        puntero_aplicacion.temp29 = cicloRCMCI_withTwoRH.temp[8];
                        puntero_aplicacion.temp210 = cicloRCMCI_withTwoRH.temp[9];
                        puntero_aplicacion.temp211 = cicloRCMCI_withTwoRH.temp[10];
                        puntero_aplicacion.temp212 = cicloRCMCI_withTwoRH.temp[11];
                        puntero_aplicacion.temp213 = cicloRCMCI_withTwoRH.temp[12];
                        puntero_aplicacion.temp214 = cicloRCMCI_withTwoRH.temp[13];
                        puntero_aplicacion.temp215 = cicloRCMCI_withTwoRH.temp[14];
                        puntero_aplicacion.temp216 = cicloRCMCI_withTwoRH.temp[15];

                        puntero_aplicacion.pres21 = cicloRCMCI_withTwoRH.pres[0];
                        puntero_aplicacion.pres22 = cicloRCMCI_withTwoRH.pres[1];
                        puntero_aplicacion.pres23 = cicloRCMCI_withTwoRH.pres[2];
                        puntero_aplicacion.pres24 = cicloRCMCI_withTwoRH.pres[3];
                        puntero_aplicacion.pres25 = cicloRCMCI_withTwoRH.pres[4];
                        puntero_aplicacion.pres26 = cicloRCMCI_withTwoRH.pres[5];
                        puntero_aplicacion.pres27 = cicloRCMCI_withTwoRH.pres[6];
                        puntero_aplicacion.pres28 = cicloRCMCI_withTwoRH.pres[7];
                        puntero_aplicacion.pres29 = cicloRCMCI_withTwoRH.pres[8];
                        puntero_aplicacion.pres210 = cicloRCMCI_withTwoRH.pres[9];
                        puntero_aplicacion.pres211 = cicloRCMCI_withTwoRH.pres[10];
                        puntero_aplicacion.pres212 = cicloRCMCI_withTwoRH.pres[11];
                        puntero_aplicacion.pres213 = cicloRCMCI_withTwoRH.pres[12];
                        puntero_aplicacion.pres214 = cicloRCMCI_withTwoRH.pres[13];
                        puntero_aplicacion.pres215 = cicloRCMCI_withTwoRH.pres[14];
                        puntero_aplicacion.pres216 = cicloRCMCI_withTwoRH.pres[15];

                        puntero_aplicacion.PHX1 = cicloRCMCI_withTwoRH.PHX.Q_dot;
                        puntero_aplicacion.RHX1 = cicloRCMCI_withTwoRH.RHX1.Q_dot;
                        puntero_aplicacion.RHX2 = cicloRCMCI_withTwoRH.RHX2.Q_dot;

                        puntero_aplicacion.LT_Q = cicloRCMCI_withTwoRH.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloRCMCI_withTwoRH.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloRCMCI_withTwoRH.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloRCMCI_withTwoRH.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloRCMCI_withTwoRH.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloRCMCI_withTwoRH.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloRCMCI_withTwoRH.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloRCMCI_withTwoRH.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloRCMCI_withTwoRH.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloRCMCI_withTwoRH.LT.eff;

                        puntero_aplicacion.HT_Q = cicloRCMCI_withTwoRH.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloRCMCI_withTwoRH.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloRCMCI_withTwoRH.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloRCMCI_withTwoRH.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloRCMCI_withTwoRH.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloRCMCI_withTwoRH.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloRCMCI_withTwoRH.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloRCMCI_withTwoRH.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloRCMCI_withTwoRH.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloRCMCI_withTwoRH.HT.eff;

                        puntero_aplicacion.PC11 = -cicloRCMCI_withTwoRH.PC.Q_dot;
                        puntero_aplicacion.PC21 = -cicloRCMCI_withTwoRH.COOLER.Q_dot;
                        ...
                        double LTR_min_DT_1 = cicloRCMCI_withTwoRH.temp[7] - cicloRCMCI_withTwoRH.temp[2];
                        double LTR_min_DT_2 = cicloRCMCI_withTwoRH.temp[8] - cicloRCMCI_withTwoRH.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloRCMCI_withTwoRH.temp[7] - cicloRCMCI_withTwoRH.temp[3];
                        double HTR_min_DT_2 = cicloRCMCI_withTwoRH.temp[6] - cicloRCMCI_withTwoRH.temp[4];
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 9] = cicloRCMCI_withTwoRH.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = cicloRCMCI_withTwoRH.HT.eff.ToString();
                        //HTR Pinch(ºC)
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, initial_CIP_value + 200, puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000, 0.2 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out2 - 4000, puntero_aplicacion.p_mc2_out2 - 3000, puntero_aplicacion.p_mc2_out2 - 1000, puntero_aplicacion.p_mc2_out2 - 2000, 0.8 });

                    solver.SetInitialStepSize(new[] { 0.01, 1000, 1000, 1000, 1000, 0.05 });

                    var initialValue = new[] { 0.1, initial_CIP_value, initial_CIP_value + 500, 14000, 11000, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_RCMCI_withTwoReheating_for_Optimization(puntero_aplicacion.luis,
                         ref cicloRCMCI_withTwoRH, puntero_aplicacion.w_dot_net2, puntero_aplicacion.t_mc2_in2,
                         puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2, variables[3],
                         puntero_aplicacion.t_rht2_in2, variables[4], variables[2],
                         puntero_aplicacion.p_mc2_out2, variables[1], puntero_aplicacion.t_mc1_in2,
                          variables[2], variables[5], UA_Total,
                         puntero_aplicacion.eta2_mc2, puntero_aplicacion.eta_rc2,
                         puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta_t2, puntero_aplicacion.eta_trh12,
                         puntero_aplicacion.eta_trh22, puntero_aplicacion.n_sub_hxrs2, variables[0],
                         puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2,
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "SolarPaces2019_Paper_Results_RCMCI_with_Two_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
            {
                ...
                if (checkBox2.Checked == false)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 5, 0.01, 10000))
                    {
                        solver.SetLowerBounds(new[] { 0.1, initial_mc1_in_value, initial_mc1_in_value+200, puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000 });
                        solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out2 - 4000, puntero_aplicacion.p_mc2_out2 - 3000, puntero_aplicacion.p_mc2_out2 - 1000, puntero_aplicacion.p_mc2_out2 - 2000 });

                        solver.SetInitialStepSize(new[] { 0.01, 1000, 1000, 1000, 1000 });

                        var initialValue = new[] { 0.1, initial_mc1_in_value, initial_mc1_out_value, 14000, 11000 };

                        Func<double[], double> funcion = delegate (double[] variables)
                        {
                            puntero_aplicacion.luis.RecompCycle_RCMCI_withTwoReheating(puntero_aplicacion.luis,
                             ref cicloRCMCI_withTwoRH, puntero_aplicacion.w_dot_net2, i,
                             puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht1_in2, variables[3],
                             puntero_aplicacion.t_rht2_in2, variables[4], variables[2],
                            ...
                            HT_Eff_list.Add(cicloRCMCI_withTwoRH.HT.eff);
                            LT_Eff_list.Add(cicloRCMCI_withTwoRH.LT.eff);
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = cicloRCMCI_withTwoRH.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = cicloRCMCI_withTwoRH.HT.eff.ToString();
                        //HTR Pinch(ºC)
                        ...
                        xlWorkSheet1.Cells[counter_Excel + 1, 18] = puntero_aplicacion.PTC_ReHeating2_SF_Effective_Apperture_Area.ToString();
                        //PTC_RHX2_Pressure_Drop(bar)
                        xlWorkSheet1.Cells[counter_Excel + 1, 19] = puntero_aplicacion.PTC_ReHeating2_SF_Pressure_drop.ToString();
                        //LF_RHX2_Apperture_Area(m2)
                        xlWorkSheet1.Cells[counter_Excel + 1, 20] = puntero_aplicacion.LF_ReHeating2_SF_Effective_Apperture_Area.ToString();
                        //LF_RHX2_Pressure_Drop(bar)
                        xlWorkSheet1.Cells[counter_Excel + 1, 21] = puntero_aplicacion.LF_ReHeating2_SF_Pressure_drop.ToString();
                ...
                else if (checkBox2.Checked == true)
                {
                    ...
                    using (var solver = new NLoptSolver(algorithm_type, 6, 0.01, 10000))
                    {
                        solver.SetLowerBounds(new[] { 0.1, initial_mc1_in_value, initial_mc1_in_value + 200, puntero_aplicacion.MixtureCriticalPressure + 2000, puntero_aplicacion.MixtureCriticalPressure + 1000, 0.2 });
                        solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc2_out2 - 4000, puntero_aplicacion.p_mc2_out2 - 3000, puntero_aplicacion.p_mc2_out2 - 1000, puntero_aplicacion.p_mc2_out2 - 2000, 0.8 });

                        solver.SetInitialStepSize(new[] { 0.01, 1000, 1000, 1000, 1000, 0.05 });

                        var initialValue = new[] { 0.1, initial_mc1_in_value, initial_mc1_out_value, 14000, 11000, 0.5 };
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "SolarPaces2019_Paper_CIT_Optimization_RCMCI_with_Two_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void RCMCI_with_Two_ReHeating_Optimization_Analysis_Results_Load(object sender, EventArgs e)
        {
