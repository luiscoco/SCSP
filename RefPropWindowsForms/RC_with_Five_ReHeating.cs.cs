...
namespace RefPropWindowsForms
{
    public partial class RC_with_Five_ReHeating : Form
    {
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            ...
            p_rhx2_in2 = Convert.ToDouble(textBox114.Text);
            t_rht2_in2 = Convert.ToDouble(textBox113.Text);
            p_rhx3_in2 = Convert.ToDouble(textBox116.Text);
            t_rht3_in2 = Convert.ToDouble(textBox115.Text);
            p_rhx4_in2 = Convert.ToDouble(textBox118.Text);
            t_rht4_in2 = Convert.ToDouble(textBox117.Text);
            p_rhx5_in2 = Convert.ToDouble(textBox120.Text);
            t_rht5_in2 = Convert.ToDouble(textBox119.Text);
            ...
            dp2_rhx3 = Convert.ToDouble(textBox72.Text);
            dp2_rhx4 = Convert.ToDouble(textBox109.Text);
            dp2_rhx5 = Convert.ToDouble(textBox110.Text);
            ...
            eta_trh2 = Convert.ToDouble(textBox70.Text);
            eta_trh3 = Convert.ToDouble(textBox71.Text);
            eta_trh4 = Convert.ToDouble(textBox111.Text);
            eta_trh5 = Convert.ToDouble(textBox112.Text);
            ...
            core.RecompCycleFiveReheating cicloRC = new core.RecompCycleFiveReheating();

            luis.RecompCycledesign_withFiveReheating(luis, ref cicloRC, w_dot_net2, 
            t_mc_in2, t_t_in2, p_mc_in2, p_mc_out2, p_rhx1_in2, t_rht1_in2, p_rhx2_in2,
            t_rht2_in2, p_rhx3_in2, t_rht3_in2, p_rhx4_in2, t_rht4_in2, p_rhx5_in2, 
            t_rht5_in2, -dp2_lt1, -dp2_ht1, -dp2_pc2, -dp2_phx1, -dp2_rhx1, -dp2_rhx2,
            -dp2_rhx3, -dp2_rhx4, -dp2_rhx5, -dp2_lt2, -dp2_ht2, ua_lt2, ua_ht2, recomp_frac,
            eta_mc, eta_rc, eta_t, eta_trh1, eta_trh2, eta_trh3, eta_trh4, eta_trh5, n_sub_hxrs2, tol2);
            ...
            temp219 = cicloRC.temp[18];
            temp220 = cicloRC.temp[19];
            ...
            pres219 = cicloRC.pres[18];
            pres220 = cicloRC.pres[19];
            ...
            textBox67.Text = Convert.ToString(pres215);
            textBox65.Text = Convert.ToString(pres216);
            textBox100.Text = Convert.ToString(pres217);
            textBox98.Text = Convert.ToString(pres218);
            textBox108.Text = Convert.ToString(pres219);
            textBox106.Text = Convert.ToString(pres220);
            ...
            textBox66.Text = Convert.ToString(temp215);
            textBox64.Text = Convert.ToString(temp216);
            textBox99.Text = Convert.ToString(temp217);
            textBox97.Text = Convert.ToString(temp218);
            textBox107.Text = Convert.ToString(temp219);
            ...
            if (checkBox1.Checked == false)
            {
                ...
                RHX3_Q2 = cicloRC.RHX3.Q_dot;
                RHX4_Q2 = cicloRC.RHX4.Q_dot;
                RHX5_Q2 = cicloRC.RHX5.Q_dot;
        ...
        {
            RC_with_Five_ReHeating_Optimization_Analysis_Results RC_with_Five_ReHeating_Optimization_Analysis_Results_dialog = new RC_with_Five_ReHeating_Optimization_Analysis_Results(this);
            RC_with_Five_ReHeating_Optimization_Analysis_Results_dialog.Show();
        }
    }   
}
