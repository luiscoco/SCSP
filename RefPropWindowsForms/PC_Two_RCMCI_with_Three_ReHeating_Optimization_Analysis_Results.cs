                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        if (i == Convert.ToDouble(textBox57.Text))
                        {
                            ...
                            xlWorkSheet1.Cells[4, 33] = "PTC_rhx3_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 34] = "PTC_rhx3_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 35] = "LF_rhx3_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 36] = "LF_rhx3_Pressure_Drop(bar)";
                        }
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 8, 0.000001, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_PC_Two_RCMCI_with_Three_Reheating(puntero_aplicacion.luis,
                                ref cicloPC_Two_RCMCI_with_Three_Reheating, puntero_aplicacion.w_dot_net, i, i, i, i,
                                puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh1_in, variables[5],
                                puntero_aplicacion.t_trh2_in, variables[6], puntero_aplicacion.t_trh3_in, variables[7],
                                variables[1], variables[2], variables[2], variables[3], variables[3], variables[4],
                                variables[4], puntero_aplicacion.p_mc2_out, puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht,
                                ...
                                PHX_Q2_list.Add(cicloPC_Two_RCMCI_with_Three_Reheating.PHX.Q_dot);
                                RHX1_Q2_list.Add(cicloPC_Two_RCMCI_with_Three_Reheating.RHX1.Q_dot);
                                RHX2_Q2_list.Add(cicloPC_Two_RCMCI_with_Three_Reheating.RHX2.Q_dot);
                                RHX3_Q2_list.Add(cicloPC_Two_RCMCI_with_Three_Reheating.RHX3.Q_dot);

                                HT_Eff_list.Add(cicloPC_Two_RCMCI_with_Three_Reheating.HT.eff);
                                LT_Eff_list.Add(cicloPC_Two_RCMCI_with_Three_Reheating.LT.eff);
                            ...
                            listBox51.Items.Add(i.ToString());
                            listBox50.Items.Add(eta_thermal2_list[maxIndex].ToString());
                            listBox49.Items.Add(recomp_frac2_list[maxIndex].ToString());
                            listBox42.Items.Add(p_pc_in2_list[maxIndex].ToString());
                            listBox41.Items.Add(p_pc_out2_list[maxIndex].ToString());
                            listBox44.Items.Add(p_mc4_in2_list[maxIndex].ToString());
                            listBox43.Items.Add(p_mc4_out2_list[maxIndex].ToString());
                            listBox40.Items.Add(p_mc3_in2_list[maxIndex].ToString());
                            listBox39.Items.Add(p_mc3_out2_list[maxIndex].ToString());
                            listBox38.Items.Add(p_mc2_in2_list[maxIndex].ToString());
                            listBox37.Items.Add(p_mc2_out2_list[maxIndex].ToString());
                            listBox36.Items.Add(p_rhx1_in2_list[maxIndex].ToString());
                            listBox35.Items.Add(p_rhx2_in2_list[maxIndex].ToString());
                            listBox34.Items.Add(p_rhx3_in2_list[maxIndex].ToString());
                            listBox45.Items.Add(t8_list[maxIndex].ToString());
                            listBox47.Items.Add(t9_list[maxIndex].ToString());
                            listBox48.Items.Add(ua_LT_list[maxIndex].ToString());
                            listBox46.Items.Add(ua_HT_list[maxIndex].ToString());
                            ...
                            //P_rhx3_in(kPa)
                            xlWorkSheet1.Cells[counter_Excel + 1, 11] = p_rhx3_in2_list[maxIndex].ToString();
                            //CIT
                            ...
                            xlWorkSheet1.Cells[counter_Excel + 1, 33] = puntero_aplicacion.PTC_Reheating3_SF_Effective_Apperture_Area.ToString();
                            //PTC_rhx3_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 34] = puntero_aplicacion.PTC_Reheating3_SF_Pressure_drop.ToString();
                            //LF_rhx3_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 35] = puntero_aplicacion.LF_Reheating3_SF_Effective_Apperture_Area.ToString();
                            //LF_rhx3_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 36] = puntero_aplicacion.LF_Reheating3_SF_Pressure_drop.ToString();
