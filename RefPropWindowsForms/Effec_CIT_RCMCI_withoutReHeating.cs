...
{
    public partial class Effec_CIT_RCMCI_withoutReHeating : Form
    {
        ...
        public Effec_CIT_RCMCI_withoutReHeating()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            UA_Total_min = Convert.ToDouble(textBox66.Text);
            UA_Total_max = Convert.ToDouble(textBox62.Text);
            ...
            for (int j = 0; j < Convert.ToInt64(maxiter_UA); j++)
            {
                ...
                CIT_min = Convert.ToDouble(textBox67.Text);
                ...
                CIT_max = Convert.ToDouble(textBox63.Text);
                ...
                for (int i = 0; i < Convert.ToInt64(maxiter); i++)
                {
                    ...
                    textBox35.Text = Convert.ToString(CIT_temp_value);
                    ...
                    //PR_Fraction & CIT
                    PR_frac_point.SetValueXY(CIT_temp_value, pr_mc2_guess2);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (comboBox4.Text == "Parabolic")
            {
                ...
                Main_PTC_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_RCMCI_Without_ReHeating(this, "Main_SF");
            ...
            else if (comboBox4.Text == "Fresnel")
            {
                ...
                Main_LF_SF_PHX_Data_Input_Dialogue.pointer_function_CIT_RCMCI_Without_ReHeating(this, "Main_SF");
