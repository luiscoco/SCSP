...
{
    public partial class Two_PC_RCMCI_withoutReheating_Optimization_Analysis_Results : Form
    {
        Two_PC_RCMCI_withoutReheating puntero_aplicacion;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                core.Two_PC_RCMCI_withoutReheating cicloTwo_PC_RCMCI_withoutReheating = new core.Two_PC_RCMCI_withoutReheating();
                ...
                {
                    solver.SetLowerBounds(new[] { 0.0, initial_CIP_value, initial_CIP_value + 500, initial_CIP_value + 1000, initial_CIP_value + 1500 });
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out });

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0 });

                    var initialValue = new[] { 0.2, initial_CIP_value , initial_CIP_value + 1500.0, initial_CIP_value + 3000.0, initial_CIP_value + 4000.0 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_without_Reheating(puntero_aplicacion.luis, ref cicloTwo_PC_RCMCI_withoutReheating,
                        ...
                        variables[4], puntero_aplicacion.p_mc3_out, puntero_aplicacion.ua_lt, 
                        ...
                        -puntero_aplicacion.dp_pc4, -puntero_aplicacion.dp_phx);

                        counter++;

                        puntero_aplicacion.massflow2 = cicloTwo_PC_RCMCI_withoutReheating.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloTwo_PC_RCMCI_withoutReheating.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloTwo_PC_RCMCI_withoutReheating.eta_thermal;
                        ...
                        puntero_aplicacion.temp21 = cicloTwo_PC_RCMCI_withoutReheating.temp[0];
                        puntero_aplicacion.temp22 = cicloTwo_PC_RCMCI_withoutReheating.temp[1];
                        puntero_aplicacion.temp23 = cicloTwo_PC_RCMCI_withoutReheating.temp[2];
                        puntero_aplicacion.temp24 = cicloTwo_PC_RCMCI_withoutReheating.temp[3];
                        puntero_aplicacion.temp25 = cicloTwo_PC_RCMCI_withoutReheating.temp[4];
                        puntero_aplicacion.temp26 = cicloTwo_PC_RCMCI_withoutReheating.temp[5];
                        puntero_aplicacion.temp27 = cicloTwo_PC_RCMCI_withoutReheating.temp[6];
                        puntero_aplicacion.temp28 = cicloTwo_PC_RCMCI_withoutReheating.temp[7];
                        puntero_aplicacion.temp29 = cicloTwo_PC_RCMCI_withoutReheating.temp[8];
                        puntero_aplicacion.temp210 = cicloTwo_PC_RCMCI_withoutReheating.temp[9];
                        puntero_aplicacion.temp211 = cicloTwo_PC_RCMCI_withoutReheating.temp[10];
                        puntero_aplicacion.temp212 = cicloTwo_PC_RCMCI_withoutReheating.temp[11];
                        puntero_aplicacion.temp213 = cicloTwo_PC_RCMCI_withoutReheating.temp[12];
                        puntero_aplicacion.temp214 = cicloTwo_PC_RCMCI_withoutReheating.temp[13];
                        puntero_aplicacion.temp215 = cicloTwo_PC_RCMCI_withoutReheating.temp[14];
                        puntero_aplicacion.temp216 = cicloTwo_PC_RCMCI_withoutReheating.temp[15];

                        puntero_aplicacion.pres21 = cicloTwo_PC_RCMCI_withoutReheating.pres[0];
                        puntero_aplicacion.pres22 = cicloTwo_PC_RCMCI_withoutReheating.pres[1];
                        puntero_aplicacion.pres23 = cicloTwo_PC_RCMCI_withoutReheating.pres[2];
                        puntero_aplicacion.pres24 = cicloTwo_PC_RCMCI_withoutReheating.pres[3];
                        puntero_aplicacion.pres25 = cicloTwo_PC_RCMCI_withoutReheating.pres[4];
                        puntero_aplicacion.pres26 = cicloTwo_PC_RCMCI_withoutReheating.pres[5];
                        puntero_aplicacion.pres27 = cicloTwo_PC_RCMCI_withoutReheating.pres[6];
                        puntero_aplicacion.pres28 = cicloTwo_PC_RCMCI_withoutReheating.pres[7];
                        puntero_aplicacion.pres29 = cicloTwo_PC_RCMCI_withoutReheating.pres[8];
                        puntero_aplicacion.pres210 = cicloTwo_PC_RCMCI_withoutReheating.pres[9];
                        puntero_aplicacion.pres211 = cicloTwo_PC_RCMCI_withoutReheating.pres[10];
                        puntero_aplicacion.pres212 = cicloTwo_PC_RCMCI_withoutReheating.pres[11];
                        puntero_aplicacion.pres213 = cicloTwo_PC_RCMCI_withoutReheating.pres[12];
                        puntero_aplicacion.pres214 = cicloTwo_PC_RCMCI_withoutReheating.pres[13];
                        puntero_aplicacion.pres215 = cicloTwo_PC_RCMCI_withoutReheating.pres[14];
                        puntero_aplicacion.pres216 = cicloTwo_PC_RCMCI_withoutReheating.pres[15];

                        puntero_aplicacion.PHX1 = cicloTwo_PC_RCMCI_withoutReheating.PHX.Q_dot;

                        puntero_aplicacion.LT_Q = cicloTwo_PC_RCMCI_withoutReheating.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloTwo_PC_RCMCI_withoutReheating.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloTwo_PC_RCMCI_withoutReheating.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloTwo_PC_RCMCI_withoutReheating.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloTwo_PC_RCMCI_withoutReheating.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloTwo_PC_RCMCI_withoutReheating.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloTwo_PC_RCMCI_withoutReheating.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloTwo_PC_RCMCI_withoutReheating.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloTwo_PC_RCMCI_withoutReheating.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloTwo_PC_RCMCI_withoutReheating.LT.eff;

                        puntero_aplicacion.HT_Q = cicloTwo_PC_RCMCI_withoutReheating.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloTwo_PC_RCMCI_withoutReheating.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloTwo_PC_RCMCI_withoutReheating.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloTwo_PC_RCMCI_withoutReheating.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloTwo_PC_RCMCI_withoutReheating.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloTwo_PC_RCMCI_withoutReheating.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloTwo_PC_RCMCI_withoutReheating.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloTwo_PC_RCMCI_withoutReheating.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloTwo_PC_RCMCI_withoutReheating.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloTwo_PC_RCMCI_withoutReheating.HT.eff;

                        puntero_aplicacion.PC1 = -cicloTwo_PC_RCMCI_withoutReheating.PC1.Q_dot;
                        puntero_aplicacion.PC2 = -cicloTwo_PC_RCMCI_withoutReheating.PC2.Q_dot;
                        puntero_aplicacion.PC3 = -cicloTwo_PC_RCMCI_withoutReheating.PC3.Q_dot;
                        puntero_aplicacion.PC4 = -cicloTwo_PC_RCMCI_withoutReheating.PC4.Q_dot;
                        ...
                        double LTR_min_DT_1 = cicloTwo_PC_RCMCI_withoutReheating.temp[7] - cicloTwo_PC_RCMCI_withoutReheating.temp[2];
                        double LTR_min_DT_2 = cicloTwo_PC_RCMCI_withoutReheating.temp[8] - cicloTwo_PC_RCMCI_withoutReheating.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloTwo_PC_RCMCI_withoutReheating.temp[7] - cicloTwo_PC_RCMCI_withoutReheating.temp[3];
                        double HTR_min_DT_2 = cicloTwo_PC_RCMCI_withoutReheating.temp[6] - cicloTwo_PC_RCMCI_withoutReheating.temp[4];
                        ...
                        //CIT
                        xlWorkSheet1.Cells[counter_Excel + 1, 5] = Convert.ToString(puntero_aplicacion.t_mc4_in - 273.15);
                        //LT UA(kW/K)
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = cicloTwo_PC_RCMCI_withoutReheating.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = cicloTwo_PC_RCMCI_withoutReheating.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "Two_PC_RCMCI_withoutRH" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else  if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 6, 0.000001, 10000))
                {
                    ...
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out, 1.0 });

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 0.05 });

                    var initialValue = new[] { 0.2, initial_CIP_value, initial_CIP_value + 1500.0, initial_CIP_value + 3000.0, initial_CIP_value + 4000.0, 0.5 };

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_RCMCI_without_Reheating_for_optimization(puntero_aplicacion.luis, ref cicloTwo_PC_RCMCI_withoutReheating,
                        puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in, puntero_aplicacion.t_pc2_in,
                        puntero_aplicacion.t_mc4_in, puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_t_in,
                        variables[1], variables[2], variables[2],
                        variables[3], variables[3], variables[4],
                        variables[4], puntero_aplicacion.p_mc3_out, variables[5], UA_Total,
                        puntero_aplicacion.m_eta_mc4, puntero_aplicacion.m_eta_pc1,
                        puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_rc, puntero_aplicacion.m_eta_mc3,
                        puntero_aplicacion.m_eta_t, puntero_aplicacion.n_sub_hxrs, variables[0],
                        puntero_aplicacion.tol, puntero_aplicacion.eta_thermal, -puntero_aplicacion.dp_lt1,
                        -puntero_aplicacion.dp_lt2, -puntero_aplicacion.dp_ht1, -puntero_aplicacion.dp_ht2,
                        ...
                        xlWorkSheet1.Cells[counter_Excel + 1, 2] = Convert.ToString(puntero_aplicacion.p_pc1_out);
                        //PC2_out(kPa)
                        xlWorkSheet1.Cells[counter_Excel + 1, 2] = Convert.ToString(puntero_aplicacion.p_pc2_out);
                        //MC4_out(kPa)
                        xlWorkSheet1.Cells[counter_Excel + 1, 3] = Convert.ToString(puntero_aplicacion.p_mc4_out);
                        //CIT
                        xlWorkSheet1.Cells[counter_Excel + 1, 4] = Convert.ToString(puntero_aplicacion.t_mc4_in - 273.15);
                        //LT UA(kW/K)
                        ...
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 9] = cicloTwo_PC_RCMCI_withoutReheating.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = cicloTwo_PC_RCMCI_withoutReheating.HT.eff.ToString();
                        //HTR Pinch(ºC)
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 5, 0.000001, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                ...
                                PHX_Q2_list.Add(cicloTwo_PC_RCMCI_withoutReheating.PHX.Q_dot);

                                HT_Eff_list.Add(cicloTwo_PC_RCMCI_withoutReheating.HT.eff);
                                LT_Eff_list.Add(cicloTwo_PC_RCMCI_withoutReheating.LT.eff);
