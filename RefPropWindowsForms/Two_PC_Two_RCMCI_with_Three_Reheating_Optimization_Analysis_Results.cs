...
{
    public partial class Two_PC_Two_RCMCI_with_Three_Reheating_Optimization_Analysis_Results : Form
    {
        Two_PC_Two_RCMCI_with_Three_Reheating puntero_aplicacion;

        public Two_PC_Two_RCMCI_with_Three_Reheating_Optimization_Analysis_Results(Two_PC_Two_RCMCI_with_Three_Reheating puntero1)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                puntero_aplicacion.t_trh1_in = Convert.ToDouble(puntero_aplicacion.textBox126.Text);
                puntero_aplicacion.p_trh1_in = Convert.ToDouble(puntero_aplicacion.textBox127.Text);

                puntero_aplicacion.t_trh2_in = Convert.ToDouble(puntero_aplicacion.textBox134.Text);
                puntero_aplicacion.p_trh2_in = Convert.ToDouble(puntero_aplicacion.textBox135.Text);

                puntero_aplicacion.t_trh3_in = Convert.ToDouble(puntero_aplicacion.textBox142.Text);
                puntero_aplicacion.p_trh3_in = Convert.ToDouble(puntero_aplicacion.textBox143.Text);
                ...
                puntero_aplicacion.m_eta_trh1 = Convert.ToDouble(puntero_aplicacion.textBox125.Text);
                puntero_aplicacion.m_eta_trh2 = Convert.ToDouble(puntero_aplicacion.textBox133.Text);
                puntero_aplicacion.m_eta_trh3 = Convert.ToDouble(puntero_aplicacion.textBox137.Text);
                ...
                puntero_aplicacion.dp_rhx1 = Convert.ToDouble(puntero_aplicacion.textBox124.Text);
                puntero_aplicacion.dp_rhx2 = Convert.ToDouble(puntero_aplicacion.textBox136.Text);
                puntero_aplicacion.dp_rhx3 = Convert.ToDouble(puntero_aplicacion.textBox132.Text);
                ...
                xlWorkSheet1.Cells[4, 12] = "P_rhx3_in(kPa)";
                xlWorkSheet1.Cells[4, 13] = "CIT(K)";
                xlWorkSheet1.Cells[4, 14] = "LT UA(kW/K)";
                xlWorkSheet1.Cells[4, 15] = "HT UA(kW/K)";
                xlWorkSheet1.Cells[4, 16] = "Rec.Frac.";
                xlWorkSheet1.Cells[4, 17] = "Eff.(%)";
                xlWorkSheet1.Cells[4, 18] = "LTR Eff.(%)";
                xlWorkSheet1.Cells[4, 19] = "LTR Pinch(ºC)";
                xlWorkSheet1.Cells[4, 20] = "HTR Eff.(%)";
                xlWorkSheet1.Cells[4, 21] = "HTR Pinch(ºC)";
                ...
                using (var solver = new NLoptSolver(algorithm_type, 9, 0.000001, 10000))
                {
                    ...
                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 250.0, 1000.0, 1000.0, 1000.0});
                    ...
                    var initialValue = new[] { 0.2, initial_CIP_value + 1500.0, initial_CIP_value + 2500.0,
                                               ...
                                               initial_CIP_value + 5500.0, 17000.0, 14000.0 , 13000.0};

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_Two_RCMCI_with_Three_Reheating(puntero_aplicacion.luis,
                        ref cicloTwo_PC_Two_RCMCI_with_Three_Reheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in,
                        ...
                        puntero_aplicacion.t_trh2_in, variables[7], puntero_aplicacion.t_trh3_in, variables[8], variables[1],
                        variables[2], variables[2], variables[3], variables[3], variables[4], variables[4], variables[5],
                        variables[5], puntero_aplicacion.p_mc3_out, puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht,
                        puntero_aplicacion.m_eta_mc5, puntero_aplicacion.m_eta_pc1, puntero_aplicacion.m_eta_pc2,
                        puntero_aplicacion.m_eta_rc, puntero_aplicacion.m_eta_mc4, puntero_aplicacion.m_eta_mc3, 
                        puntero_aplicacion.m_eta_t, puntero_aplicacion.m_eta_trh1, puntero_aplicacion.m_eta_trh2,
                         puntero_aplicacion.m_eta_trh3, puntero_aplicacion.n_sub_hxrs, variables[0], puntero_aplicacion.tol, 
                         puntero_aplicacion.eta_thermal, -puntero_aplicacion.dp_lt1, -puntero_aplicacion.dp_lt2,
                         -puntero_aplicacion.dp_ht1, -puntero_aplicacion.dp_ht2, -puntero_aplicacion.dp_pc1, 
                         -puntero_aplicacion.dp_pc4, -puntero_aplicacion.dp_pc3, -puntero_aplicacion.dp_pc2, 
                         -puntero_aplicacion.dp_pc5, -puntero_aplicacion.dp_phx, -puntero_aplicacion.dp_rhx1, 
                         -puntero_aplicacion.dp_rhx2, -puntero_aplicacion.dp_rhx3);

                        counter++;

                        puntero_aplicacion.massflow2 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.m_dot_turbine;
                        puntero_aplicacion.w_dot_net2 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.W_dot_net;
                        puntero_aplicacion.eta_thermal2 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.eta_thermal;
                        ...
                        puntero_aplicacion.p_trh1_in = variables[6];
                        puntero_aplicacion.p_trh2_in = variables[7];
                        puntero_aplicacion.p_trh3_in = variables[8];

                        puntero_aplicacion.temp21 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[0];
                        puntero_aplicacion.temp22 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[1];
                        puntero_aplicacion.temp23 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[2];
                        puntero_aplicacion.temp24 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[3];
                        puntero_aplicacion.temp25 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[4];
                        puntero_aplicacion.temp26 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[5];
                        puntero_aplicacion.temp27 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[6];
                        puntero_aplicacion.temp28 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[7];
                        puntero_aplicacion.temp29 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[8];
                        puntero_aplicacion.temp210 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[9];
                        puntero_aplicacion.temp211 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[10];
                        puntero_aplicacion.temp212 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[11];
                        puntero_aplicacion.temp213 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[12];
                        puntero_aplicacion.temp214 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[13];
                        puntero_aplicacion.temp215 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[14];
                        puntero_aplicacion.temp216 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[15];
                        puntero_aplicacion.temp217 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[16];
                        puntero_aplicacion.temp218 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[17];
                        puntero_aplicacion.temp219 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[18];
                        puntero_aplicacion.temp220 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[19];
                        puntero_aplicacion.temp221 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[20];
                        puntero_aplicacion.temp222 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[21];
                        puntero_aplicacion.temp223 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[22];
                        puntero_aplicacion.temp224 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[23];

                        puntero_aplicacion.pres21 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[0];
                        puntero_aplicacion.pres22 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[1];
                        puntero_aplicacion.pres23 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[2];
                        puntero_aplicacion.pres24 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[3];
                        puntero_aplicacion.pres25 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[4];
                        puntero_aplicacion.pres26 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[5];
                        puntero_aplicacion.pres27 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[6];
                        puntero_aplicacion.pres28 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[7];
                        puntero_aplicacion.pres29 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[8];
                        puntero_aplicacion.pres210 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[9];
                        puntero_aplicacion.pres211 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[10];
                        puntero_aplicacion.pres212 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[11];
                        puntero_aplicacion.pres213 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[12];
                        puntero_aplicacion.pres214 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[13];
                        puntero_aplicacion.pres215 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[14];
                        puntero_aplicacion.pres216 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[15];
                        puntero_aplicacion.pres217 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[16];
                        puntero_aplicacion.pres218 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[17];
                        puntero_aplicacion.pres219 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[18];
                        puntero_aplicacion.pres220 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[19];
                        puntero_aplicacion.pres221 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[20];
                        puntero_aplicacion.pres222 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[21];
                        puntero_aplicacion.pres223 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[22];
                        puntero_aplicacion.pres224 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.pres[23];

                        puntero_aplicacion.PHX = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.PHX.Q_dot;
                        puntero_aplicacion.RHX1 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.RHX1.Q_dot;
                        puntero_aplicacion.RHX2 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.RHX2.Q_dot;
                        puntero_aplicacion.RHX3 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.RHX3.Q_dot;

                        puntero_aplicacion.LT_Q = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.Q_dot;
                        puntero_aplicacion.LT_mdotc = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.m_dot_design[0];
                        puntero_aplicacion.LT_mdoth = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.m_dot_design[1];
                        puntero_aplicacion.LT_Tcin = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.T_c_in;
                        puntero_aplicacion.LT_Thin = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.T_h_in;
                        puntero_aplicacion.LT_Pcin = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.P_c_in;
                        puntero_aplicacion.LT_Phin = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.P_h_in;
                        puntero_aplicacion.LT_Pcout = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.P_c_out;
                        puntero_aplicacion.LT_Phout = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.P_h_out;
                        puntero_aplicacion.LT_Effc = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.eff;

                        puntero_aplicacion.HT_Q = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.Q_dot;
                        puntero_aplicacion.HT_mdotc = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.m_dot_design[0];
                        puntero_aplicacion.HT_mdoth = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.m_dot_design[1];
                        puntero_aplicacion.HT_Tcin = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.T_c_in;
                        puntero_aplicacion.HT_Thin = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.T_h_in;
                        puntero_aplicacion.HT_Pcin = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.P_c_in;
                        puntero_aplicacion.HT_Phin = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.P_h_in;
                        puntero_aplicacion.HT_Pcout = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.P_c_out;
                        puntero_aplicacion.HT_Phout = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.P_h_out;
                        puntero_aplicacion.HT_Effc = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.eff;

                        puntero_aplicacion.PC1 = -cicloTwo_PC_Two_RCMCI_with_Three_Reheating.PC1.Q_dot;
                        puntero_aplicacion.PC2 = -cicloTwo_PC_Two_RCMCI_with_Three_Reheating.PC2.Q_dot;
                        puntero_aplicacion.PC3 = -cicloTwo_PC_Two_RCMCI_with_Three_Reheating.PC3.Q_dot;
                        puntero_aplicacion.PC4 = -cicloTwo_PC_Two_RCMCI_with_Three_Reheating.PC4.Q_dot;
                        puntero_aplicacion.PC5 = -cicloTwo_PC_Two_RCMCI_with_Three_Reheating.PC5.Q_dot;
                        ...
                        listBox9.Items.Add(puntero_aplicacion.p_trh1_in.ToString());
                        listBox32.Items.Add(puntero_aplicacion.p_pc2_in.ToString());
                        listBox10.Items.Add(puntero_aplicacion.p_trh2_in.ToString());
                        listBox19.Items.Add(puntero_aplicacion.p_trh3_in.ToString());
                        ...
                        double LTR_min_DT_1 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[7] - cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[2];
                        double LTR_min_DT_2 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[8] - cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[1];
                        double LTR_min_DT_paper = Math.Min(LTR_min_DT_1, LTR_min_DT_2);

                        double HTR_min_DT_1 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[7] - cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[3];
                        double HTR_min_DT_2 = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[6] - cicloTwo_PC_Two_RCMCI_with_Three_Reheating.temp[4];
                        ...
                        //P_rhx1_in(kPa)
                        xlWorkSheet1.Cells[counter_Excel + 1, 10] = Convert.ToString(puntero_aplicacion.p_trh1_in);
                        //P_rhx2_in(kPa)
                        xlWorkSheet1.Cells[counter_Excel + 1, 11] = Convert.ToString(puntero_aplicacion.p_trh2_in);
                        //P_rhx3_in(kPa)
                        xlWorkSheet1.Cells[counter_Excel + 1, 12] = Convert.ToString(puntero_aplicacion.p_trh3_in);
                        //CIT
                        xlWorkSheet1.Cells[counter_Excel + 1, 13] = Convert.ToString(puntero_aplicacion.t_mc4_in - 273.15);
                        //LT UA(kW/K)
                        xlWorkSheet1.Cells[counter_Excel + 1, 14] = Convert.ToString(puntero_aplicacion.ua_lt);
                        //HT UA(kW/K)
                        xlWorkSheet1.Cells[counter_Excel + 1, 15] = Convert.ToString(puntero_aplicacion.ua_ht);
                        //Rec.Frac.
                        xlWorkSheet1.Cells[counter_Excel + 1, 16] = puntero_aplicacion.recomp_frac2.ToString();
                        //Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 17] = (puntero_aplicacion.eta_thermal2 * 100).ToString();
                        //LTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 18] = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.eff.ToString();
                        //LTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 19] = LTR_min_DT_paper.ToString();
                        //HTR Eff.(%)
                        xlWorkSheet1.Cells[counter_Excel + 1, 20] = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.eff.ToString();
                        //HTR Pinch(ºC)
                        xlWorkSheet1.Cells[counter_Excel + 1, 21] = HTR_min_DT_paper.ToString();
                    ...
                    textBox21.Text = p_rhx1_in2_list[maxIndex].ToString();
                    textBox20.Text = p_rhx2_in2_list[maxIndex].ToString();
                    textBox19.Text = p_rhx3_in2_list[maxIndex].ToString();
                    ...
                    if (checkBox3.Checked == true)
                    {
                        ...
                        puntero_aplicacion.textBox143.Text = p_rhx3_in2_list[maxIndex].ToString();
                    }

                    //Closing Excel Book
                    xlWorkBook1.SaveAs(textBox3.Text + "Two_PC_Two_RCMCI_with_Three_RH" + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                using (var solver = new NLoptSolver(algorithm_type, 10, 0.000001, 10000))
                {
                    ...
                    solver.SetUpperBounds(new[] { 1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out,
                                                  puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out,
                                                  puntero_aplicacion.p_mc3_out , puntero_aplicacion.p_mc3_out,
                                                  1.0, puntero_aplicacion.p_mc3_out, puntero_aplicacion.p_mc3_out});

                    solver.SetInitialStepSize(new[] { 0.05, 250.0, 250.0, 250.0, 250.0, 250.0, 1000.0, 0.05, 1000.0, 1000.0});

                    var initialValue = new[] { 0.2, initial_CIP_value + 1500.0, initial_CIP_value + 2500.0,
                                               initial_CIP_value + 3500.0, initial_CIP_value + 4500.0,
                                               initial_CIP_value + 5500.0, 17000.0, 0.5, 14000.0, 13000.0};

                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_Two_PC_Two_RCMCI_with_Three_Reheating_for_optimization(puntero_aplicacion.luis,
                        ref cicloTwo_PC_Two_RCMCI_with_Three_Reheating, puntero_aplicacion.w_dot_net, puntero_aplicacion.t_pc1_in,
                        puntero_aplicacion.t_pc2_in, puntero_aplicacion.t_mc5_in, puntero_aplicacion.t_mc4_in,
                        puntero_aplicacion.t_mc3_in, puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh1_in, 
                        variables[6], puntero_aplicacion.t_trh2_in, variables[8], puntero_aplicacion.t_trh3_in, variables[9], 
                        variables[1], variables[2], variables[2], variables[3], variables[3],
                        ...
                        puntero_aplicacion.m_eta_mc3, puntero_aplicacion.m_eta_t, puntero_aplicacion.m_eta_trh1, 
                        puntero_aplicacion.m_eta_trh2, puntero_aplicacion.m_eta_trh3, puntero_aplicacion.n_sub_hxrs, 
                        variables[0], puntero_aplicacion.tol, puntero_aplicacion.eta_thermal,
                        ...
                        puntero_aplicacion.p_trh2_in = variables[8];
                        puntero_aplicacion.p_trh3_in = variables[9];
                        ...
                        listBox32.Items.Add(puntero_aplicacion.p_pc2_in.ToString());
                        listBox10.Items.Add(puntero_aplicacion.p_trh2_in.ToString());
                        listBox19.Items.Add(puntero_aplicacion.p_trh2_in.ToString());
                        listBox20.Items.Add(puntero_aplicacion.p_mc5_in.ToString());
                        //listBox19.Items.Add(puntero_aplicacion.p_mc5_out.ToString());
                        listBox24.Items.Add(puntero_aplicacion.p_mc4_in.ToString());
                        //listBox23.Items.Add(puntero_aplicacion.p_mc4_out.ToString());
            ...
            for (double j = Convert.ToDouble(textBox11.Text); j <= Convert.ToDouble(textBox10.Text); j = j + Convert.ToDouble(textBox9.Text))
            {
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        List<Double> t23_list = new List<Double>();
                        List<Double> t24_list = new List<Double>();
                        ...
                        List<Double> p23_list = new List<Double>();
                        List<Double> p24_list = new List<Double>();
                        ...
                        if (i == Convert.ToDouble(textBox57.Text))
                        {
                            ...
                            xlWorkSheet1.Cells[4, 20] = "HTR Eff.(%)";
                            xlWorkSheet1.Cells[4, 21] = "HTR Pinch(ºC)";
                            xlWorkSheet1.Cells[4, 22] = "PTC_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 23] = "PTC_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 24] = "LF_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 25] = "LF_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 26] = "PTC_rhx1_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 27] = "PTC_rhx1_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 28] = "LF_rhx1_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 29] = "LF_rhx1_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 30] = "PTC_rhx2_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 31] = "PTC_rhx2_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 32] = "LF_rhx2_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 33] = "LF_rhx2_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 34] = "PTC_rhx3_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 35] = "PTC_rhx3_Pressure_Drop(bar)";
                            xlWorkSheet1.Cells[4, 36] = "LF_rhx3_Apperture_Area(m2)";
                            xlWorkSheet1.Cells[4, 37] = "LF_rhx3_Pressure_Drop(bar)";
                        }
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 9, 0.000001, 10000))
                        {
                            ...
                            {
                                puntero_aplicacion.luis.RecompCycle_Two_PC_Two_RCMCI_with_Three_Reheating(puntero_aplicacion.luis,
                                ref cicloTwo_PC_Two_RCMCI_with_Three_Reheating, puntero_aplicacion.w_dot_net, i, i, i, i, i, 
                                puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh1_in, variables[6],
                                puntero_aplicacion.t_trh2_in, variables[7], puntero_aplicacion.t_trh3_in, variables[8], variables[1],
                                variables[2], variables[2], variables[3], variables[3], variables[4], variables[4], variables[5],
                                variables[5], puntero_aplicacion.p_mc3_out, puntero_aplicacion.ua_lt, puntero_aplicacion.ua_ht,
                                puntero_aplicacion.m_eta_mc5, puntero_aplicacion.m_eta_pc1, puntero_aplicacion.m_eta_pc2,
                                ...
                                t23_list.Add(puntero_aplicacion.temp223);
                                t24_list.Add(puntero_aplicacion.temp224);
                                ...
                                p23_list.Add(puntero_aplicacion.pres223);
                                p24_list.Add(puntero_aplicacion.pres224);

                                PHX_Q2_list.Add(cicloTwo_PC_Two_RCMCI_with_Three_Reheating.PHX.Q_dot);
                                RHX1_Q2_list.Add(cicloTwo_PC_Two_RCMCI_with_Three_Reheating.RHX1.Q_dot);
                                RHX2_Q2_list.Add(cicloTwo_PC_Two_RCMCI_with_Three_Reheating.RHX2.Q_dot);
                                RHX3_Q2_list.Add(cicloTwo_PC_Two_RCMCI_with_Three_Reheating.RHX3.Q_dot);

                                HT_Eff_list.Add(cicloTwo_PC_Two_RCMCI_with_Three_Reheating.HT.eff);
                                LT_Eff_list.Add(cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.eff);
                            ...
                            listBox25.Items.Add(p_rhx1_in2_list[maxIndex].ToString());
                            listBox23.Items.Add(p_rhx2_in2_list[maxIndex].ToString());
                            listBox21.Items.Add(p_rhx3_in2_list[maxIndex].ToString());
                            ...
                            PTC_rhx3.textBox3.Text = Convert.ToString(puntero_aplicacion.temp223);
                            PTC_rhx3.textBox6.Text = Convert.ToString(puntero_aplicacion.temp224);
                            PTC_rhx3.textBox4.Text = Convert.ToString(puntero_aplicacion.pres223);
                            PTC_rhx3.textBox5.Text = Convert.ToString(puntero_aplicacion.pres224);
                            ...
                            LF_rhx3.textBox3.Text = Convert.ToString(puntero_aplicacion.temp223);
                            LF_rhx3.textBox6.Text = Convert.ToString(puntero_aplicacion.temp224);
                            LF_rhx3.textBox4.Text = Convert.ToString(puntero_aplicacion.pres223);
                            LF_rhx3.textBox5.Text = Convert.ToString(puntero_aplicacion.pres224);
                            ...
                            //P_rhx3_in(kPa)
                            xlWorkSheet1.Cells[counter_Excel + 1, 12] = p_rhx3_in2_list[maxIndex].ToString();
                            //CIT
                            xlWorkSheet1.Cells[counter_Excel + 1, 13] = Convert.ToString(i - 273.15);
                            //LT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 14] = Convert.ToString(puntero_aplicacion.ua_lt);
                            //HT UA(kW/K)
                            xlWorkSheet1.Cells[counter_Excel + 1, 15] = Convert.ToString(puntero_aplicacion.ua_ht);
                            //Rec.Frac.
                            xlWorkSheet1.Cells[counter_Excel + 1, 16] = recomp_frac2_list[maxIndex].ToString();
                            //Eff.(%)
                            xlWorkSheet1.Cells[counter_Excel + 1, 17] = (eta_thermal2_list[maxIndex] * 100).ToString();
                            //LTR Eff.(%)
                            xlWorkSheet1.Cells[counter_Excel + 1, 18] = cicloTwo_PC_Two_RCMCI_with_Three_Reheating.LT.eff.ToString();
                            //LTR Pinch(ºC)
                            xlWorkSheet1.Cells[counter_Excel + 1, 19] = LTR_min_DT_paper.ToString();
                            ...
                            xlWorkSheet1.Cells[counter_Excel + 1, 22] = puntero_aplicacion.PTC_Main_SF_Effective_Apperture_Area.ToString();
                            //PTC_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 23] = puntero_aplicacion.PTC_Main_SF_Pressure_drop.ToString();
                            //LF_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 24] = puntero_aplicacion.LF_Main_SF_Effective_Apperture_Area.ToString();
                            //LF_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 25] = puntero_aplicacion.LF_Main_SF_Pressure_drop.ToString();
                            //PTC_rhx1_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 26] = puntero_aplicacion.PTC_Reheating1_SF_Effective_Apperture_Area.ToString();
                            //PTC_rhx1_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 27] = puntero_aplicacion.PTC_Reheating1_SF_Pressure_drop.ToString();
                            //LF_rhx1_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 28] = puntero_aplicacion.LF_Reheating1_SF_Effective_Apperture_Area.ToString();
                            //LF_rhx1_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 29] = puntero_aplicacion.LF_Reheating1_SF_Pressure_drop.ToString();
                            //PTC_rhx2_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 30] = puntero_aplicacion.PTC_Reheating2_SF_Effective_Apperture_Area.ToString();
                            //PTC_rhx2_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 31] = puntero_aplicacion.PTC_Reheating2_SF_Pressure_drop.ToString();
                            //LF_rhx2_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 32] = puntero_aplicacion.LF_Reheating2_SF_Effective_Apperture_Area.ToString();
                            //LF_rhx2_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 33] = puntero_aplicacion.LF_Reheating2_SF_Pressure_drop.ToString();
                            //PTC_rhx3_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 34] = puntero_aplicacion.PTC_Reheating3_SF_Effective_Apperture_Area.ToString();
                            //PTC_rhx3_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 35] = puntero_aplicacion.PTC_Reheating3_SF_Pressure_drop.ToString();
                            //LF_rhx3_Apperture_Area(m2)
                            xlWorkSheet1.Cells[counter_Excel + 1, 36] = puntero_aplicacion.LF_Reheating3_SF_Effective_Apperture_Area.ToString();
                            //LF_rhx3_Pressure_Drop(bar)
                            xlWorkSheet1.Cells[counter_Excel + 1, 37] = puntero_aplicacion.LF_Reheating3_SF_Pressure_drop.ToString();
                    ...
                    else if (checkBox2.Checked == true)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 10, 0.000001, 10000))
                        {
                            ...
                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                puntero_aplicacion.luis.RecompCycle_Two_PC_Two_RCMCI_with_Three_Reheating_for_optimization(puntero_aplicacion.luis,
                                ref cicloTwo_PC_Two_RCMCI_with_Three_Reheating, puntero_aplicacion.w_dot_net, i, i, i, i, i, 
                                puntero_aplicacion.t_t_in, puntero_aplicacion.t_trh1_in, variables[6], puntero_aplicacion.t_trh2_in, 
                                variables[8], puntero_aplicacion.t_trh3_in, variables[9], variables[1], variables[2], variables[2], 
                                variables[3], variables[3], variables[4], variables[4], variables[5], variables[5], puntero_aplicacion.p_mc3_out,
                                variables[7], UA_Total, puntero_aplicacion.m_eta_mc5, puntero_aplicacion.m_eta_pc1,
                                puntero_aplicacion.m_eta_pc2, puntero_aplicacion.m_eta_rc, puntero_aplicacion.m_eta_mc4,
                                puntero_aplicacion.m_eta_mc3, puntero_aplicacion.m_eta_t, puntero_aplicacion.m_eta_trh1,
                                puntero_aplicacion.m_eta_trh2, puntero_aplicacion.m_eta_trh3, puntero_aplicacion.n_sub_hxrs,
