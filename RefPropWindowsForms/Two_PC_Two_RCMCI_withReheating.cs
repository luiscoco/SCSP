...
{
    public partial class Two_PC_Two_RCMCI_withReheating : Form
    {
        //Input Data:
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            t_trh_in = Convert.ToDouble(textBox126.Text);
            p_trh_in = Convert.ToDouble(textBox127.Text);
            ...
            m_eta_trh = Convert.ToDouble(textBox125.Text);
            ...
            dp_rhx = Convert.ToDouble(textBox124.Text);
            ...
            luis.RecompCycle_Two_PC_Two_RCMCI_withReheating(luis, ref cicloTwo_PC_Two_RCMCI_withReheating,
            w_dot_net, t_pc1_in, t_pc2_in, t_mc5_in, t_mc4_in, t_mc3_in, t_t_in, t_trh_in, p_trh_in,
            ...
            m_eta_mc4, m_eta_mc3, m_eta_t, m_eta_trh, n_sub_hxrs, m_recomp_frac, tol, eta_thermal,
            -dp_lt1, -dp_lt2, -dp_ht1, -dp_ht2, -dp_pc1, -dp_pc4, -dp_pc3, -dp_pc2, -dp_pc5,
            -dp_phx, -dp_rhx);

            massflow2 = cicloTwo_PC_Two_RCMCI_withReheating.m_dot_turbine;
            w_dot_net2 = cicloTwo_PC_Two_RCMCI_withReheating.W_dot_net;
            eta_thermal2 = cicloTwo_PC_Two_RCMCI_withReheating.eta_thermal;
            ...
            temp21 = cicloTwo_PC_Two_RCMCI_withReheating.temp[0];
            temp22 = cicloTwo_PC_Two_RCMCI_withReheating.temp[1];
            temp23 = cicloTwo_PC_Two_RCMCI_withReheating.temp[2];
            temp24 = cicloTwo_PC_Two_RCMCI_withReheating.temp[3];
            temp25 = cicloTwo_PC_Two_RCMCI_withReheating.temp[4];
            temp26 = cicloTwo_PC_Two_RCMCI_withReheating.temp[5];
            temp27 = cicloTwo_PC_Two_RCMCI_withReheating.temp[6];
            temp28 = cicloTwo_PC_Two_RCMCI_withReheating.temp[7];
            temp29 = cicloTwo_PC_Two_RCMCI_withReheating.temp[8];
            temp210 = cicloTwo_PC_Two_RCMCI_withReheating.temp[9];
            temp211 = cicloTwo_PC_Two_RCMCI_withReheating.temp[10];
            temp212 = cicloTwo_PC_Two_RCMCI_withReheating.temp[11];
            temp213 = cicloTwo_PC_Two_RCMCI_withReheating.temp[12];
            temp214 = cicloTwo_PC_Two_RCMCI_withReheating.temp[13];
            temp215 = cicloTwo_PC_Two_RCMCI_withReheating.temp[14];
            temp216 = cicloTwo_PC_Two_RCMCI_withReheating.temp[15];
            temp217 = cicloTwo_PC_Two_RCMCI_withReheating.temp[16];
            temp218 = cicloTwo_PC_Two_RCMCI_withReheating.temp[17];
            temp219 = cicloTwo_PC_Two_RCMCI_withReheating.temp[18];
            temp220 = cicloTwo_PC_Two_RCMCI_withReheating.temp[19];

            pres21 = cicloTwo_PC_Two_RCMCI_withReheating.pres[0];
            pres22 = cicloTwo_PC_Two_RCMCI_withReheating.pres[1];
            pres23 = cicloTwo_PC_Two_RCMCI_withReheating.pres[2];
            pres24 = cicloTwo_PC_Two_RCMCI_withReheating.pres[3];
            pres25 = cicloTwo_PC_Two_RCMCI_withReheating.pres[4];
            pres26 = cicloTwo_PC_Two_RCMCI_withReheating.pres[5];
            pres27 = cicloTwo_PC_Two_RCMCI_withReheating.pres[6];
            pres28 = cicloTwo_PC_Two_RCMCI_withReheating.pres[7];
            pres29 = cicloTwo_PC_Two_RCMCI_withReheating.pres[8];
            pres210 = cicloTwo_PC_Two_RCMCI_withReheating.pres[9];
            pres211 = cicloTwo_PC_Two_RCMCI_withReheating.pres[10];
            pres212 = cicloTwo_PC_Two_RCMCI_withReheating.pres[11];
            pres213 = cicloTwo_PC_Two_RCMCI_withReheating.pres[12];
            pres214 = cicloTwo_PC_Two_RCMCI_withReheating.pres[13];
            pres215 = cicloTwo_PC_Two_RCMCI_withReheating.pres[14];
            pres216 = cicloTwo_PC_Two_RCMCI_withReheating.pres[15];
            pres217 = cicloTwo_PC_Two_RCMCI_withReheating.pres[16];
            pres218 = cicloTwo_PC_Two_RCMCI_withReheating.pres[17];
            pres219 = cicloTwo_PC_Two_RCMCI_withReheating.pres[18];
            pres220 = cicloTwo_PC_Two_RCMCI_withReheating.pres[19];
            ...
            {
                PHX = cicloTwo_PC_Two_RCMCI_withReheating.PHX.Q_dot;
                RHX = cicloTwo_PC_Two_RCMCI_withReheating.RHX.Q_dot;
                
                recomp_frac2 = cicloTwo_PC_Two_RCMCI_withReheating.recomp_frac;

                LT_Q = cicloTwo_PC_Two_RCMCI_withReheating.LT.Q_dot;
                LT_mdotc = cicloTwo_PC_Two_RCMCI_withReheating.LT.m_dot_design[0];
                LT_mdoth = cicloTwo_PC_Two_RCMCI_withReheating.LT.m_dot_design[1];
                LT_Tcin = cicloTwo_PC_Two_RCMCI_withReheating.LT.T_c_in;
                LT_Thin = cicloTwo_PC_Two_RCMCI_withReheating.LT.T_h_in;
                LT_Pcin = cicloTwo_PC_Two_RCMCI_withReheating.LT.P_c_in;
                LT_Phin = cicloTwo_PC_Two_RCMCI_withReheating.LT.P_h_in;
                LT_Pcout = cicloTwo_PC_Two_RCMCI_withReheating.LT.P_c_out;
                LT_Phout = cicloTwo_PC_Two_RCMCI_withReheating.LT.P_h_out;
                LT_Effc = cicloTwo_PC_Two_RCMCI_withReheating.LT.eff;

                HT_Q = cicloTwo_PC_Two_RCMCI_withReheating.HT.Q_dot;
                HT_mdotc = cicloTwo_PC_Two_RCMCI_withReheating.HT.m_dot_design[0];
                HT_mdoth = cicloTwo_PC_Two_RCMCI_withReheating.HT.m_dot_design[1];
                HT_Tcin = cicloTwo_PC_Two_RCMCI_withReheating.HT.T_c_in;
                HT_Thin = cicloTwo_PC_Two_RCMCI_withReheating.HT.T_h_in;
                HT_Pcin = cicloTwo_PC_Two_RCMCI_withReheating.HT.P_c_in;
                HT_Phin = cicloTwo_PC_Two_RCMCI_withReheating.HT.P_h_in;
                HT_Pcout = cicloTwo_PC_Two_RCMCI_withReheating.HT.P_c_out;
                HT_Phout = cicloTwo_PC_Two_RCMCI_withReheating.HT.P_h_out;
                HT_Effc = cicloTwo_PC_Two_RCMCI_withReheating.HT.eff;

                PC1 = -cicloTwo_PC_Two_RCMCI_withReheating.PC1.Q_dot;
                PC2 = -cicloTwo_PC_Two_RCMCI_withReheating.PC2.Q_dot;
                PC3 = -cicloTwo_PC_Two_RCMCI_withReheating.PC3.Q_dot;
                PC4 = -cicloTwo_PC_Two_RCMCI_withReheating.PC4.Q_dot;
                PC5 = -cicloTwo_PC_Two_RCMCI_withReheating.PC5.Q_dot;
