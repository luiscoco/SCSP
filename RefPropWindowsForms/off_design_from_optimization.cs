...
{
    public partial class off_design_from_optimization : Form
    {
        ...
        const string refpropDLL_path2 = "CO2_offdesign.dll";
        [DllImport(refpropDLL_path2, EntryPoint = "carbondioxide_", SetLastError = true)]
        public static extern void carbondioxide_(ref Double w_dot_net1, ref Double t_mc_in1, ref Double t_t_in1, ref Double p_mc_in1,
                                                 ...
                                                 ref Double LT_Effc, ref Double HT_Effc, ref Double N_mc_design, ref Double t_mc_in_off, ref Double t_t_in_off, ref Double p_mc_in_off,
                                                 ref Double recomp_frac_off, ref Double n_mc_off, ref Double n_t_off);

        public off_design_from_optimization()
        {
            InitializeComponent();
        }
        ...
        public Double N_design2, PHX_Q2, PC_Q2;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            p_mc_in_off2 = Convert.ToDouble(textBox30.Text);
            recomp_frac_off2 = Convert.ToDouble(textBox8.Text);
            n_mc_off2 = Convert.ToDouble(textBox3.Text);
            ...
            if (comboBox2.Text == "CO2")
            {
                carbondioxide_(ref  w_dot_net2, ref  t_mc_in2, ref  t_t_in2, ref  p_mc_in2, ref  p_mc_out2, ref  ua_lt2,
                              ...
                              ref  N_mc_design2, ref t_mc_in_off2, ref t_t_in_off2, ref p_mc_in_off2, ref recomp_frac_off2, ref n_mc_off2, ref n_t_off2);
