...
{
    public partial class Off_design_from_Design_Point : Form
    {
        ...
        const string refpropDLL_path2 = "CO2_offdesign_withReheating.dll";
        [DllImport(refpropDLL_path2, EntryPoint = "carbondioxideoffdesign_", SetLastError = true)]
        public static extern void carbondioxideoffdesign_(ref Double w_dot_net1,ref Double t_mc_in1,ref Double t_t_in1,ref Double p_mc_in1,ref Double p_mc_out1,
                                                                       ref Double p_rhx_in1,ref Double t_rht_in1,ref Double ua_lt1,ref Double ua_ht1,ref Double eta_mc1,ref Double eta_rc1,
                                                                       ref Double eta_t1,ref Double eta_trh1,ref Int64 n_sub_hxrs1,ref Double recomp_frac1,ref Double tol1,ref Double eta_thermal1,
                                                                       ...
                                                                       ref Double dp_phx2,ref Double dp_rhx1,ref Double dp_rhx2,ref Double temp1,ref Double temp2,ref Double temp3,ref Double temp4,
                                                                       ref Double temp5,ref Double temp6,ref Double temp7,ref Double temp8,ref Double temp9,ref Double temp10,ref Double temp11,
                                                                       ref Double temp12,ref Double pres1,ref Double pres2,ref Double pres3,ref Double pres4, ref Double pres5,ref Double pres6,
                                                                       ref Double pres7,ref Double pres8,ref Double pres9,ref Double pres10,ref Double pres11,ref Double pres12,ref Double m_dot_turbine1,
                                                                       ...
                                                                       ref Double HT_Pcin,ref Double HT_Phin,ref Double HT_Pcout,ref Double HT_Phout,ref Double HT_Q,ref Double LT_UA,ref Double HT_UA,
                                                                       ref Double LT_Effc,ref Double HT_Effc,ref Double N_mc_design,ref Double t_mc_in_off,ref Double t_t_in_off,ref Double t_trh_in_off,
                                                                       ref Double p_trh_in_off,ref Double p_mc_in_off,ref Double recomp_frac_off,ref Double n_mc_off,ref Double n_t_off);

        public Off_design_from_Design_Point()
        {
            InitializeComponent();
        }
        ...
        public Double t_mc_in_off2,t_t_in_off2,p_mc_in_off2,recomp_frac_off2;
        public Double n_mc_off2,n_t_off2,t_trh_in_off2,p_trh_in_off2;
        ...
        private void button2_Click(object sender, System.EventArgs e)
        {
            ...
            dp2_rhx2 = Convert.ToDouble(textBox58.Text);
            ...
            if (comboBox2.Text == "CO2")
            {
                ...
                textBox59.Text = Convert.ToString(N_design2);
        ...
        private void button5_Click(object sender, System.EventArgs e)
        {
            ...
            t_trh_in_off2 = Convert.ToDouble(textBox54.Text);
            p_trh_in_off2 = Convert.ToDouble(textBox53.Text);
            p_mc_in_off2 = Convert.ToDouble(textBox52.Text);
            recomp_frac_off2 = Convert.ToDouble(textBox9.Text);
            n_mc_off2 = Convert.ToDouble(textBox57.Text);
            n_t_off2 = Convert.ToDouble(textBox60.Text);
            
            if (comboBox2.Text == "CO2")
            {
                carbondioxideoffdesign_(ref  w_dot_net2,ref  t_mc_in2,ref  t_t_in2,ref  p_mc_in2,ref  p_mc_out2,
                                        ref  p_rhx_in2,ref  t_rht_in2,ref  ua_lt2,ref  ua_ht2,ref  eta_mc2,ref  eta_rc2,
                                        ref  eta_t2,ref  eta_trh2,ref n_sub_hxrs2,ref  recomp_frac2,ref  tol2,ref  eta_thermal2,
                                        ref  dp2_lt1,ref  dp2_lt2,ref  dp2_ht1,ref  dp2_ht2,ref  dp2_pc1,ref  dp2_pc2,ref  dp2_phx1,
                                        ref  dp2_phx2,ref  dp2_rhx1,ref  dp2_rhx2,ref  temp21,ref  temp22,ref  temp23,ref  temp24,
                                        ref  temp25,ref  temp26,ref  temp27,ref  temp28,ref  temp29,ref  temp210,ref  temp211,
                                        ref  temp212,ref  pres21,ref  pres22,ref  pres23,ref  pres24, ref  pres25,ref  pres26,
                                        ref  pres27, ref  pres28, ref  pres29, ref  pres210, ref  pres211, ref  pres212, ref  massflow2,
                                        ...
                                        ref  HT_Pcin,ref  HT_Phin,ref  HT_Pcout,ref  HT_Phout,ref  HT_Q,ref  LT_UA,ref  HT_UA,
                                        ref  LT_Effc, ref  HT_Effc, ref  N_design2, ref  t_mc_in_off2, ref  t_t_in_off2, ref  t_trh_in_off2,
                                        ref  p_trh_in_off2,ref  p_mc_in_off2,ref  recomp_frac_off2,ref  n_mc_off2,ref  n_t_off2);
