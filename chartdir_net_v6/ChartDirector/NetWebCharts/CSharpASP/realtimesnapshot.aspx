...
private void drawChart(WebChartViewer viewer)
{
    ...
    string downloadFormat = Request["download"];
    if (!string.IsNullOrEmpty(downloadFormat)) {
        string fname = "demo_" + c.formatValue(timeStamps[timeStamps.Length - 1], "yyyymmddhhnnss");
