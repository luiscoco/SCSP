...
type HeatExchanger
    ...
    integer  :: N_sub = 15                            ! number of sub-heat exchangers used in model
...
type RecompCycle
    ...
    type(Compressor) :: mc1,mc2,rc                           ! compressor and recompressor user-defined types
    type(HeatExchanger) :: LT, HT, PHX, RHX, PC1, PC2        ! heat exchanger user-defined types
