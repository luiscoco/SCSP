...
!------------------------------------------------------------w
        subroutine carbondioxide(w_dot_net1,t_mc_in1,t_t_in1,p_mc_in1,p_mc_out1, &
					   ...
					   N_mc_design,PHX_Q1,RHX_Q1,PC_Q1)
      ...
      integer :: i
      real(dp) , INTENT(INOUT):: w_dot_net1,t_mc_in1,t_t_in1,ua_lt1,N_mc_design
      ...
      real(dp) , INTENT(INOUT):: PHX_Q1,RHX_Q1,PC_Q1
...
! Define and optimize a design point.
      call design(                         &
        ...
        RHX_Q1=recomp_cycle1%RHX%Q_dot
