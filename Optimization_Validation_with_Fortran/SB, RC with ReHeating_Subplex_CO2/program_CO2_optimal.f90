...
!------------------------------------------------------------w
	  ...
	  integer :: i
      real(dp) , INTENT(INOUT):: w_dot_net1,t_mc_in1,t_t_in1,ua_rec_total1,eta_mc1,eta_rc1,eta_t1,eta_trh1,eta_thermal1,N_design
