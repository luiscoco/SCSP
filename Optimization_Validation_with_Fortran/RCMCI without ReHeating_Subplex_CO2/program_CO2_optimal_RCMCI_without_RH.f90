...
!------------------------------------------------------------w
      ...
      subroutine carbondioxidesubplex( w_dot_net1, t_mc1_in1, t_mc2_in1, t_t_in1, p_mc1_in_guess1, &
	                      fixed_p_mc1_in1,ua_rec_total1, eta_mc1, eta_mc2, eta_rc1, eta_t1, &
                          ...
                          dp2_pc1, dp2_pc2, dp_phx1, dp_phx2, &
      ...
      real(dp) , INTENT(INOUT):: p_mc1_in_guess1,eta_thermal1,eta_mc1,eta_mc2,eta_rc1,eta_t1
      real(dp) , INTENT(INOUT):: m_dot_turbine1,LT_UA,HT_UA,LT_Effc,HT_Effc	  
      real(dp) , INTENT(INOUT):: dp_lt1,dp_lt2,dp_ht1,dp_ht2,dp1_pc1,dp1_pc2,dp_phx1,dp_phx2
      ...
      logical , INTENT (INOUT):: fixed_p_mc2_out1,fixed_pr_mc2,fixed_recomp_frac1, fixed_lt_frac1
      ...
      real(dp) , INTENT(INOUT):: PHX, PC1, PC2
