...
!------------------------------------------------------------w
        ...
        ua_lt1,ua_ht1,eta_mc11,eta_mc21,eta_rc1,eta_t1, &
        n_sub_hxrs1,recomp_frac1,tol1,eta_thermal1, &
        dp_lt1,dp_lt2,dp_ht1,dp_ht2,dp1_pc1,dp1_pc2,dp2_pc1,dp2_pc2, &
        dp_phx1,dp_phx2,temp1,temp2,temp3,temp4,temp5,temp6,temp7, &
      ...
      real(dp) , INTENT(INOUT):: ua_ht1,eta_mc11,eta_mc21,eta_rc1,eta_t1,eta_thermal1
      real(dp) , INTENT(INOUT):: recomp_frac1,tol1,p_mc1_in1,p_mc1_out1,p_mc2_in1,p_mc2_out1
      real(dp) , INTENT(INOUT):: m_dot_turbine1,LT_UA,HT_UA,LT_Effc,HT_Effc,PHX1,PC1,PC2	  
      real(dp) , INTENT(INOUT):: dp_lt1,dp_lt2,dp_ht1,dp_ht2,dp1_pc1,dp1_pc2,dp2_pc1,dp2_pc2,dp_phx1,dp_phx2
...
! Define and optimize a design point.
      call design(                         &
         ...
         temp11=recomp_cycle1%temp(13)		 
         temp12=recomp_cycle1%temp(14)
         ...
         pres11=recomp_cycle1%pres(13)		 
         pres12=recomp_cycle1%pres(14)
