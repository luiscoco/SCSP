...
!------------------------------------------------------------w
        ...
        p_pc_in1,t_pc_in1,p_pc_out1,ua_lt1,ua_ht1, &
        eta_mc1,eta_rc1,eta_pc1,eta_t1, &
        n_sub_hxrs1,recomp_frac1,tol1,eta_thermal1, &
        dp_lt1,dp_lt2,dp_ht1,dp_ht2,dp_pc1,dp_pc2,dp_phx1,dp_phx2, &
        dp_cooler1,dp_cooler2,temp1,temp2,temp3,temp4,temp5,temp6,temp7, &
      ...
      real(dp) , INTENT(INOUT):: ua_ht1,eta_mc1,eta_pc1,eta_rc1,eta_t1,eta_thermal1
      real(dp) , INTENT(INOUT):: recomp_frac1,tol1,p_mc_in1,p_mc_out1
      real(dp) , INTENT(INOUT):: m_dot_turbine1,LT_UA,HT_UA,LT_Effc,HT_Effc	  
      real(dp) , INTENT(INOUT):: dp_lt1,dp_lt2,dp_ht1,dp_ht2,dp_pc1,dp_pc2,dp_phx1,dp_phx2,dp_cooler1,dp_cooler2
...
! Define and optimize a design point.
      call design(                         &
        ...
        PC1=recomp_cycle1%PC%Q_dot
        PC2=recomp_cycle1%COOLER%Q_dot
