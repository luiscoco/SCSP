...
!------------------------------------------------------------w
      ...
      subroutine carbondioxidesubplex(w_dot_net1,t_mc_in1,t_t_in1, & 
	                 p_pc_in_guess1,fixed_p_pc_in1,t_pc_in1,ua_rec_total1,eta_mc1,eta_rc1,eta_pc1,eta_t1,  &
	  ...
	  integer :: i
	  real(dp) , INTENT(INOUT):: p_pc_in_guess1,t_pc_in1,eta_pc1,dp_cooler1,dp_cooler2
      real(dp) , INTENT(INOUT):: w_dot_net1,t_mc_in1,t_t_in1,ua_rec_total1,eta_mc1,eta_rc1,eta_t1,eta_thermal1
      ...
      logical , INTENT (INOUT):: fixed_p_mc_out1,fixed_pr_mc1,fixed_recomp_frac1, fixed_lt_frac1,fixed_p_pc_in1
...
! Define and optimize a design point.
      call optimal_design( &
         ...
         p_pc_in_guess1=recomp_cycle%pres(13)
        ...
        PC1=recomp_cycle%PC%Q_dot
        PC2=recomp_cycle%COOLER%Q_dot
