...
!------------------------------------------------------------w
        subroutine carbondioxide(w_dot_net1,t_mc_in1,t_t_in1,p_mc_in1,p_mc_out1, &
                       ...
                       HT_Pcin,HT_Phin,HT_Pcout,HT_Phout,HT_Q,LT_UA,HT_UA,LT_Effc, &
					   HT_Effc,N_design1,PHX_Q1,PC_Q1)
      ...
      integer :: i
      real(dp) , INTENT(INOUT):: w_dot_net1,t_mc_in1,t_t_in1,ua_lt1,N_design1
...
! Define and optimize a design point.
      call design(                         &
        ...
        N_design1=recomp_cycle1%mc%N

        PHX_Q1=recomp_cycle1%PHX%Q_dot
        PC_Q1=recomp_cycle1%PC%Q_dot
