...
!------------------------------------------------------------w
      subroutine carbondioxide(w_dot_net1,t_mc_in1,t_t_in1,p_mc_in1,p_mc_out1, &
				  ...
				  LT_Effc,HT_Effc,N_mc_design,t_mc_in_off,t_t_in_off,p_mc_in_off, &
      ...
      real(dp) , INTENT(INOUT):: ua_ht1,eta_mc1,eta_rc1,eta_t1,eta_thermal1,p_mc_in_off
      real(dp) , INTENT(INOUT):: recomp_frac1,tol1,p_mc_in1,p_mc_out1,t_t_in_off,n_t_off
