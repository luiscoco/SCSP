...
!
!------------------------------------------------------------w
      subroutine carbondioxidetarget(w_dot_net1,t_mc_in1,t_t_in1,p_mc_in1,p_mc_out1, &
				  ...
				  recomp_frac_off,n_mc_off,n_t_off,target_off,target_code_off, &
				  lowest_pressure_off,highest_pressure_off)

      !DEC$ ATTRIBUTES DLLEXPORT, ALIAS: 'carbondioxidetarget'
      ...
      integer :: i
      real(dp) , INTENT(INOUT):: w_dot_net1,t_mc_in1,t_t_in1,ua_lt1,t_mc_in_off,n_mc_off,N_mc_design
      real(dp) , INTENT(INOUT):: ua_ht1,eta_mc1,eta_rc1,eta_t1,eta_thermal1,target_off
      real(dp) , INTENT(INOUT):: recomp_frac1,tol1,p_mc_in1,p_mc_out1,t_t_in_off,n_t_off,lowest_pressure_off,highest_pressure_off
      real(dp) , INTENT(INOUT):: m_dot_turbine1,LT_UA,HT_UA,LT_Effc,HT_Effc,recomp_frac_off	  
...
! Define and optimize a design point.
      ...
      call target_off_design(                   &
         ...
         N_mc = n_mc_off,                & ! Cold vary
         N_t = n_t_off,                  & ! Could vary
         target = target_off,            &
         target_code = target_code_off,  &
      ...
      end subroutine carbondioxidetarget
